> **Note:** This is a copy of the canonical specification at `express-suite/packages/digitaldefiance-ecies-lib/docs/DD-ECIES-SPECIFICATION.md`. If they differ, the canonical version takes precedence.
