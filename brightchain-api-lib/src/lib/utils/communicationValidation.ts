...
export const sendDirectMessageValidation: ValidationChain[] = [
  body('recipientId')
    ...
    .isString()
    .notEmpty()
    .withMessage('recipientId must be a non-empty string when provided'),
  body('conversationId')
    .optional()
    .isString()
    .notEmpty()
    .withMessage('conversationId must be a non-empty string when provided'),
  body().custom((value) => {
    if (!value?.recipientId && !value?.conversationId) {
  ...
  body('content')
    ...
    .isString()
    .notEmpty()
    .withMessage('content must be a non-empty string when provided'),
];
...
export const uploadServerIconValidation: ValidationChain[] = [
  param('serverId').isString().notEmpty().withMessage('serverId is required'),
  body('commitToken')
    .isString()
    .notEmpty()
    .withMessage('commitToken is required'),
];

export const serverIconParamValidation: ValidationChain[] = [
  param('serverId').isString().notEmpty().withMessage('serverId is required'),
];
