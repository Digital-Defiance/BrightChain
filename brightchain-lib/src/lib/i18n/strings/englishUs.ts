...
export const AmericanEnglishStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'Search by block hash prefix…',
  [BrightChainStrings.Explorer_SearchButton]: 'Search',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} result(s)',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: 'Queried {PEERS} peers in {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'No nodes found holding this block.',
