...
function EcosystemFAQ() {
  ...
  return (
    <>
      ...
      <div className="faq-item ecosystem-item">
        <h2>{t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_Title)}</h2>
        <p>{t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_Intro)}</p>
        <ul>
          <li>
            <strong>
              {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_CoupledToPhysics_Label)}:
            </strong>{' '}
            {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_CoupledToPhysics)}
          </li>
          <li>
            <strong>
              {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_PoUW_Label)}:
            </strong>{' '}
            {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_PoUW)}
          </li>
          <li>
            <strong>
              {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_ResourceUtility_Label)}:
            </strong>{' '}
            {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_ResourceUtility)}
          </li>
          <li>
            <strong>
              {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_Thermodynamic_Label)}:
            </strong>{' '}
            {t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_Thermodynamic)}
          </li>
        </ul>
        <p>{t(ShowcaseStrings.FAQ_Eco_JoulesVsGas_Summary)}</p>
      </div>
