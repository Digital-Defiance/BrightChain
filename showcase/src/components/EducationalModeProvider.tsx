 ...
 */
export const EducationalModeProvider: React.FC<
  EducationalModeProviderProps
> = ({ children, animationController }) => {
  ...
  const updateConfig = useCallback(
    (newConfig: Partial<EducationalModeConfig>) => {
  ...
  const showProcessSummary = useCallback(
...
export const useEducationalModeContext = (): EducationalModeContextType => {
  ...
  if (!context) {
    throw new Error(
      'useEducationalModeContext must be used within an EducationalModeProvider',
    );
  }
  return context;
};
