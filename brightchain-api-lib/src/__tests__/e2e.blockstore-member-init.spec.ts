...
const RBAC_SYSTEM_FULL_ID = 'b40c689a-4819-4a2c-b303-085bc0d49954';
const RBAC_ADMIN_FULL_ID = '56bdd544-91d4-4f8c-90a8-d4a4bda3e9f9';
const RBAC_MEMBER_FULL_ID = '83aa5069-9d38-4920-938d-5f23c51da297';

const RBAC_SYSTEM_ROLE_ID = '22e235f1-1364-4723-b532-51bd4f540200';
const RBAC_ADMIN_ROLE_ID = 'fe76ff84-8355-4ef3-bc36-e61be02daf81';
const RBAC_MEMBER_ROLE_ID = '8ee7c136-b01f-41e9-a444-825f84fe59f9';

const RBAC_SYSTEM_USER_ROLE_ID = '43f3f97d-6b10-4065-a0c9-aa826ed04f9f';
const RBAC_ADMIN_USER_ROLE_ID = 'f6602523-f9b3-4d9d-8bcc-fe2cc6003a58';
const RBAC_MEMBER_USER_ROLE_ID = 'cefa30ae-8f17-47b0-8319-2395b26b6a23';

const RBAC_SYSTEM_MNEMONIC_DOC_ID = 'bd4e724f-743e-40a4-8770-6b04598cd156';
const RBAC_ADMIN_MNEMONIC_DOC_ID = '3b4dfdc6-1699-40ca-b29d-9d7203f15fa7';
const RBAC_MEMBER_MNEMONIC_DOC_ID = 'a01197d6-82fa-4053-a030-1ab1b6f7b1fc';
