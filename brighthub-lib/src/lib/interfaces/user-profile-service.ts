...
export interface IUpdateProfileOptions {
  ...
  /** New website URL */
  websiteUrl?: string;
  /** ID of the post to pin to profile (undefined to clear) */
  pinnedPostId?: string;
}
...
export interface IUserProfileService {
   ...
   * @param username The username to look up (without @ prefix)
   * @param requesterId Optional requester for privacy filtering
   * @throws UserProfileServiceError if user not found
   */
