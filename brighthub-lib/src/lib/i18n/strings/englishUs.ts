...
export const BrightHubAmericanEnglishStrings: ComponentStrings<BrightHubStringKey> =
  {
    ...
    [BrightHubStrings.PostComposer_ImageLimitReached]:
      'Maximum 20 images per post',
    [BrightHubStrings.PostComposer_ImageUploadFailed]: 'Image upload failed',
    [BrightHubStrings.PostComposer_Uploading]: 'Uploading...',
    [BrightHubStrings.PostComposer_InsertImage]: 'Insert image',
    [BrightHubStrings.PostComposer_RemoveAttachment]: 'Remove attachment',
    [BrightHubStrings.PostComposer_AttachmentLimitReached]:
      'Maximum 4 attachments per post',
    [BrightHubStrings.PostComposer_EditAltText]: 'Edit alt text',
    [BrightHubStrings.PostComposer_AltText]: 'Alt text',
    [BrightHubStrings.PostComposer_Save]: 'Save',
    [BrightHubStrings.PostComposer_Cancel]: 'Cancel',
    [BrightHubStrings.PostComposer_InsertIcon]: 'Insert icon',
    [BrightHubStrings.PostComposer_IconSearchPlaceholder]: 'Search icons...',
    [BrightHubStrings.PostComposer_IconNoMatchTemplate]:
      'No icons match \u201c{0}\u201d',
    [BrightHubStrings.PostComposer_IconStyleOptions]: 'Style Options',
    [BrightHubStrings.PostComposer_IconColor]: 'Color',
    [BrightHubStrings.PostComposer_IconColorNone]: 'None',
    [BrightHubStrings.PostComposer_IconAnimation]: 'Animation',
    [BrightHubStrings.PostComposer_IconAnimationNone]: 'None',
    [BrightHubStrings.PostComposer_IconRotation]: 'Rotation',
    [BrightHubStrings.PostComposer_IconRotationNone]: 'None',
    [BrightHubStrings.PostComposer_IconSize]: 'Size',
    [BrightHubStrings.PostComposer_IconSizeDefault]: 'Default',
    [BrightHubStrings.PostComposer_IconPreview]: 'Preview',

    // ImageCropDialog
    [BrightHubStrings.ImageCropDialog_Title]: 'Crop Image',
    [BrightHubStrings.ImageCropDialog_Crop]: 'Crop',
    [BrightHubStrings.ImageCropDialog_Skip]: 'Use Original',
    [BrightHubStrings.ImageCropDialog_Cancel]: 'Cancel',
    [BrightHubStrings.ImageCropDialog_ZoomLabel]: 'Zoom',
    [BrightHubStrings.ImageCropDialog_PreviewAlt]: 'Crop preview',
