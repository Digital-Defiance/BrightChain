...
export interface UserProfileCardProps {
  ...
  /** Callback to open the edit profile dialog — only shown when isSelf is true */
  onEditProfile?: () => void;
}
    ...
    >
      ...
      <CardContent sx={{ pb: '12px !important' }}>
        ...
        >
          ...
          {/* Action element (e.g., FollowButton) and Edit Profile button */}
          {(actionElement || (isSelf && onEditProfile)) && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              {isSelf && onEditProfile && (
                ...
                >
                  {t(BrightHubStrings.UserProfileCard_EditProfile)}
                </Button>
              )}
            </Box>
          )}
        ...
        {(user.formattedBio || user.bio) && (
          <Box
            ...
            dangerouslySetInnerHTML={{
              __html: user.formattedBio || user.bio,
            }}
          />
        )}
