...
export const THEME_COLORS: IThemeColors = {
  ...
  TAGLINE_LIGHT_COLOR: '#ffffff' as const,
  TAGLINE_DARK_COLOR: '#000000' as const,
 ...
 */
export const BLOCK_HEADER: IBlockHeaderConsts = {
  /**
...
export const BRIGHTHUB: IFontawesomePickerConstants = {
  /**
   * Max icons to show in the grid at once
   */
  FONTAWESOME_MAX_DISPLAY: 120 as const,

  /**
   * Grid item size (width and height) in pixels for the icon grid.
   */
  FONTAWESOME_ICON_GRID_SIZE: 40 as const,
};

export const BRIGHTCHAT: IFontawesomePickerConstants = {
  /**
   * Max icons to show in the grid at once
   */
  FONTAWESOME_MAX_DISPLAY: 120 as const,
