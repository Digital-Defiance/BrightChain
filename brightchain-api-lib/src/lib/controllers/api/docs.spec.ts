 ...
 * The upstream BaseController route pipeline always runs
 * setGlobalContextLanguageFromRequest which requires a registered language
 * and a valid GlobalActiveContext. Under parallel Jest workers these
 * singletons can be cleared by other test files.
 */
