...
const getFeatures = (
...
): Feature[] => [
  {
    ...
    tech: [
      t(ShowcaseStrings.Feat_Burnbag_Tech1),
      t(ShowcaseStrings.Feat_Burnbag_Tech2),
      t(ShowcaseStrings.Feat_Burnbag_Tech3),
    ],
    category: t(ShowcaseStrings.Feat_Burnbag_Cat) as Feature['category'],
    highlights: [
      t(ShowcaseStrings.Feat_Burnbag_HL1),
      t(ShowcaseStrings.Feat_Burnbag_HL2),
      t(ShowcaseStrings.Feat_Burnbag_HL3),
      t(ShowcaseStrings.Feat_Burnbag_HL4),
      t(ShowcaseStrings.Feat_Burnbag_HL5),
      t(ShowcaseStrings.Feat_Burnbag_HL6),
      t(ShowcaseStrings.Feat_Burnbag_HL7),
      t(ShowcaseStrings.Feat_Burnbag_HL8),
      t(ShowcaseStrings.Feat_Burnbag_HL9),
      t(ShowcaseStrings.Feat_Burnbag_HL10),
      t(ShowcaseStrings.Feat_Burnbag_HL11),
      t(ShowcaseStrings.Feat_Burnbag_HL12),
    ],
  },
  {
    logo: (
  ...
  {
    logo: <img src={brightDBPoolsImg} height="40" width="252" />,
    icon: '🏊',
    description: t(ShowcaseStrings.Feat_BrightDBPools_Desc),
    tech: [
      t(ShowcaseStrings.Feat_BrightDBPools_Tech1),
      t(ShowcaseStrings.Feat_BrightDBPools_Tech2),
      t(ShowcaseStrings.Feat_BrightDBPools_Tech3),
    ],
    category: t(ShowcaseStrings.Feat_BrightDBPools_Cat) as Feature['category'],
    highlights: [
      t(ShowcaseStrings.Feat_BrightDBPools_HL1),
      t(ShowcaseStrings.Feat_BrightDBPools_HL2),
      t(ShowcaseStrings.Feat_BrightDBPools_HL3),
      t(ShowcaseStrings.Feat_BrightDBPools_HL4),
      t(ShowcaseStrings.Feat_BrightDBPools_HL5),
      t(ShowcaseStrings.Feat_BrightDBPools_HL6),
      t(ShowcaseStrings.Feat_BrightDBPools_HL7),
      t(ShowcaseStrings.Feat_BrightDBPools_HL8),
      t(ShowcaseStrings.Feat_BrightDBPools_HL9),
    ],
  },
  {
    logo: (
      ...
      >
        ...
        >
          ...
          <div className="value-props">
            ...
            <div className="value-prop">
              <strong>{t(ShowcaseStrings.Comp_VP_BrightTrust_Title)}</strong>
              <p>{t(ShowcaseStrings.Comp_VP_BrightTrust_Desc)}</p>
            </div>
            <div className="value-prop">
