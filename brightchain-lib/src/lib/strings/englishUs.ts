...
export const AmericanEnglishStrings: StringsCollection = {
  ...
  [StringNames.Error_BlockValidationErrorCreatorIDMismatch]:
    'Creator ID mismatch',
  [StringNames.Error_BlockValidationErrorCreatorHasNoPrivateKey]:
    'Creator has no private key',
  ...
  [StringNames.Error_BlockServiceErrorNoWhiteners]: 'No whiteners provided',
