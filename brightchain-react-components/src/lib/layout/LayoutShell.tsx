...
export function LayoutShell({
  ...
  const outerMode = outerTheme.palette.mode;

  const theme = useMemo(() => {
    const base: ThemeOptions = {
      palette: {
        mode: outerMode,
        primary: { main: brandConfig.primaryColor },
        ...(outerMode === 'dark'
          ? {
              background: {
                default: outerTheme.palette.background.default,
                paper: outerTheme.palette.background.paper,
              },
              text: {
                primary: outerTheme.palette.text.primary,
                secondary: outerTheme.palette.text.secondary,
              },
            }
          : {}),
      },
    ...
    brandConfig.themeOverrides,
    outerMode,
    outerTheme.palette.background.default,
    outerTheme.palette.background.paper,
    outerTheme.palette.text.primary,
