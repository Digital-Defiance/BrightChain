...
export const JapaneseStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'ブロックハッシュのプレフィックスで検索…',
  [BrightChainStrings.Explorer_SearchButton]: '検索',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} 件の結果',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: '{PEERS} ピアに {DURATION}ms で問い合わせ',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'このブロックを保持するノードが見つかりません。',
