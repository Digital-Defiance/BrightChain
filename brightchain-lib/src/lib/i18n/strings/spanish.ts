...
export const SpanishStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'Buscar por prefijo de hash…',
  [BrightChainStrings.Explorer_SearchButton]: 'Buscar',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} resultado(s)',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: '{PEERS} pares consultados en {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'No se encontraron nodos con este bloque.',
  ...
  [BrightChainStrings.Explorer_PageTemplate]: 'Página {PAGE} · {TOTAL} en total',
