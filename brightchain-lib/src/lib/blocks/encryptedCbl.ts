...
BlockCreator.register(
  ...
  async (
    ...
    const minDataSize =
      ConstituentBlockListBlock.CblHeaderSize + BlockECIES.eciesOverheadLength;
...
export class EncryptedConstituentBlockListBlock extends EncryptedOwnedDataBlock {
  public static override async from(
    ...
    const result = await BlockCreator.create(
      BlockType.EncryptedConstituentBlockListBlock,
      dataType,
      blockSize,
      data,
  ...
  public static async fromCbl(
    ...
    const eciesService = BlockServices.getECIESService();
    const encryptedData = eciesService.encrypt(encryptor.publicKey, cbl.data);
  ...
  public override get payload(): Buffer {
    ...
    return this.data.subarray(BlockECIES.eciesOverheadLength, this.blockSize);
  }
  ...
  public override validateSync(): void {
    ...
    const dataAfterHeader =
      this.lengthBeforeEncryption - ConstituentBlockListBlock.CblHeaderSize;
    ...
    const totalSize =
      this.lengthBeforeEncryption + BlockECIES.eciesOverheadLength;
