    ...
    },
    {
      logo: (
        <BrightChainSubLogo
          subText="Chat"
          height={40}
          leadColor={THEME_COLORS.CHAIN_BLUE_DARK}
          subColor={THEME_COLORS.CHAIN_BLUE_LIGHT}
          icon={faComment}
        />
      ),
  ...
  return (
    <Container maxWidth="lg">
      ...
      <Alert severity="warning" sx={{ mb: 4 }}>
        <AlertTitle>{t(BrightChainStrings.Splash_EarlyDev_Title)}</AlertTitle>
        <Typography variant="body2" sx={{ mb: 1 }}>
          {t(BrightChainStrings.Splash_EarlyDev_Body)}
        </Typography>
        <Stack spacing={1} sx={{ mt: 1 }}>
          <Box>
            <Typography variant="body2" component="span" fontWeight="bold">
              {t(BrightChainStrings.Splash_EarlyDev_Team)}:{' '}
            </Typography>
            <Typography variant="body2" component="span">
              {t(BrightChainStrings.Splash_EarlyDev_TeamDescription)}
            </Typography>
          </Box>
          <Box>
            <Typography variant="body2" component="span" fontWeight="bold">
              {t(BrightChainStrings.Splash_EarlyDev_DataWarning)}:{' '}
            </Typography>
            <Typography variant="body2" component="span">
              {t(BrightChainStrings.Splash_EarlyDev_DataWarningDescription)}
            </Typography>
          </Box>
          <Box>
            <Typography variant="body2" component="span" fontWeight="bold">
              {t(BrightChainStrings.Splash_EarlyDev_UptimeWarning)}:{' '}
            </Typography>
            <Typography variant="body2" component="span">
              {t(BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription)}
            </Typography>
          </Box>
          <Box>
            <Typography variant="body2" component="span" fontWeight="bold">
              {t(BrightChainStrings.Splash_EarlyDev_GetInvolved)}:{' '}
            </Typography>
            <Typography variant="body2" component="span">
              {t(BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription)}
            </Typography>
          </Box>
        </Stack>
      </Alert>
