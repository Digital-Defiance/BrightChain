    ...
    stops: [
      {
        ...
        description:
          'This tour will show you the key features of the BrightChain demo in just a few minutes.',
      ...
      },
      {
        ...
        description:
          'Start here by uploading a file. You can drag and drop or click to browse. The file will be broken into blocks.',
      ...
      },
      {
        ...
        description:
          'This is where all the magic happens! Your file blocks are mixed with others in this "soup" for privacy and security.',
      ...
      },
      {
        ...
        title: 'Control Panel',
        description:
          'Use these controls to adjust animation speed, enable educational mode, and access help.',
    ...
    stops: [
      {
        ...
        description:
          "File encoding transforms your file into secure, distributed blocks. Let's explore each step in detail.",
      ...
      },
      {
        ...
        description:
          'The file is divided into fixed-size chunks. This ensures uniform block sizes for efficient storage.',
      ...
      },
      {
        ...
        description:
          'Random data is added to the last chunk to reach the standard block size. This prevents information leakage.',
      ...
      },
      {
        ...
        description:
          'SHA-512 hashes are calculated for each block. These checksums ensure data integrity and serve as block identifiers.',
      ...
      },
      {
        ...
        description:
          "Blocks are added to the soup where they mix with other files' blocks, providing anonymity.",
      ...
      },
      {
        ...
        description:
          'A Constituent Block List is created containing the "recipe" to reconstruct your file.',
    ...
    stops: [
      {
        ...
        description:
          'The soup is a collection of blocks from many different files, all mixed together for security.',
        targetElement: '.soup-visualization',
        position: 'top',
      },
      {
        ...
        title: 'Soup Cans',
        description:
          'Each "soup can" represents a data block. Colors are generated from block checksums.',
      ...
      },
      {
        ...
        description:
          'Blocks from the same file are visually connected. Hover over blocks to see these connections.',
      ...
      },
      {
        ...
        description:
          'Click any block to see detailed information including checksum, size, and file association.',
    ...
    stops: [
      {
        ...
        description:
          'Reconstruction is the process of reassembling your original file from the block soup using a CBL.',
      ...
      },
      {
        ...
        description:
          'Start by pasting a magnet URL or uploading a CBL file. This contains the block list.',
      ...
      },
      {
        ...
        description:
          'The system identifies and highlights all required blocks in the soup.',
      ...
      },
      {
        ...
        description:
          "Each block's checksum is verified to ensure data integrity before reassembly.",
      ...
      },
      {
        ...
        description:
          'Blocks are combined in the correct order and padding is removed to restore the original file.',
    ...
    stops: [
      {
        ...
        description:
          'Enable this mode to slow down animations and see detailed explanations for each step.',
      ...
      },
      {
        ...
        description:
          'Click the help icons throughout the demo to get detailed explanations of technical concepts.',
      ...
      },
      {
        ...
        description:
          'Access the glossary to look up technical terms and concepts with detailed definitions.',
      ...
      },
      {
        ...
        title: 'Help Center',
        description:
          'The help center provides comprehensive documentation on all BrightChain features.',
      ...
      },
      {
        ...
        title: 'Debug Panel',
        description:
          'Advanced users can view internal state and diagnostic information in the debug panel.',
...
export const GuidedTour: React.FC<GuidedTourProps> = ({
  ...
  const progress = tour
    ? ((currentStopIndex + 1) / tour.stops.length) * 100
    : 0;
