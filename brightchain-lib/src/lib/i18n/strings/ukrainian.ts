...
export const UkrainianStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'Пошук за префіксом хешу блоку…',
  [BrightChainStrings.Explorer_SearchButton]: 'Шукати',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} результат(ів)',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: 'Опитано {PEERS} вузлів за {DURATION}мс',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'Не знайдено вузлів, що зберігають цей блок.',
  ...
  [BrightChainStrings.Explorer_PageTemplate]: 'Сторінка {PAGE} · {TOTAL} всього',
