...
describe('ChecksumService', () => {
  ...
  // Helper function to create a web readable stream from a buffer
  ...
  describe('synchronous checksum', () => {
    ...
    it('should generate consistent checksums for the same data', () => {
      ...
      expect(Buffer.from(checksum1).equals(Buffer.from(checksum2))).toBe(true);
    ...
    it('should generate different checksums for different data', () => {
      ...
      expect(Buffer.from(checksum1).equals(Buffer.from(checksum2))).toBe(false);
    ...
    describe('validation', () => {
      ...
      it('should detect tampered checksums', () => {
        ...
        const tamperedChecksum = new Uint8Array(tamperedBuffer) as any;
