...
> = {
  ...
  [ShowcaseStrings.BlogPost_NotFoundDesc]: 'お探しのブログ記事は存在しません。',
  ...
  [ShowcaseStrings.Feat_OFFS_Desc]:
    'オリジナルのOwner-Free File Systemコンセプトを基に、BrightChainはOFFSを次のレベルへと進化させました。ECIES非対称暗号化、冗長性と耐久性のためのReed-Solomon前方誤り訂正パリティブロック、そしてデジタルブロックチェーン台帳を追加しました。この基盤の上に構築されたDigital Burnbagは、OFFSの独自の特性を活用して、内容が一度も読まれることなくファイルの完全な破棄を保証します。詳しい数学的基礎はDigital Burnbag Vaultホワイトペーパーをご覧ください。',
  [ShowcaseStrings.Feat_OFFS_Cat]: 'ストレージ',
  [ShowcaseStrings.Feat_OFFS_Tech1]: 'ECIES暗号化',
  [ShowcaseStrings.Feat_OFFS_Tech2]: 'Reed-Solomon FEC',
  [ShowcaseStrings.Feat_OFFS_Tech3]: 'ブロックチェーン台帳',
  [ShowcaseStrings.Feat_OFFS_HL1]:
    'オリジナルのOFFSコンセプトに基づく — XOR混合によりどのブロックにも識別可能なコンテンツが含まれない',
  [ShowcaseStrings.Feat_OFFS_HL2]:
    'ECIES非対称暗号化によりXOR難読化を超えた暗号セキュリティ層を追加',
  [ShowcaseStrings.Feat_OFFS_HL3]:
    'Reed-Solomon FECパリティブロックがノードオフライン時でも冗長性と耐久性を提供',
  [ShowcaseStrings.Feat_OFFS_HL4]:
    'デジタルブロックチェーン台帳がすべてのブロック操作の改ざん不可能な記録を維持',
  [ShowcaseStrings.Feat_OFFS_HL5]:
    'Digital Burnbagは内容へのアクセスなしにファイル破棄を保証 — 台帳により証明可能',
  [ShowcaseStrings.Feat_OFFS_HL6]:
    'Digital Burnbag Vaultホワイトペーパーに詳細な数学的基礎を掲載 — https://github.brightchain.org/docs/papers/digital-burnbag-vault/',
  ...
  [ShowcaseStrings.Feat_BrightMail_HL8]: '送信者認証のためのデジタル署名',
  ...
  [ShowcaseStrings.Feat_BrightChat_HL8]: 'チャンネル履歴内の全文メッセージ検索',
  ...
  [ShowcaseStrings.Feat_BrightPass_HL10]: 'ブラウザ拡張機能オートフィルAPI対応',
  ...
  [ShowcaseStrings.Feat_BrightVote_HL6]: '階層的集約：投票区 → 郡 → 州 → 全国',
  ...
  [ShowcaseStrings.Feat_BrightVote_HL9]: '定数時間演算によるタイミング攻撃耐性',
  ...
  [ShowcaseStrings.Feat_Encryption_HL3]: 'BIP39/32ニーモニックベースの認証',
  ...
  [ShowcaseStrings.Feat_BrightID_HL4]: '公開鍵ベースの認証（SECP256k1）',
  [ShowcaseStrings.Feat_BrightID_HL5]:
    'アイデンティティバックアップのための前方誤り訂正',
  [ShowcaseStrings.Feat_BrightID_HL6]: 'プライバシー保護型アイデンティティ検証',
  ...
  [ShowcaseStrings.Feat_Reputation_HL5]: 'ストレージと帯域幅コストの追跡と補償',
  ...
  [ShowcaseStrings.Feat_CrossPlatform_HL5]: '再現可能な暗号結果',
  ...
  [ShowcaseStrings.Feat_Contracts_HL6]: '透明で監査可能なガバナンスプロセス',
  ...
  [ShowcaseStrings.Soup_AlertUploadCBLOnly]:
    '.cblファイルをアップロードしてください',
  ...
  [ShowcaseStrings.Soup_AlertMessageSent]:
    'メッセージが送信され、スープに保存されました！',
  [ShowcaseStrings.Soup_AlertSendFailed]:
    'メッセージの送信に失敗しました：{ERROR}',
  ...
  [ShowcaseStrings.Soup_AlertCopied]:
    'マグネットURLがクリップボードにコピーされました！',
  ...
  [ShowcaseStrings.Edu_StepsCompleted]: '{COMPLETED}/{TOTAL}ステップ完了',
  ...
  [ShowcaseStrings.Enc_PaddingSameSize]:
    'すべてのブロックは同じサイズでなければなりません',
  [ShowcaseStrings.Enc_PaddingPreventsAnalysis]:
    'ランダムパディングがデータ分析を防止します',
  [ShowcaseStrings.Enc_PaddingRemoved]: 'パディングは再構築時に除去されます',
  ...
  [ShowcaseStrings.Enc_UniqueIdentifier]:
    '一意のブロック識別子として使用されます',
  [ShowcaseStrings.Enc_EnablesVerification]: '取得時の検証を可能にします',
  ...
  [ShowcaseStrings.PP_S7_P2]: 'ただし、BrightChainのアーキテクチャ設計により：',
  ...
  [ShowcaseStrings.PP_S11_1_Title]: '11.1 欧州経済領域（EEA）および英国',
