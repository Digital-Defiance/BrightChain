/**
 * @fileoverview Property-based tests for BrightTrustService seal/unseal operations
 *
 * **Feature: backend-blockstore-brightTrust, Property 9: Seal/Unseal Round-Trip**
...
import { BrightTrustMemberMetadata } from '../interfaces/services/brightTrustService';
import { BrightTrustService } from './brightTrustService';
...
describe('BrightTrustService Seal/Unseal Property Tests', () => {
  beforeAll(() => {
   ...
   */
  function createBrightTrustService(): BrightTrustService<GuidV4Uint8Array> {
    // BrightTrustService now uses getBrightChainConfigKey() internally
    // so we don't need to pass providers explicitly
    return new BrightTrustService<GuidV4Uint8Array>();
  }
