/**
 * @fileoverview Property-based tests for BrightTrustService member management
 *
 * **Feature: backend-blockstore-brightTrust, Property 6: Member Management Round-Trip**
...
describe('BrightTrustService Member Management Property Tests', () => {
  beforeAll(() => {
      ...
      await fc.assert(
        fc.asyncProperty(
          ...
          async (name, emailSuffix, role) => {
            const testService = new BrightTrustService<GuidV4Uint8Array>();
