...
const features: Feature[] = [
  ...
  },
  {
    ...
    tech: ['Gossip Protocol', 'ECIES', 'WebSocket', 'Bloom Filters'],
    category: 'Network',
    highlights: [
  ...
  },
  {
    ...
    tech: ['RFC 5322', 'RFC 2045', 'MIME', 'Threading'],
    category: 'Network',
    highlights: [
  ...
  },
  {
    ...
    tech: ['VCBL', 'TOTP', 'AES-256-GCM', 'Shamir Sharing'],
    category: 'Identity',
    highlights: [
        ...
        >
          ...
          <div className="problem-solution">
            <div className="problem">
              ...
              <p>
                <strong>Result:</strong> Blockchain technology that's
                environmentally destructive, legally risky, and functionally
                limited.
              </p>
            </div>
            <div className="solution">
              ...
              <p>
                ...
                <strong>proof-of-work only for throttling</strong>, not
                consensus. The <strong>Owner-Free File System</strong> provides
                legal immunity by storing only XOR-randomized blocks.{' '}
                <strong>Homomorphic voting</strong> enables privacy-preserving
                elections, while <strong>brokered anonymity</strong> balances
                privacy with accountability.
              </p>
              <p>
                Built on <strong>Ethereum's keyspace</strong> but engineered
                without proof-of-work constraints, BrightChain monetizes{' '}
                <strong>unused storage</strong> on personal devices, creating a
                sustainable P2P network. The <strong>quorum system</strong>{' '}
                provides democratic governance with mathematical security
                guarantees.
              </p>
            </div>
          </div>
          <div className="value-props">
            ...
            <div className="value-prop">
              ...
              <p>
                Privacy-preserving elections with vote tallying that never
                reveals individual votes
              </p>
            </div>
            <div className="value-prop">
