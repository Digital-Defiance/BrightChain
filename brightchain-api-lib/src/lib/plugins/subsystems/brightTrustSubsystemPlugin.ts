...
export class BrightTrustSubsystemPlugin implements IAppSubsystemPlugin {
  ...
  private brightTrustDbAdapter: BrightTrustDatabaseAdapter<PlatformID> | null =
    null;
  private brightTrustStateMachine: BrightTrustStateMachine<PlatformID> | null =
    null;
  private identityExpirationScheduler: IdentityExpirationScheduler<PlatformID> | null =
    null;
  private brightTrustGossipHandler: BrightTrustGossipHandler<PlatformID> | null =
    null;
  ...
  public async initialize(context: ISubsystemContext): Promise<void> {
    ...
    this.identityExpirationScheduler =
      new IdentityExpirationScheduler<PlatformID>(
        this.brightTrustDbAdapter,
        auditLogService,
      );
    ...
    context.services.register(
      ...
      () => (gossipService: GossipService) => {
        this.brightTrustGossipHandler =
          new BrightTrustGossipHandler<PlatformID>(
            gossipService,
            this.brightTrustStateMachine!,
            this.brightTrustDbAdapter!,
          );
