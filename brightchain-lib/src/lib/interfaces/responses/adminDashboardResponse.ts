...
export interface IAdminDashboardData {
  ...
  /** Fake email capture stats — only present when EMAIL_SERVICE=fake or DISABLE_EMAIL_SEND=true */
  fakeEmail?: {
    /** Number of unique recipient addresses with captured emails */
    recipientCount: number;
    /** Total number of emails captured across all recipients */
