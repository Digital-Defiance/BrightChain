...
export const AmericanEnglishStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    'No block store registered in the service container. Ensure database initialization has completed before constructing BlockStoreService.',
  ...
  // Splash - Early Development Banner
  [BrightChainStrings.Splash_EarlyDev_Title]:
    '\uD83D\uDEA7 Early Development — Work in Progress',
  [BrightChainStrings.Splash_EarlyDev_Body]:
    'BrightChain is a work in progress. Most features are under active development and not fully functional. Everything is very rudimentary while we bootstrap the network.',
  [BrightChainStrings.Splash_EarlyDev_Team]: 'Small Team',
  [BrightChainStrings.Splash_EarlyDev_TeamDescription]:
    'The development team currently consists of one person and an AI assistant. We are actively looking for co-developers and first peer nodes for the network.',
  [BrightChainStrings.Splash_EarlyDev_DataWarning]: 'Data May Be Purged',
  [BrightChainStrings.Splash_EarlyDev_DataWarningDescription]:
    'We cannot guarantee data persistence. The database may need to be purged for backwards-incompatible changes before stability is reached. Please do not store anything irreplaceable.',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarning]: 'No Uptime Guarantee',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription]:
    'There is a single production node with no redundancy, set up manually with no automation. Outages are possible at any time.',
  [BrightChainStrings.Splash_EarlyDev_GetInvolved]: 'Get Involved',
  [BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription]:
    'Donations and contributions of time are very welcome and would meaningfully accelerate development. If you are interested in co-developing or running a peer node, please reach out.',
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'Fake Email (Dev)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: 'Recipients',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: 'Captured',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: 'Joule',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]: 'Joule Ledger Administration',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    "Operational credit / debit / adjust on a user's energy account. Until the contribution & provider systems are live, all Joule movement is performed manually here. Every action is recorded in the persistent admin audit log below.",
  [BrightChainStrings.Admin_Joule_SelectUser]: 'Select User',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    'Search by username or email (min 2 chars)',
  [BrightChainStrings.Admin_Joule_Searching]: 'Searching…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    'Selected: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'Clear',
  [BrightChainStrings.Admin_Joule_AccountSection]: 'Account',
  [BrightChainStrings.Admin_Joule_FieldBalance]: 'Balance',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: 'Available',
  [BrightChainStrings.Admin_Joule_FieldReserved]: 'Reserved',
  [BrightChainStrings.Admin_Joule_FieldEarned]: 'Earned',
  [BrightChainStrings.Admin_Joule_FieldSpent]: 'Spent',
  [BrightChainStrings.Admin_Joule_FieldReputation]: 'Reputation',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: 'Last updated',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: 'Adjust Balance',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'Action',
  [BrightChainStrings.Admin_Joule_ActionCredit]: 'Credit (add Joule)',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'Debit (remove Joule)',
  [BrightChainStrings.Admin_Joule_ActionAdjust]:
    'Adjust (set absolute target balance)',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    'Credit amount (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]:
    'Debit amount (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    'Target balance (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: 'Amount',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    'Decimal microJoule string. 1 J = 1,000,000 µJ. Adjust accepts a non-negative target.',
  [BrightChainStrings.Admin_Joule_ReasonLabel]:
    'Reason (required, max 256 chars)',
  [BrightChainStrings.Admin_Joule_MemoLabel]: 'Memo (optional, max 1024 chars)',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'Credit',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'Debit',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: 'Set Balance',
  [BrightChainStrings.Admin_Joule_RecentActionsSection]: 'Recent Admin Actions',
  [BrightChainStrings.Admin_Joule_NoActions]:
    'No admin actions recorded for this user.',
  [BrightChainStrings.Admin_Joule_ColWhen]: 'When',
  [BrightChainStrings.Admin_Joule_ColAction]: 'Action',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: 'Balance after',
  [BrightChainStrings.Admin_Joule_ColReason]: 'Reason',
  [BrightChainStrings.Admin_Joule_ColActor]: 'Actor',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'Load more',
  [BrightChainStrings.Admin_Joule_LoadingMore]: 'Loading…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'End of log.',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]:
    'Confirm Joule {ACTION}',
  ...
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    'Target balance: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    'Amount: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: 'Reason: {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'Memo: {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'This change writes directly to the operational EnergyAccountStore. Layer-3 ledger reconciliation will occur once the ledger subsystem ships.',
  [BrightChainStrings.Admin_Joule_Submitting]: 'Submitting…',
  [BrightChainStrings.Admin_Joule_Confirm]: 'Confirm',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]:
    'Failed to load Joule account',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]: 'Failed to load more events',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: 'Operation failed',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]:
    '{ACTION} successful. Δ {DELTA}',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'Blocks',
  [BrightChainStrings.Explorer_Nav_Pools]: 'Pools',
  [BrightChainStrings.Explorer_Nav_Search]: 'Search',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'Search by block hash prefix…',
  [BrightChainStrings.Explorer_SearchButton]: 'Search',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} result(s)',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'No blocks found.',
  [BrightChainStrings.Explorer_PoolsTitle]: 'Storage Pools',
  [BrightChainStrings.Explorer_PoolsNone]: 'No pools found.',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} blocks',
  [BrightChainStrings.Explorer_BlockDetail]: 'Block Detail',
  [BrightChainStrings.Explorer_BackToBlocks]: '← Back to blocks',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'Locate on Network',
  [BrightChainStrings.Explorer_Locating]: 'Locating…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'Network Locate',
  [BrightChainStrings.Explorer_NetworkFound]: 'Found',
  [BrightChainStrings.Explorer_NetworkNotFound]: 'Not found',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    'Queried {PEERS} peers in {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'No nodes found holding this block.',
  [BrightChainStrings.Explorer_ColHash]: 'Hash',
  [BrightChainStrings.Explorer_ColPool]: 'Pool',
  [BrightChainStrings.Explorer_ColSize]: 'Size',
  [BrightChainStrings.Explorer_ColCreated]: 'Created',
  [BrightChainStrings.Explorer_PageTemplate]: 'Page {PAGE} · {TOTAL} total',
  [BrightChainStrings.Explorer_Previous]: 'Previous',
  [BrightChainStrings.Explorer_Next]: 'Next',
  [BrightChainStrings.Explorer_BlockNotFound]: 'Block not found',
  [BrightChainStrings.Explorer_LocateFailed]: 'Network locate failed',
  [BrightChainStrings.Explorer_FetchFailed]: 'Failed to fetch blocks',
  [BrightChainStrings.Explorer_SearchFailed]: 'Search failed',
  [BrightChainStrings.Explorer_Parity]: 'Parity',
  ...
  [BrightChainStrings.Error_Friends_AlreadyFriends]:
    'You are already friends with this member',
  ...
  [BrightChainStrings.Error_Friends_RequestNotFound]:
    'Friend request not found or is not pending',
  [BrightChainStrings.Error_Friends_NotFriends]:
    'No friendship exists between these members',
  [BrightChainStrings.Error_Friends_UserBlocked]:
    'Cannot perform friend operation due to a block between members',
  ...
  [BrightChainStrings.Friends_RequestSent]: 'Friend request sent',
  [BrightChainStrings.Friends_RequestAccepted]: 'Friend request accepted',
  [BrightChainStrings.Friends_RequestRejected]: 'Friend request rejected',
  [BrightChainStrings.Friends_RequestCancelled]: 'Friend request cancelled',
  [BrightChainStrings.Friends_Removed]: 'Friend removed',
  [BrightChainStrings.Friends_ListRetrieved]: 'Friends list retrieved',
  ...
  [BrightChainStrings.Friends_StatusRetrieved]: 'Friendship status retrieved',
  [BrightChainStrings.Friends_MutualRetrieved]: 'Mutual friends retrieved',
  [BrightChainStrings.Friends_Unauthenticated]: 'Authentication required',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    'Rate limit exceeded. Complete the attached work unit to proceed.',
  [BrightChainStrings.Error_PoUW_Middleware_WorkVerificationFailed]:
    'Work result verification failed.',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_MissingWorkResult]:
    'Missing work result in request body.',
