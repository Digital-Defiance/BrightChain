...
export abstract class BaseMemberDocument {
  ...
  public get privateKey() {
    return this.publicData.privateKey
      ? Buffer.from(this.publicData.privateKey, 'base64')
      : undefined;
  }
  ...
  public get votingPrivateKey() {
    return this.publicData.votingPrivateKey
      ? Buffer.from(this.publicData.votingPrivateKey, 'base64')
      : undefined;
  }
