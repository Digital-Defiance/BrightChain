...
export const FrenchStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'Rechercher par préfixe de hash…',
  [BrightChainStrings.Explorer_SearchButton]: 'Rechercher',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} résultat(s)',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: '{PEERS} pairs interrogés en {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'Aucun nœud trouvé détenant ce bloc.',
