...
export class BrightChainMember {
  private constructor(
    ...
    if (factoryToken !== FACTORY_TOKEN) {
      throw new FactoryPatternViolationError('BrightChainMember');
    }
  }
   ...
   * @returns A new BrightChainMember instance
   */
  static newMember(
    type: MemberType,
    name: string,
    ...
    return new BrightChainMember(FACTORY_TOKEN, type, name, contactEmail, email);
  }
}
```
