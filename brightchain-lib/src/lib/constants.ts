...
export const ENCRYPTION = {
  ...
  RECIPIENT_ID_SIZE: BaseConstants.idProvider.byteLength,
} as const;
...
/**
 * GUID size in bytes (derived from idProvider)
 * Re-exported for backward compatibility
 */
export const GUID_SIZE = BaseConstants.idProvider.byteLength;
