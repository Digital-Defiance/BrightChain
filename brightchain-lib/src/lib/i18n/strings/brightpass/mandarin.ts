...
export const BrightPassMandarinStrings: StringsCollection<BrightPassStringKey> =
  {
    // Menu
    ...
    [BrightPassStrings.TOTP_SecondsRemaining]: '剩余{SECONDS}秒',
    ...
    [BrightPassStrings.Import_Imported]: '成功导入{COUNT}个条目',
    [BrightPassStrings.Import_Skipped]: '跳过{COUNT}个条目',
    [BrightPassStrings.Import_Errors]: '第{INDEX}行：{MESSAGE}',
