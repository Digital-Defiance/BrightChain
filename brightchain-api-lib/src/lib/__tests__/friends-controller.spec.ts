...
function createTestApp(
  ...
  // Catch-all error handler — prevents socket hang up if an unexpected error
  // reaches Express without a registered error handler (e.g. in parallel Jest
  // workers where module identity issues cause instanceof checks to fail).
