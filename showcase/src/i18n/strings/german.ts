...
> = {
  ...
  [ShowcaseStrings.FAQ_Tech_Q9_Quorum_Label]: 'Das Quorum',
  [ShowcaseStrings.FAQ_Tech_Q9_Quorum]:
    'Die Identität ist kryptographisch an ein Governance-Quorum gebunden. Dies stellt sicher, dass, obwohl die Daten und Aktionen eines Benutzers privat sind, die Gemeinschaft eine „Soziale Schicht" der Verantwortlichkeit über Shamirs Secret Sharing und homomorphe Abstimmung aufrechterhält.',
  ...
  [ShowcaseStrings.FAQ_Tech_Q10_QuorumBasedAccess_Label]:
    'Quorum-basierter Zugang',
  [ShowcaseStrings.FAQ_Tech_Q10_QuorumBasedAccess]:
    'Der Zugang zu bestimmten Datenbanken oder Sammlungen kann durch ein Quorum gesteuert werden, das kryptographische Genehmigung von autorisierten Unterzeichnern erfordert.',
  ...
  [ShowcaseStrings.Comp_Solution_P2]:
    'Aufgebaut auf dem Schlüsselraum von Ethereum, aber ohne Proof-of-Work-Einschränkungen entwickelt, monetarisiert BrightChain ungenutzten Speicher auf persönlichen Geräten und schafft ein nachhaltiges P2P-Netzwerk. Das Quorum-System bietet demokratische Governance mit mathematischen Sicherheitsgarantien.',
  ...
  [ShowcaseStrings.Comp_VP_Anonymous_Desc]:
    'Privatsphäre mit Moderationsmöglichkeiten — vermittelte Anonymität durch Quorum-Konsens',
  ...
  [ShowcaseStrings.About_Feature_Anonymous_Desc]:
    'Privatsphäre mit Moderationsmöglichkeiten. Vermittelte Anonymität bringt Privatsphäre und Rechenschaftspflicht durch Quorum-Konsens in Einklang.',
