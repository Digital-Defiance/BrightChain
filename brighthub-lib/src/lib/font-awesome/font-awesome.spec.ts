...
describe('font-awesome', () => {
  ...
  describe('style and family lists', () => {
    ...
    it('should include sharp compound names', () => {
      expect(FontAwesomeIconStyleStrings).toContain('sharpregular');
      expect(FontAwesomeIconStyleStrings).toContain('sharplight');
      expect(FontAwesomeIconStyleStrings).toContain('sharpthin');
    });
  });
  ...
  describe('extractIconDetails', () => {
    ...
    it('should handle sharp-duotone family', () => {
      expect(extractIconDetails(['sharp-duotone', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['sharp-duotone', 'solid'],
        additionalClasses: [],
      });
    });
    ...
    it('should handle sharpregular compound as two base classes', () => {
      expect(extractIconDetails(['sharpregular', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['sharp', 'regular'],
        additionalClasses: [],
      });
    });

    it('should handle sharplight compound as two base classes', () => {
      expect(extractIconDetails(['sharplight', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['sharp', 'light'],
        additionalClasses: [],
      });
    });

    it('should handle sharpthin compound as two base classes', () => {
      expect(extractIconDetails(['sharpthin', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['sharp', 'thin'],
        additionalClasses: [],
      });
    });
    ...
    it('should handle utility family', () => {
      expect(extractIconDetails(['utility', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['utility', 'semibold'],
        additionalClasses: [],
      });
    });
    ...
    it('should handle whiteboard family', () => {
      expect(extractIconDetails(['whiteboard', 'heart'])).toEqual({
        iconName: 'heart',
        iconBaseClass: ['whiteboard', 'semibold'],
        additionalClasses: [],
      });
    });
  ...
  describe('parseIconMarkup', () => {
    ...
    it('should handle all valid style/family classes', () => {
      // Styles that expand to multiple CSS classes via STYLE_TO_CSS_CLASSES
      const multiClassStyles: Record<string, string> = {
      ...
      FontAwesomeIconStyles.forEach((iconClass) => {
        const expectedPrefix = multiClassStyles[iconClass] ?? `fa-${iconClass}`;
        expect(parseIconMarkup(`{{${iconClass} heart}}`)).toBe(
          `<i class="${expectedPrefix} fa-heart" style="display: inline-block;"></i>`,
        );
      });
    });
    ...
    it('should render sharp-duotone family icons', () => {
      expect(parseIconMarkup('{{sharp-duotone heart}}')).toBe(
        '<i class="fa-sharp-duotone fa-solid fa-heart" style="display: inline-block;"></i>',
      );
    });

    it('should render chisel family icons', () => {
      expect(parseIconMarkup('{{chisel heart}}')).toBe(
        '<i class="fa-chisel fa-regular fa-heart" style="display: inline-block;"></i>',
      );
    });

    it('should render utility family icons', () => {
      expect(parseIconMarkup('{{utility heart}}')).toBe(
        '<i class="fa-utility fa-semibold fa-heart" style="display: inline-block;"></i>',
      );
    });

    it('should render whiteboard family icons', () => {
      expect(parseIconMarkup('{{whiteboard heart}}')).toBe(
        '<i class="fa-whiteboard fa-semibold fa-heart" style="display: inline-block;"></i>',
      );
    });
