...
**Compound**: sharpsolid, sharpregular, sharplight, sharpthin (expand to \`fa-sharp fa-{style}\`)
...
**Compound names**:
sharpsolid, sharpregular, sharplight, sharpthin (expand to \`fa-sharp fa-{style}\`)
