...
export interface IAppSubsystemPlugin {
   ...
   *
   * @returns `true` (or `void`/`undefined`) when the plugin started
   *          normally; `false` when it intentionally skipped
   *          initialization (e.g. a feature gate was off). The caller
   *          uses this to decide whether to log a "ready" message.
   */
  initialize(context: ISubsystemContext): Promise<boolean | void>;
