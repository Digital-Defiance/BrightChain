...
- [ ] 4.5 Fix whitened.spec.ts
  - Remove payload property access (use correct property)
  - _Requirements: 6.1_

- [ ] 4.6 Fix ephemeral.spec.ts
  - Fix constructor parameter count (remove extra parameter)
  - Fix ChecksumBuffer/ChecksumUint8Array conversions
  - Add email parameter to BrightChainMember.newMember()
  - Remove payload property access
  - Fix equals() method calls on checksums
  - _Requirements: 8.3, 1.2, 4.1, 6.1, 1.3_

- [ ] 4.7 Fix encrypted.spec.ts
...
- [ ] 5. Fix Service and Interface Issues
...
- [ ] 5.1 Fix blockCapacity.service.spec.ts
...
- [ ] 5.2 Fix fec.service.spec.ts
  - Fix BaseBlock type casting (convert through 'unknown')
  - _Requirements: 7.3_

- [ ] 5.3 Fix interfaces/constants.spec.ts
...
- [ ] 7. Checkpoint - Verify all tests compile
...
- [ ] 8. Run test suite and fix runtime issues
