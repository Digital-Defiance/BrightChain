...
/**
 * DiskBrightTrustService extends BrightTrustService with disk-based persistence
 ...
 */
export class DiskBrightTrustService<
...
> extends BrightTrustService<TID> {
   ...
   * This is needed because unsealDocument requires the full BrightTrustDataRecord
   */
  async loadDocumentForUnseal(documentId: TID): Promise<void> {
    ...
    // Note: Full reconstruction of BrightTrustDataRecord from disk would require
