...
export const ShowcaseAmericanEnglishStrings: ComponentStrings<ShowcaseStringKey> =
  {
    ...
    [ShowcaseStrings.FAQ_Tech_Q11_BrightChat_Text]:
      'A real-time communications platform with persistent channels, voice, and media sharing. Community governance is managed via BrightTrusts, and GPU-accelerated recovery ensures chat history is never lost.',
    ...
    [ShowcaseStrings.FAQ_Tech_Q16_Answer]:
      'IPFS is transparent by default; if you have the hash, you can see the file. BrightChain uses an XOR Baseline. Data is functionally "Shredded" before it ever touches the network. Privacy isn\'t a "plugin" — it is the mechanical state of the data.',
