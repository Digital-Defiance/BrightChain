...
describe('ConnectionSuggestions', () => {
  ...
  it('displays suggestion reason labels', () => {
    ...
    expect(screen.getByText('mutual_connections')).toBeInTheDocument();
    expect(screen.getByText('similar_interests')).toBeInTheDocument();
    expect(screen.getByText('similar_to_user')).toBeInTheDocument();
  });
