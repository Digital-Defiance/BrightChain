...
export interface IBaseBlock {
   ...
   */
  get layerPayload(): Uint8Array | Uint8Array;
   ...
   */
  get fullHeaderData(): Uint8Array | Uint8Array;
  /**
   ...
   */
  get layerHeaderData(): Uint8Array | Uint8Array;

  /**
   * Gets the layer's data including header and payload
   */
  get layerData(): Uint8Array | Uint8Array;
