...
export const GermanStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Error_SealingError_InsufficientSharesForReconstruction]:
    'Unzureichende Anteile für die Schlüsselrekonstruktion',
  [BrightChainStrings.Error_SealingError_KeyReconstructionFailed]:
    'Schlüsselrekonstruktion fehlgeschlagen',
  ...
  [BrightChainStrings.Error_MessageMetadataSchema_InvalidEncryptionSchemeFormat]:
    'Ungültiges Verschlüsselungsschemaformat',
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    'Kein Blockspeicher im Dienstcontainer registriert. Stellen Sie sicher, dass die Datenbankinitialisierung abgeschlossen ist, bevor BlockStoreService erstellt wird.',
  ...
  [BrightChainStrings.Splash_NotACryptocurrency]: 'Keine Kryptowährung',
  ...
  [BrightChainStrings.Splash_Documentation]: 'Dokumentation',
  [BrightChainStrings.Splash_FAQ]: 'Häufig gestellte Fragen',
  [BrightChainStrings.Splash_PrivacyPolicy]: 'Datenschutzrichtlinie',
  [BrightChainStrings.Splash_TermsOfService]: 'Nutzungsbedingungen',

  // Splash - Banner für frühe Entwicklungsphase
  [BrightChainStrings.Splash_EarlyDev_Title]:
    '🚧 Frühe Entwicklung — Arbeit im Gange',
  [BrightChainStrings.Splash_EarlyDev_Body]:
    'BrightChain ist ein laufendes Projekt. Die meisten Funktionen sind in aktiver Entwicklung und noch nicht vollständig funktionsfähig. Alles ist noch sehr rudimentär, während wir das Netzwerk aufbauen.',
  [BrightChainStrings.Splash_EarlyDev_Team]: 'Kleines Team',
  [BrightChainStrings.Splash_EarlyDev_TeamDescription]:
    'Das Entwicklungsteam besteht derzeit aus einer Person und einem KI-Assistenten. Wir suchen aktiv nach Co-Entwicklern und ersten Peer-Knoten für das Netzwerk.',
  ...
  [BrightChainStrings.Splash_EarlyDev_DataWarningDescription]:
    'Wir können keine Datenpersistenz garantieren. Die Datenbank muss möglicherweise aufgrund rückwärtsinompatibler Änderungen bereinigt werden, bevor Stabilität erreicht wird. Bitte speichern Sie nichts Unersetzliches.',
  ...
  [BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription]:
    'Es gibt einen einzigen Produktionsknoten ohne Redundanz, der manuell ohne Automatisierung eingerichtet wurde. Ausfälle sind jederzeit möglich.',
  [BrightChainStrings.Splash_EarlyDev_GetInvolved]: 'Mitmachen',
  [BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription]:
    'Spenden und Zeitbeiträge sind sehr willkommen und würden die Entwicklung deutlich beschleunigen. Wenn Sie an einer Co-Entwicklung oder dem Betrieb eines Peer-Knotens interessiert sind, nehmen Sie bitte Kontakt auf.',
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'Fake-E-Mail (Dev)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: 'Empfänger',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: 'Erfasst',
  [BrightChainStrings.Admin_Menu_Dashboard]: 'Admin-Dashboard',
  [BrightChainStrings.Admin_Menu_Users]: 'Benutzerverwaltung',
  [BrightChainStrings.Admin_Menu_Blocks]: 'Admin Block-Explorer',
  [BrightChainStrings.Admin_Menu_Chat]: 'Chat-Verwaltung',
  [BrightChainStrings.Admin_Menu_Hub]: 'Hub-Verwaltung',
  [BrightChainStrings.Admin_Menu_Mail]: 'Mail-Verwaltung',
  [BrightChainStrings.Admin_Menu_Pass]: 'Pass-Verwaltung',
  [BrightChainStrings.Admin_Menu_About]: 'Über',
  [BrightChainStrings.Admin_Menu_Joule]: 'Joule-Verwaltung',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]: 'Joule-Ledger-Verwaltung',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    'Operatives Gutschreiben / Belasten / Anpassen auf dem Energiekonto eines Benutzers. Bis das Beitrags- und Anbietersystem live ist, werden alle Joule-Bewegungen hier manuell durchgeführt. Jede Aktion wird im persistenten Admin-Auditprotokoll unten erfasst.',
  [BrightChainStrings.Admin_Joule_SelectUser]: 'Benutzer auswählen',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    'Nach Benutzername oder E-Mail suchen (min. 2 Zeichen)',
  [BrightChainStrings.Admin_Joule_Searching]: 'Suche…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    'Ausgewählt: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'Zurücksetzen',
  [BrightChainStrings.Admin_Joule_AccountSection]: 'Konto',
  [BrightChainStrings.Admin_Joule_FieldBalance]: 'Saldo',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: 'Verfügbar',
  [BrightChainStrings.Admin_Joule_FieldReserved]: 'Reserviert',
  [BrightChainStrings.Admin_Joule_FieldEarned]: 'Verdient',
  [BrightChainStrings.Admin_Joule_FieldSpent]: 'Ausgegeben',
  [BrightChainStrings.Admin_Joule_FieldReputation]: 'Reputation',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: 'Zuletzt aktualisiert',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: 'Saldo anpassen',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'Aktion',
  [BrightChainStrings.Admin_Joule_ActionCredit]:
    'Gutschreiben (Joule hinzufügen)',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'Belasten (Joule entfernen)',
  [BrightChainStrings.Admin_Joule_ActionAdjust]:
    'Anpassen (absoluten Zielsaldo festlegen)',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    'Gutschriftbetrag (MicroJoule, Dezimal)',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]:
    'Belastungsbetrag (MicroJoule, Dezimal)',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    'Zielsaldo (MicroJoule, Dezimal)',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: 'Betrag',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    'Dezimaler MicroJoule-String. 1 J = 1.000.000 µJ. Anpassung akzeptiert ein nicht-negatives Ziel.',
  [BrightChainStrings.Admin_Joule_ReasonLabel]:
    'Grund (erforderlich, max. 256 Zeichen)',
  [BrightChainStrings.Admin_Joule_MemoLabel]:
    'Notiz (optional, max. 1024 Zeichen)',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'Gutschreiben',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'Belasten',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: 'Saldo setzen',
  [BrightChainStrings.Admin_Joule_RecentActionsSection]:
    'Letzte Admin-Aktionen',
  [BrightChainStrings.Admin_Joule_NoActions]:
    'Für diesen Benutzer wurden keine Admin-Aktionen erfasst.',
  [BrightChainStrings.Admin_Joule_ColWhen]: 'Wann',
  [BrightChainStrings.Admin_Joule_ColAction]: 'Aktion',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: 'Saldo danach',
  [BrightChainStrings.Admin_Joule_ColReason]: 'Grund',
  [BrightChainStrings.Admin_Joule_ColActor]: 'Akteur',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'Mehr laden',
  [BrightChainStrings.Admin_Joule_LoadingMore]: 'Lädt…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'Ende des Protokolls.',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]:
    'Joule {ACTION} bestätigen',
  [BrightChainStrings.Admin_Joule_ConfirmUserTemplate]:
    'Benutzer: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]: 'Aktion: {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    'Zielsaldo: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    'Betrag: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: 'Grund: {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'Notiz: {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'Diese Änderung wird direkt in den operativen EnergyAccountStore geschrieben. Die Layer-3-Ledger-Abstimmung erfolgt, sobald das Ledger-Subsystem ausgeliefert wird.',
  [BrightChainStrings.Admin_Joule_Submitting]: 'Wird gesendet…',
  [BrightChainStrings.Admin_Joule_Confirm]: 'Bestätigen',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]:
    'Joule-Konto konnte nicht geladen werden',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]:
    'Weitere Ereignisse konnten nicht geladen werden',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]:
    'Vorgang fehlgeschlagen',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]:
    '{ACTION} erfolgreich. Δ {DELTA}',
  ...
  [BrightChainStrings.Admin_Users_ColRole]: 'Rolle',
  [BrightChainStrings.Admin_Users_ChangeRole]: 'Rolle ändern',
  [BrightChainStrings.Admin_Users_ChangeRoleTitle]: 'Benutzerrolle ändern',
  [BrightChainStrings.Admin_Users_ChangeRoleConfirmTemplate]:
    'Sind Sie sicher, dass Sie {USERNAME} von {OLD_ROLE} zu {NEW_ROLE} ändern möchten?',
  [BrightChainStrings.Admin_Users_ChangeRoleWarning]:
    ' Das Ändern eines Benutzers zu Admin gewährt vollen administrativen Zugriff.',
  [BrightChainStrings.Admin_Users_RoleAdmin]: 'Admin',
  [BrightChainStrings.Admin_Users_RoleMember]: 'Mitglied',
  ...
  [BrightChainStrings.Admin_Users_CannotChangeSystemUser]:
    'Die Rolle des Systembenutzers kann nicht geändert werden.',
  [BrightChainStrings.Admin_Users_DeleteUser]: 'Benutzer löschen',
  [BrightChainStrings.Admin_Users_DeleteUserTitle]: 'Benutzer löschen',
  [BrightChainStrings.Admin_Users_DeleteConfirmTemplate]:
    'Sind Sie sicher, dass Sie den Benutzer „{USERNAME}" dauerhaft löschen möchten? Dadurch werden seine CBLs, Einstellungen und alle Datenbankeinträge entfernt. Diese Aktion kann nicht rückgängig gemacht werden.',
  [BrightChainStrings.Admin_Users_DeleteWarning]:
    ' Dies ist ein destruktiver Vorgang.',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'Blöcke',
  [BrightChainStrings.Explorer_Nav_Pools]: 'Pools',
  [BrightChainStrings.Explorer_Nav_Search]: 'Suche',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'Nach Block-Hash-Präfix suchen…',
  [BrightChainStrings.Explorer_SearchButton]: 'Suchen',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} Ergebnis(se)',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'Keine Blöcke gefunden.',
  [BrightChainStrings.Explorer_PoolsTitle]: 'Speicher-Pools',
  [BrightChainStrings.Explorer_PoolsNone]: 'Keine Pools gefunden.',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} Blöcke',
  [BrightChainStrings.Explorer_BlockDetail]: 'Block-Details',
  [BrightChainStrings.Explorer_BackToBlocks]: '← Zurück zu Blöcken',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'Im Netzwerk suchen',
  [BrightChainStrings.Explorer_Locating]: 'Suche läuft…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'Netzwerk-Suche',
  [BrightChainStrings.Explorer_NetworkFound]: 'Gefunden',
  [BrightChainStrings.Explorer_NetworkNotFound]: 'Nicht gefunden',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    '{PEERS} Peers in {DURATION}ms abgefragt',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'Keine Knoten gefunden, die diesen Block halten.',
  [BrightChainStrings.Explorer_ColHash]: 'Hash',
  [BrightChainStrings.Explorer_ColPool]: 'Pool',
  [BrightChainStrings.Explorer_ColSize]: 'Größe',
  [BrightChainStrings.Explorer_ColCreated]: 'Erstellt',
  [BrightChainStrings.Explorer_PageTemplate]: 'Seite {PAGE} · {TOTAL} gesamt',
  [BrightChainStrings.Explorer_Previous]: 'Zurück',
  [BrightChainStrings.Explorer_Next]: 'Weiter',
  [BrightChainStrings.Explorer_BlockNotFound]: 'Block nicht gefunden',
  [BrightChainStrings.Explorer_LocateFailed]: 'Netzwerk-Suche fehlgeschlagen',
  [BrightChainStrings.Explorer_FetchFailed]:
    'Blöcke konnten nicht geladen werden',
  [BrightChainStrings.Explorer_SearchFailed]: 'Suche fehlgeschlagen',
  [BrightChainStrings.Explorer_Parity]: 'Parität',
  ...
  [BrightChainStrings.Admin_ChatServers_Title]: 'BrightChat-Serververwaltung',
  [BrightChainStrings.Admin_ChatServers_TabServers]: 'Server',
  [BrightChainStrings.Admin_ChatServers_TabChannels]: 'Kanäle',
  [BrightChainStrings.Admin_ChatServers_TabMembers]: 'Mitglieder',
  [BrightChainStrings.Admin_ChatServers_ColName]: 'Name',
  [BrightChainStrings.Admin_ChatServers_ColOwner]: 'Eigentümer',
  [BrightChainStrings.Admin_ChatServers_ColMembers]: 'Mitglieder',
  [BrightChainStrings.Admin_ChatServers_ColChannels]: 'Kanäle',
  [BrightChainStrings.Admin_ChatServers_ColCreated]: 'Erstellt',
  [BrightChainStrings.Admin_ChatServers_ColActions]: 'Aktionen',
  [BrightChainStrings.Admin_ChatServers_NoServersFound]:
    'Keine Server gefunden.',
  [BrightChainStrings.Admin_ChatServers_DeleteServer]: 'Server löschen',
  [BrightChainStrings.Admin_ChatServers_DeleteServerTitle]: 'Server löschen',
  [BrightChainStrings.Admin_ChatServers_DeleteServerConfirm]:
    'Sind Sie sicher, dass Sie diesen Server löschen möchten? Alle Kanäle und Daten werden dauerhaft entfernt.',
  [BrightChainStrings.Admin_ChatServers_EditServer]: 'Server bearbeiten',
  [BrightChainStrings.Admin_ChatServers_EditServerTitle]: 'Server bearbeiten',
  [BrightChainStrings.Admin_ChatServers_ServerName]: 'Servername',
  [BrightChainStrings.Admin_ChatServers_ServerIcon]: 'Symbol-URL',
  [BrightChainStrings.Admin_ChatServers_Save]: 'Speichern',
  [BrightChainStrings.Admin_ChatServers_ChannelName]: 'Kanalname',
  [BrightChainStrings.Admin_ChatServers_ChannelTopic]: 'Thema',
  [BrightChainStrings.Admin_ChatServers_ChannelVisibility]: 'Sichtbarkeit',
  [BrightChainStrings.Admin_ChatServers_ChannelMembers]: 'Mitglieder',
  [BrightChainStrings.Admin_ChatServers_NoChannelsFound]:
    'Keine Kanäle gefunden.',
  [BrightChainStrings.Admin_ChatServers_DeleteChannel]: 'Kanal löschen',
  [BrightChainStrings.Admin_ChatServers_DeleteChannelTitle]: 'Kanal löschen',
  [BrightChainStrings.Admin_ChatServers_DeleteChannelConfirm]:
    'Sind Sie sicher, dass Sie diesen Kanal löschen möchten? Alle Nachrichten werden dauerhaft entfernt.',
  [BrightChainStrings.Admin_ChatServers_MemberName]: 'Mitglied',
  [BrightChainStrings.Admin_ChatServers_MemberRole]: 'Rolle',
  [BrightChainStrings.Admin_ChatServers_MemberJoined]: 'Beigetreten',
  [BrightChainStrings.Admin_ChatServers_NoMembersFound]:
    'Keine Mitglieder gefunden.',
  [BrightChainStrings.Admin_ChatServers_RemoveMember]: 'Mitglied entfernen',
  [BrightChainStrings.Admin_ChatServers_RemoveMemberTitle]:
    'Mitglied entfernen',
  [BrightChainStrings.Admin_ChatServers_RemoveMemberConfirm]:
    'Sind Sie sicher, dass Sie dieses Mitglied vom Server entfernen möchten?',
  [BrightChainStrings.Admin_ChatServers_ChangeRole]: 'Rolle ändern',
  [BrightChainStrings.Admin_ChatServers_EncryptedNote]:
    'Der Nachrichteninhalt ist Ende-zu-Ende-verschlüsselt und für Administratoren nicht sichtbar.',
  [BrightChainStrings.Admin_ChatServers_FilterByServer]: 'Nach Server filtern',
  [BrightChainStrings.Admin_ChatServers_AllServers]: 'Alle Server',
  [BrightChainStrings.Admin_Menu_ChatServers]: 'Chat-Server',
  ...
  [BrightChainStrings.Error_Friends_SelfRequestNotAllowed]:
    'Sie können sich nicht selbst eine Freundschaftsanfrage senden',
  [BrightChainStrings.Error_Friends_AlreadyFriends]:
    'Sie sind bereits mit diesem Mitglied befreundet',
  [BrightChainStrings.Error_Friends_RequestAlreadyExists]:
    'Eine ausstehende Freundschaftsanfrage existiert bereits',
  [BrightChainStrings.Error_Friends_RequestNotFound]:
    'Freundschaftsanfrage nicht gefunden oder nicht ausstehend',
  [BrightChainStrings.Error_Friends_NotFriends]:
    'Zwischen diesen Mitgliedern besteht keine Freundschaft',
  [BrightChainStrings.Error_Friends_UserBlocked]:
    'Freundschaftsoperation kann aufgrund einer Blockierung zwischen den Mitgliedern nicht durchgeführt werden',
  [BrightChainStrings.Error_Friends_Unauthorized]:
    'Sie sind nicht berechtigt, diese Aktion für diese Freundschaftsanfrage durchzuführen',

  // Friends Controller Response Messages
  [BrightChainStrings.Friends_RequestSent]: 'Freundschaftsanfrage gesendet',
  ...
  [BrightChainStrings.Friends_Removed]: 'Freund entfernt',
  [BrightChainStrings.Friends_ListRetrieved]: 'Freundesliste abgerufen',
  [BrightChainStrings.Friends_ReceivedRequestsRetrieved]:
    'Empfangene Freundschaftsanfragen abgerufen',
  [BrightChainStrings.Friends_SentRequestsRetrieved]:
    'Gesendete Freundschaftsanfragen abgerufen',
  [BrightChainStrings.Friends_StatusRetrieved]: 'Freundschaftsstatus abgerufen',
  [BrightChainStrings.Friends_MutualRetrieved]: 'Gemeinsame Freunde abgerufen',
  [BrightChainStrings.Friends_Unauthenticated]:
  ...
  [BrightChainStrings.Error_PoUW_WorkUnit_MissingFieldTemplate]:
    "WorkUnit parse error: missing required field '{FIELD}'",
  [BrightChainStrings.Error_PoUW_WorkUnit_FieldTypeMismatchTemplate]:
    "WorkUnit parse error: field '{FIELD}' must be a {EXPECTED_TYPE}, got {ACTUAL_TYPE}",
  ...
  [BrightChainStrings.Error_PoUW_WorkResult_MissingFieldTemplate]:
    "WorkResult parse error: missing required field '{FIELD}'",
  [BrightChainStrings.Error_PoUW_WorkResult_FieldTypeMismatchTemplate]:
    "WorkResult parse error: field '{FIELD}' must be a {EXPECTED_TYPE}, got {ACTUAL_TYPE}",

  // PoUW computeWorkUnit Errors
  [BrightChainStrings.Error_PoUW_ComputeWorkUnit_InvalidOperationTemplate]:
    "computeWorkUnit: unsupported operation '{OPERATION}'",
  [BrightChainStrings.Error_PoUW_ComputeWorkUnit_InvalidBase64Input]:
    'computeWorkUnit: inputData is not valid base64',

  // PoUW Middleware Errors
  [BrightChainStrings.Error_PoUW_Middleware_RateLimited]:
    'Anfragelimit überschritten. Bitte warten Sie, bevor Sie es erneut versuchen.',
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    'Anfragelimit überschritten. Schließen Sie die beigefügte Arbeitseinheit ab, um fortzufahren.',
  [BrightChainStrings.Error_PoUW_Middleware_WorkVerificationFailed]:
    'Überprüfung des Arbeitsergebnisses fehlgeschlagen.',
  [BrightChainStrings.Error_PoUW_Middleware_InvalidChallengeToken]:
    'Ungültiges oder abgelaufenes Challenge-Token.',
  [BrightChainStrings.Error_PoUW_Middleware_MissingWorkResult]:
    'Arbeitsergebnis fehlt im Anfragekörper.',
  [BrightChainStrings.Error_PoUW_Middleware_ServiceUnavailable]:
  ...
  [BrightChainStrings.DatePage_HolidayType_Public]: 'Gesetzlicher Feiertag',
