...
> = {
  ...
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_Title]:
    'The Joule vs. Traditional Gas: A Physics-First Economy',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_Intro]:
    'While traditional blockchain "gas" is often an abstract, speculative auction for network priority, the Joule is a unit of measure grounded in the physical reality of computing.',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_CoupledToPhysics_Label]:
    'Coupled to Physics',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_CoupledToPhysics]:
    'Unlike Ethereum gas, which fluctuates based on market demand, the Joule is designed to be directly coupled to real energy usage\u2014measuring the actual CPU cycles, storage space, and bandwidth consumed by a task.',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_PoUW_Label]:
    'Proof of Useful Work (PoUW)',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_PoUW]:
    'Traditional gas is often "burned" during arbitrary calculations. In the BrightStack, you earn Joules by performing essential infrastructure maintenance, such as building Merkle trees for the Digital Burnbag or contributing to BOINC research projects.',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_ResourceUtility_Label]:
    'Resource-Based Utility',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_ResourceUtility]:
    'The Joule economy treats your hardware (like the Apple Silicon M4 Max) as a utility provider. You earn Joules by providing the network with storage, processing power, or bandwidth, turning your device into a self-sustaining node.',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_Thermodynamic_Label]:
    'Thermodynamic Stability',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_Thermodynamic]:
    'By anchoring the unit to microjoules (\u00B5J) spent on operations, the system avoids the hyper-inflation of "magic money" and instead reflects the literal cost of keeping the Owner-Free Filesystem (OFF) alive.',
  [ShowcaseStrings.FAQ_Eco_JoulesVsGas_Summary]:
    'In short: Gas is what you pay to play; the Joule is the current that keeps the lights on.',
  ...
  [ShowcaseStrings.BlogPost_NotFoundDesc]: '您查找的博客文章不存在。',
  ...
  [ShowcaseStrings.Feat_BrightDB_HL4]: '具有B树结构的单字段、复合和唯一索引',
  [ShowcaseStrings.Feat_BrightDB_HL5]:
    '具有提交/中止和乐观并发的多文档ACID事务',
  [ShowcaseStrings.Feat_BrightDB_HL6]: '用于实时插入/更新/删除事件订阅的变更流',
  [ShowcaseStrings.Feat_BrightDB_HL7]:
    '用于即插即用API访问集合的Express REST中间件',
  [ShowcaseStrings.Feat_BrightDB_HL8]: '用于文档自动过期的TTL索引',
  [ShowcaseStrings.Feat_BrightDB_HL9]: '具有严格/中等级别和默认值的模式验证',
  [ShowcaseStrings.Feat_BrightDB_HL10]: '具有加权字段和$text操作符的全文搜索',
  [ShowcaseStrings.Feat_BrightDB_HL11]: '写时复制存储：块永不删除，仅更新映射',
  ...
  [ShowcaseStrings.Feat_OFFS_HL4]: '数字区块链账本对所有块操作保持防篡改记录',
  ...
  [ShowcaseStrings.Feat_BrightMail_HL8]: '用于发件人身份验证的数字签名',
  ...
  [ShowcaseStrings.Feat_BrightChat_HL1]: '私信功能，支持点对点加密对话',
  [ShowcaseStrings.Feat_BrightChat_HL2]: '群聊支持共享加密和自动密钥轮换',
  ...
  [ShowcaseStrings.Feat_BrightChat_HL8]: '频道历史记录中的全文消息搜索',
  [ShowcaseStrings.Feat_BrightChat_HL9]: '无缝将私信对话升级为群聊',
  ...
  [ShowcaseStrings.Feat_BrightPass_HL3]: '密码学安全的密码生成，支持约束条件',
  [ShowcaseStrings.Feat_BrightPass_HL4]: 'TOTP/2FA 支持，可为认证器生成二维码',
  [ShowcaseStrings.Feat_BrightPass_HL5]:
    '通过 Have I Been Pwned API 的 k-匿名性泄露检测',
  [ShowcaseStrings.Feat_BrightPass_HL6]: '所有保险库操作的仅追加加密审计日志',
  [ShowcaseStrings.Feat_BrightPass_HL7]: '通过 Shamir 秘密共享实现紧急访问恢复',
  ...
  [ShowcaseStrings.Feat_BrightPass_HL10]: '浏览器扩展自动填充 API 就绪',
  ...
  [ShowcaseStrings.Feat_BrightVote_HL2]: '通过同态加法实现隐私保护的投票聚合',
  [ShowcaseStrings.Feat_BrightVote_HL3]:
    '15 种以上投票方法：多数制、赞成制、加权、Borda、评分、排名选择、IRV、STAR、STV、二次方、共识等',
  [ShowcaseStrings.Feat_BrightVote_HL4]: '安全分类：完全同态、多轮、不安全',
  [ShowcaseStrings.Feat_BrightVote_HL5]:
    '政府合规：不可变审计日志、公共公告板、可验证回执',
  [ShowcaseStrings.Feat_BrightVote_HL6]: '层级聚合：选区 → 县 → 州 → 全国',
  [ShowcaseStrings.Feat_BrightVote_HL7]:
    '128 位安全级别，采用 Miller-Rabin 素性测试（256 轮）',
  [ShowcaseStrings.Feat_BrightVote_HL8]: '跨平台确定性（Node.js 和浏览器环境）',
  [ShowcaseStrings.Feat_BrightVote_HL9]: '通过常量时间操作抵抗时序攻击',
  ...
  [ShowcaseStrings.Feat_BrightHub_HL2]: '话题对话支持 10 级嵌套和回复层级',
  [ShowcaseStrings.Feat_BrightHub_HL3]: '联系人列表、分类和中心，用于组织关系',
  ...
  [ShowcaseStrings.Feat_BrightHub_HL7]: '通过 WebSocket 实时通知，支持智能分组',
  [ShowcaseStrings.Feat_BrightHub_HL8]:
    '通知偏好：安静时段、勿扰模式、按类别设置',
  [ShowcaseStrings.Feat_BrightHub_HL9]: '受保护账户，支持关注请求审批工作流',
  [ShowcaseStrings.Feat_BrightHub_HL10]:
    '联系人洞察：强度计算、共同联系人、推荐',
  [ShowcaseStrings.Feat_BrightHub_HL11]:
    '基于中心的内容可见性，用于私密群组分享',
  [ShowcaseStrings.Feat_BrightHub_HL12]: '富文本格式，支持 XSS 防护和表情符号',
  ...
  [ShowcaseStrings.Feat_Anonymity_HL1]: '匿名发布，带加密身份备份',
  [ShowcaseStrings.Feat_Anonymity_HL2]:
    '身份分片分布在约 24 个 BrightTrust 成员中',
  [ShowcaseStrings.Feat_Anonymity_HL3]: '重建身份信息需要多数投票',
  [ShowcaseStrings.Feat_Anonymity_HL4]: '有时限的问责制——数据在诉讼时效后过期',
  ...
  [ShowcaseStrings.Feat_Encryption_HL1]: 'ECIES 加密，支持用户特定的密钥派生',
  [ShowcaseStrings.Feat_Encryption_HL2]: 'AES-256-GCM 认证文件加密',
  [ShowcaseStrings.Feat_Encryption_HL3]: 'BIP39/32 基于助记词的认证',
  ...
  [ShowcaseStrings.Feat_Storage_HL1]: '利用个人电脑和设备上的闲置存储空间',
  [ShowcaseStrings.Feat_Storage_HL2]: '分布式哈希表 (DHT) 实现高效的块跟踪',
  [ShowcaseStrings.Feat_Storage_HL3]: '可配置的块持久性和可访问性要求',
  [ShowcaseStrings.Feat_Storage_HL4]: '基于块使用率和访问模式的动态复制',
  [ShowcaseStrings.Feat_Storage_HL5]: '传统工作量证明挖矿的节能替代方案',
  [ShowcaseStrings.Feat_Storage_HL6]: '节点运营者的存储积分和带宽补偿',
  ...
  [ShowcaseStrings.Feat_Sealing_HL3]: '在达到阈值之前的数学安全保证',
  [ShowcaseStrings.Feat_Sealing_HL4]: '灵活的解封机制，用于法律合规或群组决策',
  [ShowcaseStrings.Feat_Sealing_HL5]: '支持组织治理和合规工作流',
  [ShowcaseStrings.Feat_Sealing_HL6]: '基于时间的过期机制，实现自动隐私保护',
  ...
  [ShowcaseStrings.Feat_BrightID_HL1]: 'BIP39/32 基于助记词的身份生成',
  [ShowcaseStrings.Feat_BrightID_HL2]: '每个用户账户支持多个注册别名',
  [ShowcaseStrings.Feat_BrightID_HL3]: '匿名发布，支持可选的身份恢复',
  [ShowcaseStrings.Feat_BrightID_HL4]: '基于公钥的认证 (SECP256k1)',
  [ShowcaseStrings.Feat_BrightID_HL5]: '前向纠错用于身份备份',
  [ShowcaseStrings.Feat_BrightID_HL6]: '隐私保护的身份验证',
  ...
  [ShowcaseStrings.Feat_Reputation_HL1]:
    '能量成本以实际焦耳计量，与现实世界关联',
  [ShowcaseStrings.Feat_Reputation_HL2]: '基于用户声誉的动态工作量证明',
  [ShowcaseStrings.Feat_Reputation_HL3]: '内容创作者在其内容被消费时获得奖励',
  [ShowcaseStrings.Feat_Reputation_HL4]: '不良行为者通过增加计算要求被限流',
  [ShowcaseStrings.Feat_Reputation_HL5]: '存储和带宽成本被追踪和补偿',
  [ShowcaseStrings.Feat_Reputation_HL6]: '激励积极贡献和优质内容',
  ...
  [ShowcaseStrings.Feat_BlockTemp_HL1]: '"至少保留到"合约，保证最低存储时长',
  [ShowcaseStrings.Feat_BlockTemp_HL2]:
    '块的有用性随访问增加，陈旧度随时间降低',
  [ShowcaseStrings.Feat_BlockTemp_HL3]: '基于访问模式和温度的动态复制',
  [ShowcaseStrings.Feat_BlockTemp_HL4]: '频繁访问的块自动延长合约',
  [ShowcaseStrings.Feat_BlockTemp_HL5]: '证明有用的块返还能量积分',
  [ShowcaseStrings.Feat_BlockTemp_HL6]: '可配置的持久性和可访问性要求',
  ...
  [ShowcaseStrings.Feat_ZeroMining_HL3]: '工作量证明仅用于交易限流',
  [ShowcaseStrings.Feat_ZeroMining_HL4]: '节能的共识机制',
  [ShowcaseStrings.Feat_ZeroMining_HL5]: '可持续的区块链，无环境影响',
  [ShowcaseStrings.Feat_ZeroMining_HL6]: '专注于存储和计算，而非人为稀缺性',
  ...
  [ShowcaseStrings.Feat_CrossPlatform_HL1]: '跨平台统一的密码学操作',
  [ShowcaseStrings.Feat_CrossPlatform_HL2]: '确定性随机位生成 (HMAC-DRBG)',
  [ShowcaseStrings.Feat_CrossPlatform_HL3]:
    '从 ECDH 密钥一致派生 Paillier 密钥',
  [ShowcaseStrings.Feat_CrossPlatform_HL4]: '浏览器和 Node.js 兼容',
  [ShowcaseStrings.Feat_CrossPlatform_HL5]: '可复现的密码学结果',
  [ShowcaseStrings.Feat_CrossPlatform_HL6]: '跨平台测试和验证',
  ...
  [ShowcaseStrings.Feat_Contracts_HL1]: '在去中心化网络上执行数字合约',
  [ShowcaseStrings.Feat_Contracts_HL2]: '基于 BrightTrust 的网络治理决策',
  [ShowcaseStrings.Feat_Contracts_HL3]: '不同操作的可配置多数要求',
  [ShowcaseStrings.Feat_Contracts_HL4]: '同态投票实现隐私保护的治理',
  [ShowcaseStrings.Feat_Contracts_HL5]: '基于声誉加权的投票机制',
  [ShowcaseStrings.Feat_Contracts_HL6]: '透明且可审计的治理流程',
  ...
  [ShowcaseStrings.Soup_AlertRetrieveFailed]: '文件检索失败：{ERROR}',
  ...
  [ShowcaseStrings.Soup_AlertMagnetFailed]: '磁力链接处理失败：{ERROR}',
  [ShowcaseStrings.Soup_AlertMessageSent]: '消息已发送并存储在汤中！',
  [ShowcaseStrings.Soup_AlertSendFailed]: '消息发送失败：{ERROR}',
  [ShowcaseStrings.Soup_AlertMessageRetrieved]: '从汤中检索到消息：{TEXT}',
  [ShowcaseStrings.Soup_AlertRetrieveMessageFailed]: '消息检索失败：{ERROR}',
  ...
  [ShowcaseStrings.Edu_StepsCompleted]: '已完成 {COMPLETED}/{TOTAL} 步',
  [ShowcaseStrings.Enc_Title]: '🎬 文件编码动画',
  [ShowcaseStrings.Enc_Subtitle]: '观看您的文件如何转换为 BrightChain 块',
  [ShowcaseStrings.Enc_ChunksTitle]: '📦 文件分块（{COUNT}）',
  [ShowcaseStrings.Enc_ChunksSubtitle]: '每个分块将成为汤中的一个块',
  ...
  [ShowcaseStrings.Enc_ChunkBecomesBlock]: '每个分块成为汤中的一个块',
  [ShowcaseStrings.Enc_WhyPadding]: '为什么需要填充？',
  [ShowcaseStrings.Enc_PaddingSameSize]: '所有块必须大小相同',
  [ShowcaseStrings.Enc_PaddingPreventsAnalysis]: '随机填充防止数据分析',
  [ShowcaseStrings.Enc_PaddingRemoved]: '填充在重建时被移除',
  ...
  [ShowcaseStrings.Enc_EnablesVerification]: '在检索时启用验证',
  ...
  [ShowcaseStrings.PP_S4_Li5]: '就服务与您沟通（例如，服务公告、安全警报）',
