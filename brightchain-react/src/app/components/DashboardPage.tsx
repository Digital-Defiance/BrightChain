...
import { JouleIconBalance } from '@brightchain/brightchain-react-components';
            ...
            <Card>
              <CardContent>
                ...
                {loading ? (
                  ...
                  <>
                    <JouleIconBalance
                      balanceJoules={energyBalance.balance}
                      variant="h3"
                    />
            ...
            <Card>
              <CardContent>
                ...
                {loading ? (
                  ...
                  <>
                    <JouleIconBalance
                      balanceJoules={energyBalance.earned}
                      variant="h4"
                    />
                    <Typography variant="body2" color="text.secondary" mt={1}>
            ...
            <Card>
              <CardContent>
                ...
                {loading ? (
                  ...
                  <>
                    <JouleIconBalance
                      balanceJoules={energyBalance.spent}
                      variant="h4"
                    />
                    <Typography variant="body2" color="text.secondary" mt={1}>
