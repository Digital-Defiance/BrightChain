/**
 * Unit tests for BrightCal FriendsSuggestionSection component.
 *
...
describe('BrightCal FriendsSuggestionSection', () => {
  it('renders "Friends" heading and friend items when friends exist (Req 18.2, 18.3)', async () => {
    renderSection();
  ...
  it('omits section entirely when user has no friends (Req 18.4)', async () => {
  ...
  it('calls onSelectFriend with the correct friend ID when a friend is clicked (Req 18.2)', async () => {
