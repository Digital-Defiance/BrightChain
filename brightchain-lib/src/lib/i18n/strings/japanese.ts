...
export const JapaneseStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    'サービスコンテナにブロックストアが登録されていません。BlockStoreService を構築する前にデータベースの初期化が完了していることを確認してください。',
  ...
  // Splash - 早期開発バナー
  [BrightChainStrings.Splash_EarlyDev_Title]: '🚧 開発初期段階 — 開発中',
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'フェイクメール (開発)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: '受信者',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]:
    'キャプチャ済み',
  [BrightChainStrings.Admin_Menu_Dashboard]: '管理ダッシュボード',
  [BrightChainStrings.Admin_Menu_Users]: 'ユーザー管理',
  [BrightChainStrings.Admin_Menu_Blocks]: 'ブロックエクスプローラー管理',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: 'ジュール管理',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]: 'ジュール台帳管理',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    'ユーザーのエネルギー口座に対する運用上のクレジット／デビット／調整。コントリビューションおよびプロバイダーシステムが稼働するまで、すべてのジュール移動はここで手動で行われます。すべての操作は下の永続的な管理者監査ログに記録されます。',
  [BrightChainStrings.Admin_Joule_SelectUser]: 'ユーザーを選択',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    'ユーザー名またはメールで検索（最低2文字）',
  [BrightChainStrings.Admin_Joule_Searching]: '検索中…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    '選択中: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'クリア',
  [BrightChainStrings.Admin_Joule_AccountSection]: '口座',
  [BrightChainStrings.Admin_Joule_FieldBalance]: '残高',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: '利用可能',
  [BrightChainStrings.Admin_Joule_FieldReserved]: '予約済み',
  [BrightChainStrings.Admin_Joule_FieldEarned]: '獲得済み',
  [BrightChainStrings.Admin_Joule_FieldSpent]: '使用済み',
  [BrightChainStrings.Admin_Joule_FieldReputation]: '評価',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: '最終更新',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: '残高を調整',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'アクション',
  [BrightChainStrings.Admin_Joule_ActionCredit]: 'クレジット（ジュールを追加）',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'デビット（ジュールを削除）',
  [BrightChainStrings.Admin_Joule_ActionAdjust]: '調整（絶対目標残高を設定）',
  ...
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    '目標残高（マイクロジュール、小数）',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: '金額',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    '小数のマイクロジュール文字列。1 J = 1,000,000 µJ。調整は非負の目標値を受け入れます。',
  [BrightChainStrings.Admin_Joule_ReasonLabel]: '理由（必須、最大256文字）',
  [BrightChainStrings.Admin_Joule_MemoLabel]: 'メモ（任意、最大1024文字）',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'クレジット',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'デビット',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: '残高を設定',
  [BrightChainStrings.Admin_Joule_RecentActionsSection]: '最近の管理者操作',
  [BrightChainStrings.Admin_Joule_NoActions]:
    'このユーザーに対する管理者操作は記録されていません。',
  [BrightChainStrings.Admin_Joule_ColWhen]: '日時',
  [BrightChainStrings.Admin_Joule_ColAction]: 'アクション',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: '操作後残高',
  [BrightChainStrings.Admin_Joule_ColReason]: '理由',
  [BrightChainStrings.Admin_Joule_ColActor]: '実行者',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'さらに読み込む',
  [BrightChainStrings.Admin_Joule_LoadingMore]: '読み込み中…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'ログの終わりです。',
  ...
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]:
    'アクション: {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    '目標残高: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    '金額: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: '理由: {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'メモ: {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'この変更は運用 EnergyAccountStore に直接書き込まれます。レイヤー3台帳の照合は台帳サブシステムが提供されてから実施されます。',
  [BrightChainStrings.Admin_Joule_Submitting]: '送信中…',
  [BrightChainStrings.Admin_Joule_Confirm]: '確認',
  ...
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]:
    '追加イベントの読み込みに失敗しました',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: '操作に失敗しました',
  ...
  [BrightChainStrings.Admin_Users_DeleteWarning]: ' これは破壊的な操作です。',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'ブロック',
  [BrightChainStrings.Explorer_Nav_Pools]: 'プール',
  [BrightChainStrings.Explorer_Nav_Search]: '検索',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'ブロックハッシュのプレフィックスで検索…',
  [BrightChainStrings.Explorer_SearchButton]: '検索',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} 件の結果',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'ブロックが見つかりません。',
  [BrightChainStrings.Explorer_PoolsTitle]: 'ストレージプール',
  [BrightChainStrings.Explorer_PoolsNone]: 'プールが見つかりません。',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} ブロック',
  [BrightChainStrings.Explorer_BlockDetail]: 'ブロック詳細',
  [BrightChainStrings.Explorer_BackToBlocks]: '← ブロック一覧に戻る',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'ネットワークで検索',
  [BrightChainStrings.Explorer_Locating]: '検索中…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'ネットワーク検索',
  [BrightChainStrings.Explorer_NetworkFound]: '見つかりました',
  [BrightChainStrings.Explorer_NetworkNotFound]: '見つかりません',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    '{PEERS} ピアに {DURATION}ms で問い合わせ',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'このブロックを保持するノードが見つかりません。',
  [BrightChainStrings.Explorer_ColHash]: 'ハッシュ',
  [BrightChainStrings.Explorer_ColPool]: 'プール',
  [BrightChainStrings.Explorer_ColSize]: 'サイズ',
  [BrightChainStrings.Explorer_ColCreated]: '作成日',
  [BrightChainStrings.Explorer_PageTemplate]: 'ページ {PAGE} · 合計 {TOTAL}',
  [BrightChainStrings.Explorer_Previous]: '前へ',
  [BrightChainStrings.Explorer_Next]: '次へ',
  [BrightChainStrings.Explorer_BlockNotFound]: 'ブロックが見つかりません',
  [BrightChainStrings.Explorer_LocateFailed]: 'ネットワーク検索に失敗しました',
  [BrightChainStrings.Explorer_FetchFailed]: 'ブロックの取得に失敗しました',
  [BrightChainStrings.Explorer_SearchFailed]: '検索に失敗しました',
  [BrightChainStrings.Explorer_Parity]: 'パリティ',
  ...
  [BrightChainStrings.Friends_ListRetrieved]: 'フレンドリストを取得しました',
  ...
  [BrightChainStrings.Friends_StatusRetrieved]:
    'フレンドシップステータスを取得しました',
  [BrightChainStrings.Friends_MutualRetrieved]: '共通のフレンドを取得しました',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_RateLimited]:
    'レート制限を超えました。再試行する前にお待ちください。',
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    'レート制限を超えました。続行するには添付の作業ユニットを完了してください。',
  ...
  [BrightChainStrings.DatePage_Format_LocalDateTime]: 'ローカル日時',
  [BrightChainStrings.DatePage_Format_LocalDate]: 'ローカル日付',
  [BrightChainStrings.DatePage_Format_LocalTime]: 'ローカル時刻',
  [BrightChainStrings.DatePage_Format_UnixTimestamp]: 'Unixタイムスタンプ',
  [BrightChainStrings.DatePage_Format_UnixMs]: 'Unixミリ秒',
  [BrightChainStrings.DatePage_Format_JulianDate]: 'ユリウス日',
  [BrightChainStrings.DatePage_Format_ModifiedJulianDate]: '修正ユリウス日',
  [BrightChainStrings.DatePage_Format_DayOfYear]: '年間通算日',
  [BrightChainStrings.DatePage_Format_ISOWeek]: 'ISO週番号',
  [BrightChainStrings.DatePage_Format_RFC2822]: 'RFC 2822',
  [BrightChainStrings.DatePage_HolidayType_Public]: '祝日',
