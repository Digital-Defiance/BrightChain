...
> **See also**: [BrightDB Architecture Reference](./brightdb.md) for the complete
> top-to-bottom description of BrightDB — including the block store, head registry,
> query pipeline, gossip consistency model, and REST API layer.
