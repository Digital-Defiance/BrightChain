...
export const MandarinStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    '服务容器中未注册块存储。请确保在构造 BlockStoreService 之前已完成数据库初始化。',
  ...
  // Splash - 早期开发横幅
  [BrightChainStrings.Splash_EarlyDev_Title]: '🚧 早期开发阶段 — 开发中',
  [BrightChainStrings.Splash_EarlyDev_Body]:
    'BrightChain是一个正在开发中的项目。大多数功能仍在积极开发中，尚未完全可用。在我们启动网络的过程中，一切都非常初步。',
  [BrightChainStrings.Splash_EarlyDev_Team]: '小型团队',
  [BrightChainStrings.Splash_EarlyDev_TeamDescription]:
    '开发团队目前由一个人和一个AI助手组成。我们正在积极寻找共同开发者和网络的首批对等节点。',
  [BrightChainStrings.Splash_EarlyDev_DataWarning]: '数据可能被清除',
  [BrightChainStrings.Splash_EarlyDev_DataWarningDescription]:
    '我们无法保证数据持久性。在达到稳定性之前，可能需要因向后不兼容的更改而清除数据库。请不要存储任何不可替代的内容。',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarning]: '不保证正常运行时间',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription]:
    '只有一个没有冗余的生产节点，手动设置，没有自动化。随时可能发生故障。',
  [BrightChainStrings.Splash_EarlyDev_GetInvolved]: '参与贡献',
  [BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription]:
    '非常欢迎捐款和时间贡献，这将有意义地加速开发。如果您有兴趣共同开发或运行对等节点，请与我们联系。',
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: '模拟邮件 (开发)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: '收件人',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: '已捕获',
  [BrightChainStrings.Admin_Menu_Dashboard]: '管理面板',
  [BrightChainStrings.Admin_Menu_Users]: '用户管理',
  [BrightChainStrings.Admin_Menu_Blocks]: '区块浏览器管理',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: '焦耳管理',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]: '焦耳账本管理',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    '对用户能源账户进行运营性贷记／借记／调整。在贡献和提供方系统上线之前，所有焦耳变动都在此处手动执行。每项操作都会记录在下方持久化的管理员审计日志中。',
  [BrightChainStrings.Admin_Joule_SelectUser]: '选择用户',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    '按用户名或邮箱搜索（至少 2 个字符）',
  [BrightChainStrings.Admin_Joule_Searching]: '搜索中…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    '已选择：{USERNAME}（{USER_ID}）',
  [BrightChainStrings.Admin_Joule_Clear]: '清除',
  [BrightChainStrings.Admin_Joule_AccountSection]: '账户',
  [BrightChainStrings.Admin_Joule_FieldBalance]: '余额',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: '可用',
  [BrightChainStrings.Admin_Joule_FieldReserved]: '预留',
  [BrightChainStrings.Admin_Joule_FieldEarned]: '已获得',
  [BrightChainStrings.Admin_Joule_FieldSpent]: '已消耗',
  [BrightChainStrings.Admin_Joule_FieldReputation]: '声誉',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: '最后更新',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: '调整余额',
  [BrightChainStrings.Admin_Joule_ActionLabel]: '操作',
  [BrightChainStrings.Admin_Joule_ActionCredit]: '贷记（增加焦耳）',
  [BrightChainStrings.Admin_Joule_ActionDebit]: '借记（扣减焦耳）',
  [BrightChainStrings.Admin_Joule_ActionAdjust]: '调整（设置绝对目标余额）',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    '贷记金额（微焦耳，小数）',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]: '借记金额（微焦耳，小数）',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    '目标余额（微焦耳，小数）',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: '金额',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    '十进制微焦耳字符串。1 J = 1,000,000 µJ。调整接受非负目标值。',
  [BrightChainStrings.Admin_Joule_ReasonLabel]: '原因（必填，最多256字符）',
  [BrightChainStrings.Admin_Joule_MemoLabel]: '备注（可选，最多1024字符）',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: '贷记',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: '借记',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: '设置余额',
  [BrightChainStrings.Admin_Joule_RecentActionsSection]: '近期管理员操作',
  [BrightChainStrings.Admin_Joule_NoActions]: '该用户暂无管理员操作记录。',
  [BrightChainStrings.Admin_Joule_ColWhen]: '时间',
  [BrightChainStrings.Admin_Joule_ColAction]: '操作',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: '操作后余额',
  [BrightChainStrings.Admin_Joule_ColReason]: '原因',
  [BrightChainStrings.Admin_Joule_ColActor]: '操作者',
  [BrightChainStrings.Admin_Joule_LoadMore]: '加载更多',
  [BrightChainStrings.Admin_Joule_LoadingMore]: '加载中…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: '日志结尾。',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]: '确认焦耳 {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmUserTemplate]:
    '用户：{USERNAME}（{USER_ID}）',
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]: '操作：{ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    '目标余额：{AMOUNT} µJ（{FORMATTED}）',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    '金额：{AMOUNT} µJ（{FORMATTED}）',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: '原因：{REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: '备注：{MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    '此更改将直接写入运营 EnergyAccountStore。第三层账本对账将在账本子系统上线后进行。',
  [BrightChainStrings.Admin_Joule_Submitting]: '提交中…',
  [BrightChainStrings.Admin_Joule_Confirm]: '确认',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]: '加载焦耳账户失败',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]: '加载更多事件失败',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: '操作失败',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]: '{ACTION} 成功。Δ {DELTA}',
  ...
  [BrightChainStrings.Admin_Users_DeleteWarning]: ' 这是一个破坏性操作。',
  [BrightChainStrings.Admin_Users_CannotDeleteSelf]: '您不能删除自己的账户。',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: '区块',
  [BrightChainStrings.Explorer_Nav_Pools]: '存储池',
  [BrightChainStrings.Explorer_Nav_Search]: '搜索',
  [BrightChainStrings.Explorer_SearchPlaceholder]: '按区块哈希前缀搜索…',
  [BrightChainStrings.Explorer_SearchButton]: '搜索',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} 个结果',
  [BrightChainStrings.Explorer_NoBlocksFound]: '未找到区块。',
  [BrightChainStrings.Explorer_PoolsTitle]: '存储池',
  [BrightChainStrings.Explorer_PoolsNone]: '未找到存储池。',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} 个区块',
  [BrightChainStrings.Explorer_BlockDetail]: '区块详情',
  [BrightChainStrings.Explorer_BackToBlocks]: '← 返回区块列表',
  [BrightChainStrings.Explorer_LocateOnNetwork]: '在网络中定位',
  [BrightChainStrings.Explorer_Locating]: '定位中…',
  [BrightChainStrings.Explorer_NetworkLocate]: '网络定位',
  [BrightChainStrings.Explorer_NetworkFound]: '已找到',
  [BrightChainStrings.Explorer_NetworkNotFound]: '未找到',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    '在 {DURATION}ms 内查询了 {PEERS} 个节点',
  [BrightChainStrings.Explorer_NetworkNoNodes]: '未找到持有此区块的节点。',
  [BrightChainStrings.Explorer_ColHash]: '哈希',
  [BrightChainStrings.Explorer_ColPool]: '存储池',
  [BrightChainStrings.Explorer_ColSize]: '大小',
  [BrightChainStrings.Explorer_ColCreated]: '创建时间',
  [BrightChainStrings.Explorer_PageTemplate]: '第 {PAGE} 页 · 共 {TOTAL} 个',
  [BrightChainStrings.Explorer_Previous]: '上一页',
  [BrightChainStrings.Explorer_Next]: '下一页',
  [BrightChainStrings.Explorer_BlockNotFound]: '未找到区块',
  [BrightChainStrings.Explorer_LocateFailed]: '网络定位失败',
  [BrightChainStrings.Explorer_FetchFailed]: '加载区块失败',
  [BrightChainStrings.Explorer_SearchFailed]: '搜索失败',
  [BrightChainStrings.Explorer_Parity]: '奇偶校验',
  ...
  [BrightChainStrings.Error_Friends_SelfRequestNotAllowed]:
    '您不能向自己发送好友请求',
  [BrightChainStrings.Error_Friends_AlreadyFriends]: '您已经是该成员的好友',
  [BrightChainStrings.Error_Friends_RequestAlreadyExists]:
    '已存在待处理的好友请求',
  [BrightChainStrings.Error_Friends_RequestNotFound]:
    '好友请求未找到或不处于待处理状态',
  [BrightChainStrings.Error_Friends_NotFriends]: '这些成员之间不存在好友关系',
  ...
  [BrightChainStrings.Friends_RequestSent]: '好友请求已发送',
  [BrightChainStrings.Friends_RequestAccepted]: '好友请求已接受',
  [BrightChainStrings.Friends_RequestRejected]: '好友请求已拒绝',
  [BrightChainStrings.Friends_RequestCancelled]: '好友请求已取消',
  [BrightChainStrings.Friends_Removed]: '好友已删除',
  [BrightChainStrings.Friends_ListRetrieved]: '好友列表已获取',
  [BrightChainStrings.Friends_ReceivedRequestsRetrieved]:
    '收到的好友请求已获取',
  [BrightChainStrings.Friends_SentRequestsRetrieved]: '发送的好友请求已获取',
  [BrightChainStrings.Friends_StatusRetrieved]: '好友状态已获取',
  [BrightChainStrings.Friends_MutualRetrieved]: '共同好友已获取',
  [BrightChainStrings.Friends_Unauthenticated]: '需要身份验证',
  ...
  [BrightChainStrings.DatePage_Format_LocalDateTime]: '本地日期和时间',
  [BrightChainStrings.DatePage_Format_LocalDate]: '本地日期',
  [BrightChainStrings.DatePage_Format_LocalTime]: '本地时间',
  [BrightChainStrings.DatePage_Format_UnixTimestamp]: 'Unix时间戳',
  [BrightChainStrings.DatePage_Format_UnixMs]: 'Unix毫秒',
  [BrightChainStrings.DatePage_Format_JulianDate]: '儒略日',
  [BrightChainStrings.DatePage_Format_ModifiedJulianDate]: '修正儒略日',
  [BrightChainStrings.DatePage_Format_DayOfYear]: '年中第几天',
  [BrightChainStrings.DatePage_Format_ISOWeek]: 'ISO周',
  [BrightChainStrings.DatePage_Format_RFC2822]: 'RFC 2822',
  [BrightChainStrings.DatePage_HolidayType_Public]: '公共假日',
