...
| 02 | [Node Setup](./02-node-setup) | Intermediate | 30 minutes | Configure and start a Regular Storage Node or BrightTrust Node and join the decentralized network. |
...
| 08 | [Joining the Network](./08-joining-the-network) | Intermediate | 45 minutes | Spin up a node, connect to the BrightChain network, join storage pools, and understand BrightTrust admission. |
