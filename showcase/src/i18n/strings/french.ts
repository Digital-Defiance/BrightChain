...
> = {
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightChat_Text]:
    "Une plateforme de communications en temps réel avec des canaux persistants, la voix et le partage de médias. La gouvernance communautaire est gérée via des BrightTrusts, et la récupération accélérée par GPU garantit que l'historique de chat n'est jamais perdu.",
  ...
  [ShowcaseStrings.FAQ_Tech_Q16_Answer]:
    "IPFS est transparent par défaut ; si vous avez le hash, vous pouvez voir le fichier. BrightChain utilise une Base XOR. Les données sont fonctionnellement « Déchiquetées » avant même de toucher le réseau. La confidentialité n'est pas un « plugin » — c'est l'état mécanique des données.",
