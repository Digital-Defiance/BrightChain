---
title: "UPnP Configuration Guide"
...
Below are the most common issues. For step-by-step verification with a real router (checking the router admin page, testing external connectivity, observing refresh cycles, etc.), see the [UPnP Manual Testing Guide](./upnp-manual-testing) .
...
- [UPnP Manual Testing Guide](./upnp-manual-testing) — hands-on verification with a real router
