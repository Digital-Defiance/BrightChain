...
export const ShowcaseAmericanEnglishStrings: ComponentStrings<ShowcaseStringKey> =
  {
    ...
    [ShowcaseStrings.PP_S4_Li1]: 'Provide, maintain, and improve the Services',
    [ShowcaseStrings.PP_S4_Li2]: 'Authenticate users and manage accounts',
    [ShowcaseStrings.PP_S4_Li3]:
      'Detect and prevent fraud, abuse, and security incidents',
    [ShowcaseStrings.PP_S4_Li4]: 'Comply with applicable legal obligations',
    ...
    [ShowcaseStrings.PP_S7_Title]: '7. Law Enforcement and Legal Requests',
    ...
    [ShowcaseStrings.PP_S15_Title]: '15. Governing Law and Dispute Resolution',
