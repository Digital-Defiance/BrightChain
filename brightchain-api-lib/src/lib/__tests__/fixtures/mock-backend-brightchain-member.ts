...
export class MockBackendBrightchainMember implements IBrightchainMemberOperational<DefaultBackendIdType> {
  ...
  ): MockBackendBrightchainMember {
    return new MockBackendBrightchainMember(overrides);
  }

  static createMultiple(count: number): MockBackendBrightchainMember[] {
    return Array.from({ length: count }, () => this.create());
  }

  static createWithPrivateKey(): MockBackendBrightchainMember {
    return new MockBackendBrightchainMember({
  ...
  static createWithoutPrivateKey(): MockBackendBrightchainMember {
    return new MockBackendBrightchainMember({
