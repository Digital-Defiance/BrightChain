      ...
      <div className="voting-demo">
        <div className="election-intro">
          ...
          <div className="intro-story">
            <p>
              💰 <strong>The Challenge:</strong> $1.4M budget, 4 projects. How
              do we measure intensity of preference?
            </p>
            <p>
              ² <strong>Quadratic Voting:</strong> Each vote costs votes²
              credits. 1 vote = 1 credit, 2 votes = 4 credits, 3 votes = 9
              credits!
            </p>
            <div className="intro-stakes security-warning">
              <p>
                ⚠️ <strong>INSECURE METHOD:</strong> Requires non-homomorphic
                operations (square root). Individual votes are visible!
              </p>
              <p>
                🎯 <strong>Why use it?</strong> Prevents wealthy voters from
                dominating. Shows preference intensity, not just yes/no.
              </p>
            </div>
            <p className="intro-challenge">
              💡 Used in Colorado House, Taiwanese vTaiwan platform, and
  ...
  return (
    <div className="voting-demo">
      ...
      <div className="security-warning-banner">
        ⚠️ INSECURE: This method cannot use homomorphic encryption. Votes are
        visible!
      </div>
        ...
        <>
          ...
          {!hasVoted && (
            <div className="quadratic-section">
              <h4>
                💰 {voters[currentVoter]}'s Budget ({remaining} credits left)
              </h4>
                ...
                return (
                  <div key={idx} className="quadratic-item">
                    ...
                    <div className="cost-explanation">
                      Next vote costs {2 * votes + 1} credits (from {cost} to{' '}
                      {calculateCost(votes + 1)})
                    </div>
                  </div>
                );
              })}
        ...
        <div className="results-section">
          ...
          <div className="tally-visualization">
            ...
            <p className="tally-explain">
              Each project's total votes (not credits) determines funding
              priority:
            </p>
          </div>
          ...
          <div className="quadratic-explanation">
            ...
            <p>
              The quadratic cost prevented anyone from dominating a single
              project. To cast 10 votes costs 100 credits (your entire budget!),
              but spreading 5 votes each on 2 projects only costs 50 credits
              total.
            </p>
            <p>
              <strong>Result:</strong> Projects with broad, intense support win
              over projects with narrow, extreme support.
            </p>
          </div>
