...
> = {
  ...
  [ShowcaseStrings.Feat_OFFS_Desc]:
    'Stockage distribué révolutionnaire qui découpe les fichiers en blocs et les mélange avec des données aléatoires par XOR. Aucun bloc individuel ne contient de contenu identifiable, offrant une immunité juridique aux opérateurs de nœuds tout en permettant un stockage de fichiers sécurisé et décentralisé.',
  [ShowcaseStrings.Feat_OFFS_Cat]: 'Stockage',
  [ShowcaseStrings.Feat_OFFS_Tech1]: 'Chiffrement XOR',
  [ShowcaseStrings.Feat_OFFS_Tech2]: 'Stockage distribué',
  [ShowcaseStrings.Feat_OFFS_Tech3]: "SHA-512",
  [ShowcaseStrings.Feat_OFFS_HL1]:
    'Les fichiers sont découpés en blocs sources et fusionnés avec des données aléatoires via XOR',
  [ShowcaseStrings.Feat_OFFS_HL2]:
    'Les blocs originaux sont supprimés — seuls les blocs randomisés sont stockés',
  [ShowcaseStrings.Feat_OFFS_HL3]:
    'Les listes de blocs constitutifs (CBL) suivent les relations entre blocs',
  [ShowcaseStrings.Feat_OFFS_HL4]:
    'Les blocs sont identifiés par leur hash SHA-512 — déduplication automatique',
  [ShowcaseStrings.Feat_OFFS_HL5]:
    'Les blocs multi-usage peuvent faire partie de plusieurs fichiers simultanément',
  [ShowcaseStrings.Feat_OFFS_HL6]:
    'Protection juridique pour les opérateurs de nœuds — aucun contenu identifiable stocké',
