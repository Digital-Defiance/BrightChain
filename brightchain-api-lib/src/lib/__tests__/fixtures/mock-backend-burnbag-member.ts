...
export class MockBackendBurnbagMember
  implements IBurnbagMemberOperational<DefaultBackendIdType>
{
  ...
  ): MockBackendBurnbagMember {
    return new MockBackendBurnbagMember(overrides);
  }

  static createMultiple(count: number): MockBackendBurnbagMember[] {
    return Array.from({ length: count }, () => this.create());
  }

  static createWithPrivateKey(): MockBackendBurnbagMember {
    return new MockBackendBurnbagMember({
  ...
  static createWithoutPrivateKey(): MockBackendBurnbagMember {
    return new MockBackendBurnbagMember({
