...
> = {
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightCal_Title]:
    'Управління спільним та особистим календарем',
  ...
  [ShowcaseStrings.FAQ_Tech_Q19_Epoch]:
    'BrightDate рахує десяткові дні від J2000.0 (1 січня 2000, 12:00:00 UTC) — тієї ж епохи, яку використовують астрономи по всьому світу для небесної механіки. Це робить BrightDate природно сумісним з астрономічними розрахунками та міжпланетною координацією.',
  [ShowcaseStrings.FAQ_Tech_Q19_Format_Label]: 'Формат десяткового дня',
  [ShowcaseStrings.FAQ_Tech_Q19_Format]:
    'Значення BrightDate як 9146.43750 означає "9146 днів і 43,75% дня від епохи J2000.0." Ціла частина — це кількість днів, дробова частина — час доби у десятковому вигляді. Без часових поясів, без літнього часу, без двозначності — лише одне число на одній часовій лінії.',
  [ShowcaseStrings.FAQ_Tech_Q19_Arithmetic_Label]: 'Тривіальна арифметика',
  [ShowcaseStrings.FAQ_Tech_Q19_Arithmetic]:
    'Потрібен час між двома подіями? Відніміть один BrightDate від іншого. Результат у днях. Потрібно запланувати щось через 3 години? Додайте 0,125. Метричні підодиниці (мілідні ≈ 86,4 секунди, мікродні ≈ 86,4 мілісекунди) роблять тривалості людського масштабу інтуїтивними.',
  ...
  [ShowcaseStrings.Feat_BrightHub_Tech2]:
  ...
  [ShowcaseStrings.Feat_Anonymity_Title]:
    'Посередницька анонімність та BrightTrust',
  ...
  [ShowcaseStrings.Feat_Sealing_Title]:
    'Запечатування документів на основі BrightTrust',
  ...
  [ShowcaseStrings.Feat_ZeroMining_HL4]: 'Енергоефективні механізми консенсусу',
  ...
  [ShowcaseStrings.Feat_Contracts_HL5]:
    'Механізми голосування, зважені за репутацією',
  ...
  [ShowcaseStrings.Soup_AlertParseCBLFailed]:
    'Не вдалося розібрати CBL: {ERROR}',
  ...
  [ShowcaseStrings.Soup_AlertMessageSent]:
    'Повідомлення надіслано та збережено в супі!',
  [ShowcaseStrings.Soup_AlertSendFailed]:
  ...
  [ShowcaseStrings.Enc_ChunksSubtitle]: 'Кожен фрагмент стане блоком у супі',
  ...
  [ShowcaseStrings.Enc_ChunkBecomesBlock]: 'Кожен фрагмент стає блоком у супі',
  [ShowcaseStrings.Enc_WhyPadding]: 'Навіщо доповнення?',
  [ShowcaseStrings.Enc_PaddingSameSize]:
    'Усі блоки повинні бути однакового розміру',
  ...
  [ShowcaseStrings.Enc_UniqueIdentifier]:
    'Використовується як унікальний ідентифікатор блоку',
  ...
  [ShowcaseStrings.PP_S4_Li4]: "Дотримання застосовних правових зобов'язань",
  ...
  [ShowcaseStrings.PP_S6_Title]: '6. Криптографічний захист та обмеження',
  ...
  [ShowcaseStrings.PP_S7_Title]: '7. Правоохоронні органи та правові запити',
  ...
  [ShowcaseStrings.PP_S7_P2]: 'Однак через архітектурний дизайн BrightChain:',
  ...
  [ShowcaseStrings.PP_S15_Title]: '15. Застосовне право та вирішення спорів',
