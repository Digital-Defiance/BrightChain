...
> extends UpstreamAppRouter<TID, IApplication<TID>> {
  ...
  protected override getIndexLocals(
    ...
    return {
      ...
      gtag: environment.gtagId,
      brightHubFontAwesomeMaxDisplay:
        environment.brightHubFontAwesomeMaxDisplay,
      brightHubFontAwesomeIconGridSize:
        environment.brightHubFontAwesomeIconGridSize,
      brightChatFontAwesomeMaxDisplay:
        environment.brightChatFontAwesomeMaxDisplay,
      brightChatFontAwesomeIconGridSize:
        environment.brightChatFontAwesomeIconGridSize,
    };
  }
  ...
  protected override registerAdditionalRenderHooks(app: Application): void {
    ...
    const ejsHandler = (
      ...
      try {
        ...
        console.error(`[AppRouter] EJS render failed for "${req.path}":`, err);
        next(err);
      }
    };
