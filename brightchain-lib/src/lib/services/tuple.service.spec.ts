...
import { ECIESService } from './ecies.service'; // Import ECIESService
import { ServiceProvider } from './service.provider';
import { TupleService } from './tuple.service';
import { VotingService } from './voting.service'; // Import VotingService
...
describe('TupleService', () => {
  ...
  describe('xorDestPrimeWhitenedToOwned', () => {
    it('should recover original data from whitened blocks', async () => {
      ...
      // Verify the original data length is preserved (access directly from interface)
