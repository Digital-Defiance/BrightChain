/**
 * FriendsSuggestionSection — Renders a "Friends" section in the attendee picker.
 *
...
const FriendsSuggestionSection: FC<FriendsSuggestionSectionProps> = ({
  ...
  // Omit section entirely when user has no friends (Req 18.4)
  if (friends.length === 0) {
    return null;
  }
  ...
  return (
    <div data-testid="friends-suggestion-section">
      <Typography variant="subtitle2" sx={{ px: 2, pt: 1, pb: 0.5 }}>
        {t(BrightCalStrings.Friends_SectionTitle)}
      </Typography>
      <List dense>
