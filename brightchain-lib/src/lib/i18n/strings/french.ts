...
export const FrenchStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    "Aucun magasin de blocs enregistré dans le conteneur de services. Assurez-vous que l'initialisation de la base de données est terminée avant de construire BlockStoreService.",
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'Email factice (Dev)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: 'Destinataires',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: 'Capturés',
  ...
  [BrightChainStrings.Admin_Menu_Blocks]: 'Admin Explorateur de blocs',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: 'Admin Joule',
  ...
  [BrightChainStrings.Admin_Joule_PageTitle]:
    'Administration du registre Joule',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    "Crédit / débit / ajustement opérationnel sur le compte d'énergie d'un utilisateur. En attendant la mise en service des systèmes de contribution et de fournisseur, tout mouvement de Joule est effectué manuellement ici. Chaque action est enregistrée dans le journal d'audit administrateur persistant ci-dessous.",
  [BrightChainStrings.Admin_Joule_SelectUser]: "Sélectionner l'utilisateur",
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    "Rechercher par nom d'utilisateur ou e-mail (min 2 car.)",
  [BrightChainStrings.Admin_Joule_Searching]: 'Recherche…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    'Sélectionné : {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'Effacer',
  [BrightChainStrings.Admin_Joule_AccountSection]: 'Compte',
  [BrightChainStrings.Admin_Joule_FieldBalance]: 'Solde',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: 'Disponible',
  [BrightChainStrings.Admin_Joule_FieldReserved]: 'Réservé',
  [BrightChainStrings.Admin_Joule_FieldEarned]: 'Gagné',
  [BrightChainStrings.Admin_Joule_FieldSpent]: 'Dépensé',
  [BrightChainStrings.Admin_Joule_FieldReputation]: 'Réputation',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: 'Dernière mise à jour',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: 'Ajuster le solde',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'Action',
  [BrightChainStrings.Admin_Joule_ActionCredit]: 'Créditer (ajouter Joule)',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'Débiter (retirer Joule)',
  [BrightChainStrings.Admin_Joule_ActionAdjust]:
    'Ajuster (définir un solde cible absolu)',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    'Montant du crédit (microJoules, décimal)',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]:
    'Montant du débit (microJoules, décimal)',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    'Solde cible (microJoules, décimal)',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: 'Montant',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    'Chaîne décimale en microJoules. 1 J = 1 000 000 µJ. L’ajustement accepte une cible non négative.',
  [BrightChainStrings.Admin_Joule_ReasonLabel]: 'Motif (requis, max 256 car.)',
  [BrightChainStrings.Admin_Joule_MemoLabel]:
    'Note (facultatif, max 1024 car.)',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'Créditer',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'Débiter',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: 'Définir le solde',
  ...
  [BrightChainStrings.Admin_Joule_NoActions]:
    'Aucune action administrative enregistrée pour cet utilisateur.',
  [BrightChainStrings.Admin_Joule_ColWhen]: 'Quand',
  [BrightChainStrings.Admin_Joule_ColAction]: 'Action',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: 'Solde après',
  [BrightChainStrings.Admin_Joule_ColReason]: 'Motif',
  [BrightChainStrings.Admin_Joule_ColActor]: 'Acteur',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'Charger plus',
  [BrightChainStrings.Admin_Joule_LoadingMore]: 'Chargement…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'Fin du journal.',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]:
    'Confirmer Joule {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmUserTemplate]:
    'Utilisateur : {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]: 'Action : {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    'Solde cible : {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    'Montant : {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: 'Motif : {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'Note : {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'Cette modification est écrite directement dans le EnergyAccountStore opérationnel. La réconciliation du registre de couche 3 aura lieu une fois le sous-système de registre livré.',
  [BrightChainStrings.Admin_Joule_Submitting]: 'Envoi…',
  [BrightChainStrings.Admin_Joule_Confirm]: 'Confirmer',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]:
    'Échec du chargement du compte Joule',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]:
    "Échec du chargement d'événements supplémentaires",
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: 'Opération échouée',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]:
    '{ACTION} réussi. Δ {DELTA}',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'Blocs',
  [BrightChainStrings.Explorer_Nav_Pools]: 'Pools',
  [BrightChainStrings.Explorer_Nav_Search]: 'Recherche',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'Rechercher par préfixe de hash…',
  [BrightChainStrings.Explorer_SearchButton]: 'Rechercher',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} résultat(s)',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'Aucun bloc trouvé.',
  [BrightChainStrings.Explorer_PoolsTitle]: 'Pools de stockage',
  [BrightChainStrings.Explorer_PoolsNone]: 'Aucun pool trouvé.',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} blocs',
  [BrightChainStrings.Explorer_BlockDetail]: 'Détail du bloc',
  [BrightChainStrings.Explorer_BackToBlocks]: '← Retour aux blocs',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'Localiser sur le réseau',
  [BrightChainStrings.Explorer_Locating]: 'Localisation…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'Localisation réseau',
  [BrightChainStrings.Explorer_NetworkFound]: 'Trouvé',
  [BrightChainStrings.Explorer_NetworkNotFound]: 'Non trouvé',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    '{PEERS} pairs interrogés en {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'Aucun nœud trouvé détenant ce bloc.',
  [BrightChainStrings.Explorer_ColHash]: 'Hash',
  [BrightChainStrings.Explorer_ColPool]: 'Pool',
  [BrightChainStrings.Explorer_ColSize]: 'Taille',
  [BrightChainStrings.Explorer_ColCreated]: 'Créé',
  [BrightChainStrings.Explorer_PageTemplate]: 'Page {PAGE} · {TOTAL} au total',
  [BrightChainStrings.Explorer_Previous]: 'Précédent',
  [BrightChainStrings.Explorer_Next]: 'Suivant',
  [BrightChainStrings.Explorer_BlockNotFound]: 'Bloc non trouvé',
  [BrightChainStrings.Explorer_LocateFailed]: 'Échec de la localisation réseau',
  [BrightChainStrings.Explorer_FetchFailed]: 'Échec du chargement des blocs',
  [BrightChainStrings.Explorer_SearchFailed]: 'Échec de la recherche',
  [BrightChainStrings.Explorer_Parity]: 'Parité',
  ...
  [BrightChainStrings.Admin_ChatServers_Title]:
    'Administration des serveurs BrightChat',
  ...
  [BrightChainStrings.Admin_ChatServers_DeleteServerTitle]:
  ...
  [BrightChainStrings.Admin_ChatServers_DeleteChannelTitle]:
    'Supprimer le canal',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_RateLimited]:
    'Limite de requêtes dépassée. Veuillez patienter avant de réessayer.',
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    "Limite de requêtes dépassée. Complétez l'unité de travail jointe pour continuer.",
  [BrightChainStrings.Error_PoUW_Middleware_WorkVerificationFailed]:
    'La vérification du résultat du travail a échoué.',
  [BrightChainStrings.Error_PoUW_Middleware_InvalidChallengeToken]:
    'Jeton de défi invalide ou expiré.',
  [BrightChainStrings.Error_PoUW_Middleware_MissingWorkResult]:
    'Résultat du travail manquant dans le corps de la requête.',
  [BrightChainStrings.Error_PoUW_Middleware_ServiceUnavailable]:
    'Service de limitation de débit temporairement indisponible.',
  ...
  [BrightChainStrings.DatePage_HolidaysTitle]: 'Fêtes et célébrations du jour',
  [BrightChainStrings.DatePage_AllFormatsTitle]: 'Tous les formats de date',
  [BrightChainStrings.DatePage_AboutBrightDateTitle]: 'À propos de BrightDate',
  ...
  [BrightChainStrings.DatePage_Format_LocalDateTime]: 'Date et heure locales',
  [BrightChainStrings.DatePage_Format_LocalDate]: 'Date locale',
  [BrightChainStrings.DatePage_Format_LocalTime]: 'Heure locale',
  [BrightChainStrings.DatePage_Format_UnixTimestamp]: 'Horodatage Unix',
  [BrightChainStrings.DatePage_Format_UnixMs]: 'Millisecondes Unix',
  [BrightChainStrings.DatePage_Format_JulianDate]: 'Date julienne',
  [BrightChainStrings.DatePage_Format_ModifiedJulianDate]:
    'Date julienne modifiée',
  [BrightChainStrings.DatePage_Format_DayOfYear]: "Jour de l'année",
  [BrightChainStrings.DatePage_Format_ISOWeek]: 'Semaine ISO',
  [BrightChainStrings.DatePage_Format_RFC2822]: 'RFC 2822',
  [BrightChainStrings.DatePage_HolidayType_Public]: 'Jour férié',
  [BrightChainStrings.DatePage_HolidayType_Bank]: 'Jour férié bancaire',
  [BrightChainStrings.DatePage_HolidayType_Observance]: 'Célébration',
  [BrightChainStrings.DatePage_HolidayType_Religious]: 'Religieux',

  // ── DatePage: Cochrane Easter Egg (Interplanetary Telemetry) ──
  [BrightChainStrings.DatePage_Telemetry_Title]: 'Télémétrie Interplanétaire',
  ...
  // ── PaperKeyTemplate ──
  [BrightChainStrings.PaperKey_Title]: 'Clé papier BrightChain',
  [BrightChainStrings.PaperKey_GeneratedTemplate]: 'Généré : {DATE} ({BD})',
  [BrightChainStrings.PaperKey_SecurityWarning]:
    'CONSERVEZ CECI EN SÉCURITÉ. Cette clé papier est le seul moyen de récupérer votre identité BrightChain. Rangez-la dans un endroit sûr. Ne la partagez jamais.',
  [BrightChainStrings.PaperKey_WordsAriaLabel]: 'Mots de la clé papier',
  [BrightChainStrings.PaperKey_QrScanLabel]: 'Scanner pour importer :',
  [BrightChainStrings.PaperKey_QrAlt]: 'Code QR de la clé papier',
  [BrightChainStrings.PaperKey_SecurityRecommendations]:
    'Recommandations de sécurité :',
  [BrightChainStrings.PaperKey_Tip_Fireproof]:
    'Rangez dans un coffre ignifuge ou un coffre-fort bancaire',
  [BrightChainStrings.PaperKey_Tip_Split]:
    'Envisagez de répartir entre plusieurs emplacements',
  [BrightChainStrings.PaperKey_Tip_NoDigital]:
    "Ne stockez jamais numériquement et ne faites pas de capture d'écran",
  [BrightChainStrings.PaperKey_Tip_NeverShare]:
    'Ne partagez jamais avec quiconque, y compris le support BrightChain',
  [BrightChainStrings.PaperKey_PrintButton]: 'Imprimer ce modèle',

  // ── DisputeNotice ──
  [BrightChainStrings.Dispute_AriaLabelTemplate]: 'Litige Joule {ID}',
  [BrightChainStrings.Dispute_IdTemplate]: 'Litige #{ID}',
  [BrightChainStrings.Dispute_State_Disputed]: "En cours d'examen",
  [BrightChainStrings.Dispute_State_ResolvedFinal]: 'Résolu (final)',
  [BrightChainStrings.Dispute_State_ResolvedReplaced]: 'Résolu (remplacé)',
  [BrightChainStrings.Dispute_Field_Amount]: 'Montant',
  [BrightChainStrings.Dispute_Field_Opened]: 'Ouvert',
  [BrightChainStrings.Dispute_Field_Reason]: 'Motif',
  [BrightChainStrings.Dispute_Field_Resolved]: 'Résolu',
  [BrightChainStrings.Dispute_Field_Resolution]: 'Résolution',

  // ── RateTransparency ──
  [BrightChainStrings.RateTransparency_Loading]:
    'Chargement du tableau des tarifs',
  [BrightChainStrings.RateTransparency_Error]: 'Erreur du tableau des tarifs',
  [BrightChainStrings.RateTransparency_Empty]:
    'Tableau des tarifs non disponible.',
  [BrightChainStrings.RateTransparency_TitleTemplate]:
    'Tableau des tarifs Joule — Version {VERSION}',
  [BrightChainStrings.RateTransparency_EffectiveTemplate]:
    'En vigueur : {DATE} ({BD})',
  [BrightChainStrings.RateTransparency_SignedByTemplate]:
    'Signé par : {SIGNER}',
  [BrightChainStrings.RateTransparency_Col_ResourceClass]:
    'Classe de ressource',
  [BrightChainStrings.RateTransparency_Col_Rate]: 'Tarif',
  [BrightChainStrings.RateTransparency_Col_PerUnit]: 'Par unité',

  // ── JouleEventLog ──
  [BrightChainStrings.JouleEventLog_Loading]: 'Chargement des événements Joule',
  [BrightChainStrings.JouleEventLog_Error]:
    'Erreur du journal des événements Joule',
  [BrightChainStrings.JouleEventLog_Empty]: 'Aucun événement Joule enregistré.',
  [BrightChainStrings.JouleEventLog_AriaLabel]: 'Journal des événements Joule',
  [BrightChainStrings.JouleEventLog_Col_Time]: 'Heure',
