...
function createSpyEventEmitter(): ICommunicationEventEmitter & {
  ...
  return {
    events,
    emitMessageSent: record(
      'emitMessageSent',
    ) as ICommunicationEventEmitter['emitMessageSent'],
    emitMessageDeleted: record(
      'emitMessageDeleted',
    ) as ICommunicationEventEmitter['emitMessageDeleted'],
    emitMessageEdited: record(
      'emitMessageEdited',
    ) as ICommunicationEventEmitter['emitMessageEdited'],
    emitTypingEvent: record(
      'emitTypingEvent',
    ) as ICommunicationEventEmitter['emitTypingEvent'],
    emitPresenceChanged: record(
      'emitPresenceChanged',
    ) as ICommunicationEventEmitter['emitPresenceChanged'],
    emitReactionEvent: record(
      'emitReactionEvent',
    ) as ICommunicationEventEmitter['emitReactionEvent'],
    emitMessagePinEvent: record(
      'emitMessagePinEvent',
    ) as ICommunicationEventEmitter['emitMessagePinEvent'],
    emitMemberJoined: record(
      'emitMemberJoined',
    ) as ICommunicationEventEmitter['emitMemberJoined'],
    emitMemberLeft: record(
      'emitMemberLeft',
    ) as ICommunicationEventEmitter['emitMemberLeft'],
    emitMemberKicked: record(
      'emitMemberKicked',
    ) as ICommunicationEventEmitter['emitMemberKicked'],
    emitMemberMuted: record(
      'emitMemberMuted',
    ) as ICommunicationEventEmitter['emitMemberMuted'],
    emitGroupCreated: record(
      'emitGroupCreated',
    ) as ICommunicationEventEmitter['emitGroupCreated'],
    emitChannelUpdated: record(
      'emitChannelUpdated',
    ) as ICommunicationEventEmitter['emitChannelUpdated'],
    emitServerMemberRemoved: record(
      'emitServerMemberRemoved',
    ) as ICommunicationEventEmitter['emitServerMemberRemoved'],
    emitServerChannelCreated: record(
      'emitServerChannelCreated',
    ) as ICommunicationEventEmitter['emitServerChannelCreated'],
    emitServerChannelDeleted: record(
      'emitServerChannelDeleted',
    ) as ICommunicationEventEmitter['emitServerChannelDeleted'],
  };
}
