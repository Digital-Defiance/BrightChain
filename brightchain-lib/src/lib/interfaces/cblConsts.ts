export interface ICBLConsts {
  ...
  /**
   * Maximum allowed length for file names in Extended Constituent Block List blocks (ECBL).
  ...
  /**
   * Maximum allowed length for MIME types in Extended Constituent Block List blocks (ECBL).
