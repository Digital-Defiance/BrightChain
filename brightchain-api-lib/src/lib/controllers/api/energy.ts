    ...
    try {
      ...
      return {
        ...
        response: {
          ...
          balance: microjoulesToJoules(account.balance),
          earned: microjoulesToJoules(account.earned),
          spent: microjoulesToJoules(account.spent),
          reserved: microjoulesToJoules(account.reserved),
