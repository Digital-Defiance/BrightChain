...
import { ECIESService } from './ecies.service'; // Added import
import { ServiceProvider } from './service.provider';
import { VotingService } from './voting.service'; // Added import
...
export class MemberStore implements IMemberStore {
  ...
  public async createMember(
    ...
    const publicMember = BrightChainMember.fromJson(
      JSON.stringify({
        ...publicData,
        contactEmail: privateData.contactEmail, // Already an EmailString
        memberType: data.type,
      }),
      eciesService, // Add missing service
      votingService, // Add missing service
    );
