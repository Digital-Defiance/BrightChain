...
- [x] 0. Install required dependencies
  - Add postal-mime, mimetext, and email-addresses packages
  - Verify TypeScript types are available
  - Run `yarn install` to update lock file

- [x] 1. Create email interfaces and types
  - [x] 1.1 Create IEmailMetadata interface extending IMessageMetadata
  ...
  - [x] 1.2 Create IMailbox and IAddress interfaces
  ...
  - [x] 1.3 Create IContentType and IMimePart interfaces
  ...
  - [x] 1.4 Create IAttachmentMetadata interface
  ...
  - [x] 1.5 Create EmailDeliveryStatus enum and IDeliveryReceipt interface
  ...
  - [x] 1.6 Create EmailErrorType enum and EmailError class
...
- [x] 2. Implement EmailValidator
  - [x] 2.1 Implement header validation methods
  ...
  - [x] 2.6 Implement size validation methods
  ...
  - [x] 2.7 Write property test for size limit enforcement
    - **Property 10: Size Limit Enforcement**
    - **Validates: Requirements 8.5, 8.6, 8.8, 15.9**

  - [x] 2.8 Implement full email validation
...
- [x] 4. Implement EmailParser
  - [x] 4.1 Implement header parsing methods
  ...
  - [x] 4.5 Implement multipart parsing
  ...
  - [x] 4.6 Implement main parse() method
...
- [x] 5. Implement EmailSerializer
  - [x] 5.1 Implement header serialization methods
  ...
  - [x] 5.2 Write property test for header folding/unfolding inverse
    - **Property 14: Header Folding/Unfolding Inverse**
    - **Validates: Requirements 14.2, 14.4**

  - [x] 5.3 Implement body encoding methods
  ...
  - [x] 5.4 Write property test for Content-Transfer-Encoding consistency
    - **Property 13: Content-Transfer-Encoding Consistency**
    - **Validates: Requirements 7.6, 7.8, 14.8, 14.9**

  - [x] 5.5 Implement multipart serialization
  ...
  - [x] 5.6 Write property test for multipart boundary uniqueness
    - **Property 4: Multipart Boundary Uniqueness**
    - **Validates: Requirements 6.5**

  - [x] 5.7 Implement main serialize() method
...
- [x] 6. Checkpoint - Ensure parser and serializer tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Implement round-trip property tests
  - [x] 7.1 Write property test for email metadata round-trip
    - **Property 1: Email Metadata Round-Trip**
    - **Validates: Requirements 14.6, 14.7, 4.6, 7.1-7.8, 1.1-1.6**

- [x] 8. Implement EmailMessageService core operations
  - [x] 8.1 Create EmailMessageService class structure
...
- [x] 11. Implement email threading
  ...
  - [x] 11.4 Implement getRootMessage() method
    - Follow References to find first Message-ID
    - _Requirements: 10.6_

  - [x] 11.5 Implement forwardEmail() method
    - Add Resent-* headers per RFC 5322
    - Preserve original headers
    - Support multiple forwards with proper ordering
    - _Requirements: 17.1, 17.2, 17.3, 17.4, 17.5_

- [x] 12. Implement inbox operations
  - [x] 12.1 Implement queryInbox() method
  ...
  - [x] 12.2 Write property test for inbox query correctness
    - **Property 12: Inbox Query Correctness**
    - **Validates: Requirements 13.1**

  - [x] 12.3 Implement inbox filtering
  ...
  - [x] 12.4 Implement full-text search
    - Search across subject and body content
    - _Requirements: 13.4_

  - [x] 12.5 Implement markAsRead() and getUnreadCount()
    - Track read status per user
    - Return accurate unread count
    - _Requirements: 13.8_

- [x] 13. Checkpoint - Ensure inbox operations pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. ~~Implement CrossNodeDeliveryService~~ **SUPERSEDED** by `.kiro/specs/unified-gossip-delivery/` — delivery is now handled entirely through the gossip protocol. See unified-gossip-delivery spec tasks 4-8.
  - [x] 14.1 ~~Create CrossNodeDeliveryService class~~ — Superseded
  - [x] 14.2 ~~Implement deliverToRecipients() method~~ — Superseded
  - [x] 14.3 ~~Implement replicateBlocksToNode() method~~ — Superseded
  - [x] 14.4 ~~Implement delivery status tracking~~ — Superseded (unified-gossip-delivery task 1: unified DeliveryStatus)
  - [x] 14.5 ~~Write property test for delivery status state machine~~ — Superseded (unified-gossip-delivery task 1.2: Property 4)
  - [x] 14.6 ~~Implement delivery receipt handling~~ — Superseded (unified-gossip-delivery task 4: delivery acks via gossip)
  - [x] 14.7 ~~Implement DSN generation~~ — Superseded

- [x] 15. Implement email encryption
  - [x] 15.1 Implement encryption for email content
    - Encrypt content blocks using recipient's public key
    - Support ECIES and SYMMETRIC encryption schemes
    - _Requirements: 16.1, 16.3_

  - [x] 15.2 Implement per-recipient encryption
    - Create separate encrypted copies for each recipient
    - Store encryption metadata in Email_Metadata
    - _Requirements: 16.4, 16.7_

  - [x] 15.3 Implement S/MIME signature support
    - Sign emails with sender's private key
    - Verify signatures on decryption
    - _Requirements: 16.5, 16.8_

  - [x] 15.4 Implement S/MIME encryption support
...
- [x] 17. Integration and wiring
  ...
  - [x] 17.3 Write integration tests
    ...
    - Test cross-node delivery simulation
      - Build a test suite to stand up multiple temporary API servers with gossip services, test cross-node delivery
      - Implement any missing API endpoints, features- create any necessary specs and fork development as needed
