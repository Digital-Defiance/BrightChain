...
describe('Schema-driven unique indexes (in-memory)', () => {
  describe('setSchema auto-creates indexes', () => {
    it('should create indexes declared in the schema', async () => {
    ...
    it('should not create indexes when schema has no indexes field', async () => {
  ...
  describe('schema applied via BrightDb', () => {
    it('should auto-create indexes when schema is set on db collection', async () => {
      const store = new MockBlockStore();
      const registry = InMemoryHeadRegistry.createIsolated();
