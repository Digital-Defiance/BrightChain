/**
 * @fileoverview Property-based tests for BrightTrust API round-trip
 *
 * **Feature: backend-blockstore-brightTrust, Property 18: BrightTrust Document API Round-Trip**
 * **Validates: Requirements 12.4, 12.5**
 *
 * This test suite verifies that:
 * - POSTing to /api/brightTrust/documents/seal and then POSTing to
 *   /api/brightTrust/documents/:id/unseal with valid shares returns the original document
 * - The API correctly handles member management operations
 *
 * Note: Since the API layer is a thin wrapper around BrightTrustService, these tests
...
describe('BrightTrust API Round-Trip Property Tests', () => {
  ...
  describe('Property 18: BrightTrust Document API Round-Trip', () => {
    /**
     * Property: For any valid document and member set, POSTing to
     * /api/brightTrust/documents/seal and then POSTing to /api/brightTrust/documents/:id/unseal
    ...
    it('should seal and unseal documents correctly via service layer', async () => {
      await fc.assert(
        fc.asyncProperty(
          ...
          async (document) => {
            const testService = createBrightTrustService();
            ...
            // Seal the document (simulates POST /api/brightTrust/documents/seal)
    ...
    /**
     * Property: For any sealed document, GET /api/brightTrust/documents/:id
      ...
      await fc.assert(
        fc.asyncProperty(
          ...
          async (document) => {
            ...
            // Get document metadata (simulates GET /api/brightTrust/documents/:id)
    ...
    /**
     * Property: For any sealed document and member set, GET /api/brightTrust/documents/:id/can-unlock
