...
import { BrightTrustDataRecordDto } from './brightTrustDataRecordDto';
...
export class BrightTrustDataRecord<TID extends PlatformID = Uint8Array> {
  ...
  public static fromJson<TID extends PlatformID = Uint8Array>(
    ...
    const dto = JSON.parse(json) as BrightTrustDataRecordDto;
    return BrightTrustDataRecord.fromDto<TID>(
      dto,
      fetchMember,
      enhancedProvider,
      eciesService,
