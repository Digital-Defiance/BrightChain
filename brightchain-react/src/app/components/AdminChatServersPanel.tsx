...
import { BrightChainStrings, DefaultRole } from '@brightchain/brightchain-lib';
...
const AdminChatServersPanel: FC = () => {
  ...
  return (
    <Box>
        ...
        <>
          <Table size="small">
            <TableHead>
              <TableRow>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColName)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColOwner)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColMembers)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColChannels)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColCreated)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColActions)}
                </TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
                ...
                servers.map((server) => (
                  <TableRow key={server.id}>
                    ...
                    <TableCell>
                      <Tooltip
                        title={t(
                          BrightChainStrings.Admin_ChatServers_EditServer,
                        )}
                      >
                        <IconButton
                          size="small"
                      ...
                      <Tooltip
                        title={t(
                          BrightChainStrings.Admin_ChatServers_DeleteServer,
                        )}
                      >
                        <IconButton
                          size="small"
        ...
        <>
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ChannelName)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ChannelTopic)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ChannelVisibility)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ChannelMembers)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColCreated)}
                </TableCell>
                ...
                channels.map((channel) => (
                  <TableRow key={channel.id}>
                    ...
                    <TableCell>
                      <Tooltip
                        title={t(
                          BrightChainStrings.Admin_ChatServers_DeleteChannel,
                        )}
                      >
                        <IconButton
                          size="small"
        ...
        <>
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_MemberName)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_MemberRole)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColName)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_MemberJoined)}
                </TableCell>
                <TableCell>
                  {t(BrightChainStrings.Admin_ChatServers_ColActions)}
                </TableCell>
                  ...
                  <TableRow key={`${member.serverId}-${member.memberId}`}>
                    ...
                    <TableCell>
                      <Select
                        ...
                        value={member.role}
                        onChange={(e) =>
                          handleChangeRole(member.serverId, member.memberId, e)
                        }
                        sx={{ minWidth: 110 }}
                      >
                    ...
                    <TableCell>
                      {member.serverName ?? member.serverId}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Tooltip
                        title={t(
                          BrightChainStrings.Admin_ChatServers_RemoveMember,
                        )}
                      >
                        <IconButton
                          size="small"
      ...
      >
        <DialogTitle>
          {t(BrightChainStrings.Admin_ChatServers_EditServerTitle)}
        </DialogTitle>
        <DialogContent>
          <TextField
            fullWidth
      ...
      >
        <DialogTitle>
          {t(BrightChainStrings.Admin_ChatServers_DeleteServerTitle)}
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
      ...
      >
        <DialogTitle>
          {t(BrightChainStrings.Admin_ChatServers_DeleteChannelTitle)}
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
      ...
      >
        <DialogTitle>
          {t(BrightChainStrings.Admin_ChatServers_RemoveMemberTitle)}
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
