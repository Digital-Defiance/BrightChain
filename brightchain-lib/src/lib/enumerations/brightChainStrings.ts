...
const _brightChainKeys = {
  ...
  // Block Store Service
  BlockStoreService_NoStoreRegistered: 'BlockStoreService_NoStoreRegistered',
  ...
  Splash_EarlyDev_Title: 'Splash_EarlyDev_Title',
  Splash_EarlyDev_Body: 'Splash_EarlyDev_Body',
  Splash_EarlyDev_Team: 'Splash_EarlyDev_Team',
  Splash_EarlyDev_TeamDescription: 'Splash_EarlyDev_TeamDescription',
  Splash_EarlyDev_DataWarning: 'Splash_EarlyDev_DataWarning',
  Splash_EarlyDev_DataWarningDescription:
    'Splash_EarlyDev_DataWarningDescription',
  Splash_EarlyDev_UptimeWarning: 'Splash_EarlyDev_UptimeWarning',
  Splash_EarlyDev_UptimeWarningDescription:
    'Splash_EarlyDev_UptimeWarningDescription',
  Splash_EarlyDev_GetInvolved: 'Splash_EarlyDev_GetInvolved',
  Splash_EarlyDev_GetInvolvedDescription:
    'Splash_EarlyDev_GetInvolvedDescription',
  ...
  Admin_Dashboard_FakeEmail_Title: 'Admin_Dashboard_FakeEmail_Title',
  Admin_Dashboard_FakeEmail_Recipients: 'Admin_Dashboard_FakeEmail_Recipients',
  Admin_Dashboard_FakeEmail_CapturedTotal:
    'Admin_Dashboard_FakeEmail_CapturedTotal',
  ...
  Admin_Menu_Joule: 'Admin_Menu_Joule',
  ...
  // Admin Joule Panel
  Admin_Joule_PageTitle: 'Admin_Joule_PageTitle',
  Admin_Joule_PageDescription: 'Admin_Joule_PageDescription',
  Admin_Joule_SelectUser: 'Admin_Joule_SelectUser',
  Admin_Joule_SearchUsersLabel: 'Admin_Joule_SearchUsersLabel',
  Admin_Joule_Searching: 'Admin_Joule_Searching',
  Admin_Joule_SelectedTemplate: 'Admin_Joule_SelectedTemplate',
  Admin_Joule_Clear: 'Admin_Joule_Clear',
  Admin_Joule_AccountSection: 'Admin_Joule_AccountSection',
  Admin_Joule_FieldBalance: 'Admin_Joule_FieldBalance',
  Admin_Joule_FieldAvailable: 'Admin_Joule_FieldAvailable',
  Admin_Joule_FieldReserved: 'Admin_Joule_FieldReserved',
  Admin_Joule_FieldEarned: 'Admin_Joule_FieldEarned',
  Admin_Joule_FieldSpent: 'Admin_Joule_FieldSpent',
  Admin_Joule_FieldReputation: 'Admin_Joule_FieldReputation',
  Admin_Joule_FieldLastUpdated: 'Admin_Joule_FieldLastUpdated',
  Admin_Joule_AdjustBalanceSection: 'Admin_Joule_AdjustBalanceSection',
  Admin_Joule_ActionLabel: 'Admin_Joule_ActionLabel',
  Admin_Joule_ActionCredit: 'Admin_Joule_ActionCredit',
  Admin_Joule_ActionDebit: 'Admin_Joule_ActionDebit',
  Admin_Joule_ActionAdjust: 'Admin_Joule_ActionAdjust',
  Admin_Joule_AmountCreditLabel: 'Admin_Joule_AmountCreditLabel',
  Admin_Joule_AmountDebitLabel: 'Admin_Joule_AmountDebitLabel',
  Admin_Joule_AmountAdjustLabel: 'Admin_Joule_AmountAdjustLabel',
  Admin_Joule_AmountFallbackLabel: 'Admin_Joule_AmountFallbackLabel',
  Admin_Joule_AmountHelperText: 'Admin_Joule_AmountHelperText',
  Admin_Joule_ReasonLabel: 'Admin_Joule_ReasonLabel',
  Admin_Joule_MemoLabel: 'Admin_Joule_MemoLabel',
  Admin_Joule_ButtonCredit: 'Admin_Joule_ButtonCredit',
  Admin_Joule_ButtonDebit: 'Admin_Joule_ButtonDebit',
  Admin_Joule_ButtonSetBalance: 'Admin_Joule_ButtonSetBalance',
  Admin_Joule_RecentActionsSection: 'Admin_Joule_RecentActionsSection',
  Admin_Joule_NoActions: 'Admin_Joule_NoActions',
  Admin_Joule_ColWhen: 'Admin_Joule_ColWhen',
  Admin_Joule_ColAction: 'Admin_Joule_ColAction',
  Admin_Joule_ColDelta: 'Admin_Joule_ColDelta',
  Admin_Joule_ColBalanceAfter: 'Admin_Joule_ColBalanceAfter',
  Admin_Joule_ColReason: 'Admin_Joule_ColReason',
  Admin_Joule_ColActor: 'Admin_Joule_ColActor',
  Admin_Joule_LoadMore: 'Admin_Joule_LoadMore',
  Admin_Joule_LoadingMore: 'Admin_Joule_LoadingMore',
  Admin_Joule_EndOfLog: 'Admin_Joule_EndOfLog',
  Admin_Joule_ConfirmTitleTemplate: 'Admin_Joule_ConfirmTitleTemplate',
  Admin_Joule_ConfirmUserTemplate: 'Admin_Joule_ConfirmUserTemplate',
  Admin_Joule_ConfirmActionTemplate: 'Admin_Joule_ConfirmActionTemplate',
  Admin_Joule_ConfirmTargetTemplate: 'Admin_Joule_ConfirmTargetTemplate',
  Admin_Joule_ConfirmAmountTemplate: 'Admin_Joule_ConfirmAmountTemplate',
  Admin_Joule_ConfirmReasonTemplate: 'Admin_Joule_ConfirmReasonTemplate',
  Admin_Joule_ConfirmMemoTemplate: 'Admin_Joule_ConfirmMemoTemplate',
  Admin_Joule_ConfirmWarning: 'Admin_Joule_ConfirmWarning',
  Admin_Joule_Submitting: 'Admin_Joule_Submitting',
  Admin_Joule_Confirm: 'Admin_Joule_Confirm',
  Admin_Joule_TimestampPlaceholder: 'Admin_Joule_TimestampPlaceholder',
  Admin_Joule_ErrorLoadAccount: 'Admin_Joule_ErrorLoadAccount',
  Admin_Joule_ErrorLoadMore: 'Admin_Joule_ErrorLoadMore',
  Admin_Joule_ErrorOperationFailed: 'Admin_Joule_ErrorOperationFailed',
  Admin_Joule_SuccessTemplate: 'Admin_Joule_SuccessTemplate',
  ...
  Explorer_Nav_Blocks: 'Explorer_Nav_Blocks',
  Explorer_Nav_Pools: 'Explorer_Nav_Pools',
  Explorer_Nav_Search: 'Explorer_Nav_Search',
  Explorer_SearchPlaceholder: 'Explorer_SearchPlaceholder',
  Explorer_SearchButton: 'Explorer_SearchButton',
  Explorer_SearchResultsTemplate: 'Explorer_SearchResultsTemplate',
  Explorer_NoBlocksFound: 'Explorer_NoBlocksFound',
  Explorer_PoolsTitle: 'Explorer_PoolsTitle',
  Explorer_PoolsNone: 'Explorer_PoolsNone',
  Explorer_PoolBlocksTemplate: 'Explorer_PoolBlocksTemplate',
  Explorer_BlockDetail: 'Explorer_BlockDetail',
  Explorer_BackToBlocks: 'Explorer_BackToBlocks',
  Explorer_LocateOnNetwork: 'Explorer_LocateOnNetwork',
  Explorer_Locating: 'Explorer_Locating',
  Explorer_NetworkLocate: 'Explorer_NetworkLocate',
  Explorer_NetworkFound: 'Explorer_NetworkFound',
  Explorer_NetworkNotFound: 'Explorer_NetworkNotFound',
  Explorer_NetworkQueriedTemplate: 'Explorer_NetworkQueriedTemplate',
  Explorer_NetworkNoNodes: 'Explorer_NetworkNoNodes',
  Explorer_ColHash: 'Explorer_ColHash',
  Explorer_ColPool: 'Explorer_ColPool',
  Explorer_ColSize: 'Explorer_ColSize',
  Explorer_ColCreated: 'Explorer_ColCreated',
  Explorer_PageTemplate: 'Explorer_PageTemplate',
  Explorer_Previous: 'Explorer_Previous',
  Explorer_Next: 'Explorer_Next',
  Explorer_BlockNotFound: 'Explorer_BlockNotFound',
  Explorer_LocateFailed: 'Explorer_LocateFailed',
  Explorer_FetchFailed: 'Explorer_FetchFailed',
  Explorer_SearchFailed: 'Explorer_SearchFailed',
  Explorer_Parity: 'Explorer_Parity',
  ...
  Admin_ChatServers_DeleteServerConfirm:
    'Admin_ChatServers_DeleteServerConfirm',
  ...
  Admin_ChatServers_DeleteChannelConfirm:
    'Admin_ChatServers_DeleteChannelConfirm',
  ...
  Admin_ChatServers_RemoveMemberConfirm:
    'Admin_ChatServers_RemoveMemberConfirm',
  ...
  // Friends System Error Messages
  Error_Friends_SelfRequestNotAllowed: 'Error_Friends_SelfRequestNotAllowed',
  Error_Friends_AlreadyFriends: 'Error_Friends_AlreadyFriends',
  Error_Friends_RequestAlreadyExists: 'Error_Friends_RequestAlreadyExists',
  Error_Friends_RequestNotFound: 'Error_Friends_RequestNotFound',
  Error_Friends_NotFriends: 'Error_Friends_NotFriends',
  Error_Friends_UserBlocked: 'Error_Friends_UserBlocked',
  Error_Friends_Unauthorized: 'Error_Friends_Unauthorized',

  // Friends Controller Response Messages
  Friends_RequestSent: 'Friends_RequestSent',
  Friends_RequestAccepted: 'Friends_RequestAccepted',
  Friends_RequestRejected: 'Friends_RequestRejected',
  Friends_RequestCancelled: 'Friends_RequestCancelled',
  Friends_Removed: 'Friends_Removed',
  Friends_ListRetrieved: 'Friends_ListRetrieved',
  Friends_ReceivedRequestsRetrieved: 'Friends_ReceivedRequestsRetrieved',
  Friends_SentRequestsRetrieved: 'Friends_SentRequestsRetrieved',
  Friends_StatusRetrieved: 'Friends_StatusRetrieved',
  Friends_MutualRetrieved: 'Friends_MutualRetrieved',
  ...
  Error_PoUW_WorkUnit_MissingFieldTemplate:
    'Error_PoUW_WorkUnit_MissingFieldTemplate',
  Error_PoUW_WorkUnit_FieldTypeMismatchTemplate:
    'Error_PoUW_WorkUnit_FieldTypeMismatchTemplate',
  ...
  Error_PoUW_WorkResult_MissingFieldTemplate:
    'Error_PoUW_WorkResult_MissingFieldTemplate',
  Error_PoUW_WorkResult_FieldTypeMismatchTemplate:
    'Error_PoUW_WorkResult_FieldTypeMismatchTemplate',

  // PoUW computeWorkUnit Errors
  Error_PoUW_ComputeWorkUnit_InvalidOperationTemplate:
    'Error_PoUW_ComputeWorkUnit_InvalidOperationTemplate',
  Error_PoUW_ComputeWorkUnit_InvalidBase64Input:
    'Error_PoUW_ComputeWorkUnit_InvalidBase64Input',

  // PoUW Middleware Errors
  Error_PoUW_Middleware_RateLimited: 'Error_PoUW_Middleware_RateLimited',
  Error_PoUW_Middleware_RateLimitedWithWork:
    'Error_PoUW_Middleware_RateLimitedWithWork',
  Error_PoUW_Middleware_WorkVerificationFailed:
    'Error_PoUW_Middleware_WorkVerificationFailed',
  Error_PoUW_Middleware_InvalidChallengeToken:
    'Error_PoUW_Middleware_InvalidChallengeToken',
  Error_PoUW_Middleware_MissingWorkResult:
    'Error_PoUW_Middleware_MissingWorkResult',
