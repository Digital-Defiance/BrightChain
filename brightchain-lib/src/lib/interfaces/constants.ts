...
export interface IThemeColors {
  ...
  readonly TAGLINE_LIGHT_COLOR: string;
  readonly TAGLINE_DARK_COLOR: string;
}

export interface IFontawesomePickerConstants {
  /**
   * Max icons to show in the grid at once
   */
  FONTAWESOME_MAX_DISPLAY: number;

  /**
   * Grid item size (width and height) in pixels for the icon grid.
   */
  FONTAWESOME_ICON_GRID_SIZE: number;
}
...
export interface IConstants extends IEciesConstants {
  ...
  /** BrightHub Fontawesome Picker Constants */
  readonly BRIGHTHUB: IFontawesomePickerConstants;

  /** BrightHub Fontawesome Picker Constants */
  readonly BRIGHTCHAT: IFontawesomePickerConstants;
}
