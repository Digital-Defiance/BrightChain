...
import { BlockStoreInfo, AnimationStateInfo, PerformanceInfo } from './DebugPanel';
  ...
  describe('Property 8: Debug Information Display', () => {
    ...
    it('should have valid animation state information structure', () => {
      ...
      for (const animationState of animationStateVariations) {
        ...
        expect(animationState.currentFrame).toBeLessThanOrEqual(animationState.totalFrames);
        ...
        if (animationState.currentSequence) {
          ...
          expect(animationState.currentSequence.progress).toBeGreaterThanOrEqual(0);
          expect(animationState.currentSequence.progress).toBeLessThanOrEqual(100);
        }
      }
    });
    ...
    it('should handle block store with last operation information', () => {
      ...
      for (const operation of operations) {
        ...
        expect(['store', 'retrieve', 'delete', 'clear']).toContain(blockStoreInfo.lastOperation?.type);
