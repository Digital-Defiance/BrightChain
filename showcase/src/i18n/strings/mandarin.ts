...
> = {
  ...
  [ShowcaseStrings.FAQ_Ohm_Character]: '欧姆角色',
  [ShowcaseStrings.FAQ_Volta_Character]: '伏特角色',
  ...
  [ShowcaseStrings.FAQ_Toggle_Technical_Sublabel]: 'Ohm守护细节',
  [ShowcaseStrings.FAQ_Toggle_Ecosystem_Sublabel]: 'Volta揭示愿景',
  ...
  [ShowcaseStrings.FAQ_Tech_Q9_Quorum_Label]: '法定人数',
  ...
  [ShowcaseStrings.FAQ_Tech_Q10_QuorumBasedAccess_Label]: '基于法定人数的访问',
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightHub_Quorums_Label]: '法定人数的力量',
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Title]: '绝密',
  [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Text]:
    '一个绝密dApp即将在发布时推出，它将改变你所知道的一切，彻底颠覆游戏。',
  ...
  [ShowcaseStrings.FAQ_Eco_Soot_Answer]:
    '煤烟是每个操作的可见后果——你数字行为的"碳足迹"。它不是你花费的货币；它是你无法避免的成本。每当能量被消耗时，就会产生煤烟——随时间积累的计算工作的视觉表现。你做得越多，煤烟就积累得越多。轻度使用留下这里那里的痕迹；大量使用产生可见的积累。煤烟代表BrightChain生态系统中的业力：每个行动都留下印记。用Ohm的话说："Volta给你能量，操作把它变成热量，系统追踪后果。我只是确保我们不浪费超过必要的。"',
  ...
  [ShowcaseStrings.FAQ_Eco_HowFitsTogether_Answer]:
    '生态系统运行在Volta（花费者）和Ohm（节约者）之间的动态张力上，焦耳作为能量货币在它们之间流动。Volta渴望以全功率为每个操作供电，而Ohm确保资源不被浪费。每个操作都消耗焦耳并产生煤烟——计算工作的可见痕迹。当操作触发时，Volta伸手拿焦耳，Ohm评估成本并不情愿地让它们通过，系统追踪产生的煤烟。这创造了一个自我平衡的经济体，其中贡献等于容量，每个操作都在网络上留下印记。',

  [ShowcaseStrings.FAQ_Eco_Beliefs_Title]: '🧘 BrightChain信仰什么？',
  [ShowcaseStrings.FAQ_Eco_Beliefs_Answer]:
    '能量守恒。行动有后果。数据有重量。BrightChain生态系统中的每个元素都映射到一个更深层的原则：Volta是火花——纯粹的、混沌的潜力和行动的欲望。Ohm是锚——扎根的智慧和正确行动的纪律。焦耳是流动——在它们之间移动的精神。煤烟是业力——无法避免的可见成本。它们共同形成一个闭环：Volta提供能量，Ohm确保它被明智地花费，系统追踪每个后果。没有什么是免费的。没有什么被浪费。一切都留下印记。',

  [ShowcaseStrings.FAQ_Eco_MascotsInAction_Title]:
    '🎨 我在哪里可以看到吉祥物的行动？',
  [ShowcaseStrings.FAQ_Eco_MascotsInAction_Answer]:
    '吉祥物贯穿整个产品体验。Volta和Ohm住在平台范围的焦耳计中，Volta在能量计附近噼啪作响，Ohm在昂贵操作期间介入执行他的电阻冥想——将进度条从霓虹蓝变为平静的琥珀色。煤烟在你的会话期间可见地积聚，反映正在进行的计算工作。即将推出：吉祥物出现在错误页面、加载屏幕、根据操作严重性缩放的确认对话框中，是的——还有周边商品。',
  ...
  [ShowcaseStrings.Comp_VP_Quorum_Title]: '🔒 法定人数治理',
  [ShowcaseStrings.Comp_VP_Quorum_Desc]: '具有可配置阈值和数学安全性的民主决策',
  ...
  [ShowcaseStrings.Ledger_Quorum]: '法定人数',
