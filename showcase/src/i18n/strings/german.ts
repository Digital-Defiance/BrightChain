...
> = {
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightCal_Title]:
    'Gemeinsame und persönliche Kalenderverwaltung',
  ...
  [ShowcaseStrings.Feat_Anonymity_Title]:
    'Vermittelte Anonymität & BrightTrust',
  ...
  [ShowcaseStrings.Feat_Sealing_Title]:
    'BrightTrust-basierte Dokumentenversiegelung',
  ...
  [ShowcaseStrings.Feat_ZeroMining_HL4]: 'Energieeffiziente Konsensmechanismen',
  ...
  [ShowcaseStrings.Feat_CrossPlatform_Title]:
  ...
  [ShowcaseStrings.Feat_Contracts_HL5]:
    'Reputationsgewichtete Abstimmungsmechanismen',
  ...
  [ShowcaseStrings.Soup_AlertUploadCBLOnly]:
    'Bitte laden Sie eine .cbl-Datei hoch',
  ...
  [ShowcaseStrings.Soup_AlertParseCBLFailed]:
    'CBL konnte nicht analysiert werden: {ERROR}',
  ...
  [ShowcaseStrings.Soup_AlertMessageSent]:
    'Nachricht gesendet und in der Suppe gespeichert!',
  ...
  [ShowcaseStrings.Soup_AlertCopied]:
    'Magnet-URL in die Zwischenablage kopiert!',
  ...
  [ShowcaseStrings.Enc_PaddingSameSize]:
    'Alle Blöcke müssen die gleiche Größe haben',
  ...
  [ShowcaseStrings.Enc_UniqueIdentifier]:
    'Wird als eindeutiger Blockidentifikator verwendet',
  ...
  [ShowcaseStrings.PP_S7_Title]: '7. Strafverfolgung und rechtliche Anfragen',
  ...
  [ShowcaseStrings.PP_S15_Title]: '15. Anwendbares Recht und Streitbeilegung',
