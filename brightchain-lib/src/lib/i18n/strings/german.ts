...
export const GermanStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Explorer_SearchPlaceholder]: 'Nach Block-Hash-Präfix suchen…',
  [BrightChainStrings.Explorer_SearchButton]: 'Suchen',
  [BrightChainStrings.Explorer_SearchResults]: '{COUNT} Ergebnis(se)',
  ...
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]: '{PEERS} Peers in {DURATION}ms abgefragt',
  [BrightChainStrings.Explorer_NetworkNoNodes]: 'Keine Knoten gefunden, die diesen Block halten.',
  ...
  [BrightChainStrings.Explorer_FetchFailed]: 'Blöcke konnten nicht geladen werden',
