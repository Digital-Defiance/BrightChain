---
title: "BrightChain Messaging System Architecture"
...
- [Message Passing Requirements](../.kiro/specs/message-passing-and-events/requirements)
- [Owner-Free Filesystem](https://en.wikipedia.org/wiki/OFFSystem)
- [BrightChain Writeup](../overview/brightchain-writeup)
- [BrightChain Summary](../overview/brightchain-summary)
