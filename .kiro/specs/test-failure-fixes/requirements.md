...
### Requirement 4: Update Member Instantiation

**User Story:** As a developer, I want to create Member instances correctly, so that member-related tests pass.

#### Acceptance Criteria

1. WHEN creating a new member with newMember(), THE Test SHALL provide the required email parameter
2. WHEN the Member constructor is private, THE Tests SHALL use the factory method instead of direct instantiation
