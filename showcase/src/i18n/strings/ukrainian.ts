...
> = {
  ...
  [ShowcaseStrings.FAQ_Ohm_Character]: 'Персонаж Ом',
  [ShowcaseStrings.FAQ_Volta_Character]: 'Персонаж Вольта',
  ...
  [ShowcaseStrings.FAQ_Toggle_Technical_Sublabel]: 'Ом охороняє деталі',
  [ShowcaseStrings.FAQ_Toggle_Ecosystem_Sublabel]: 'Вольта розкриває бачення',
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Title]: 'Цілком таємно',
  [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Text]:
    "Цілком таємний dApp з'явиться при запуску, який змінить все, що ви знаєте, і повністю перевернете гру.",
  ...
  [ShowcaseStrings.FAQ_Tech_Q16_Answer]:
    'IPFS за замовчуванням прозорий; якщо у вас є хеш, ви можете бачити файл. BrightChain використовує базову лінію XOR. Дані функціонально "подрібнюються" перш ніж потрапити в мережу. Конфіденційність — це не "плагін" — це механічний стан даних.',
  ...
  [ShowcaseStrings.FAQ_Eco_Soot_Answer]:
    'Сажа — це видимий наслідок кожної операції — "вуглецевий слід" ваших цифрових дій. Це не валюта, яку ви витрачаєте; це вартість, якої ви не можете уникнути. Кожного разу, коли споживається енергія, виробляється Сажа — візуальне представлення обчислювальної роботи, що накопичується з часом. Чим більше ви робите, тим більше Сажі накопичується. Легке використання залишає слід тут і там; інтенсивне використання створює видиме накопичення. Сажа представляє карму в екосистемі BrightChain: кожна дія залишає слід. Словами Ома: "Вольта дає тобі енергію, операції перетворюють її на тепло, а система відстежує наслідки. Я просто переконуюсь, що ми не витрачаємо більше, ніж потрібно."',
  ...
  [ShowcaseStrings.FAQ_Eco_HowFitsTogether_Answer]:
    'Екосистема працює на динамічній напрузі між Вольтою (Витратником) та Омом (Заощаджувачем), з Джоулями, що течуть між ними як енергетична валюта. Вольта прагне живити кожну операцію на повну потужність, тоді як Ом забезпечує, щоб ресурси не витрачалися даремно. Кожна дія споживає Джоулі та виробляє Сажу — видимий слід обчислювальної роботи. Коли операція запускається, Вольта тягнеться за Джоулями, Ом оцінює вартість і неохоче пропускає їх, а система відстежує результуючу Сажу. Це створює самобалансуючу економіку, де внесок дорівнює потужності, і кожна дія залишає свій слід у мережі.',

  [ShowcaseStrings.FAQ_Eco_Beliefs_Title]: '🧘 У що вірить BrightChain?',
  [ShowcaseStrings.FAQ_Eco_Beliefs_Answer]:
    'Енергія зберігається. Дії мають наслідки. Дані мають вагу. Кожен елемент в екосистемі BrightChain відображає глибший принцип: Вольта — це Іскра — чистий, хаотичний потенціал і бажання діяти. Ом — це Якір — заземлена мудрість і дисципліна діяти правильно. Джоулі — це Потік — дух, що рухається між ними. Сажа — це Карма — видима вартість, якої не можна уникнути. Разом вони утворюють замкнутий цикл: Вольта забезпечує енергію, Ом гарантує, що вона витрачається мудро, а система відстежує кожен наслідок. Ніщо не є безкоштовним. Ніщо не витрачається даремно. Все залишає слід.',
  ...
  [ShowcaseStrings.FAQ_Eco_MascotsInAction_Answer]:
    'Талісмани вплетені в досвід продукту. Вольта та Ом живуть у загальноплатформному вимірювачі Джоулів, де Вольта тріщить біля індикатора енергії, а Ом втручається під час дорогих операцій, щоб виконати свою Резистивну Медитацію — змінюючи індикатор прогресу з неоново-синього на спокійний бурштиновий. Сажа видимо накопичується протягом вашої сесії, відображаючи виконану обчислювальну роботу. Незабаром: появи талісманів на сторінках помилок, екранах завантаження, діалогах підтвердження, масштабованих відповідно до серйозності операції, і так — мерч.',
