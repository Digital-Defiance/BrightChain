...
> = {
  ...
  [ShowcaseStrings.Date_BrightDate_UTC_With_Benefits]: 'UTC avec avantages',
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightCal_Title]:
    'Gestion de calendrier partagé et personnel',
  ...
  [ShowcaseStrings.Feat_Anonymity_Title]:
    'Anonymat par intermédiation et BrightTrust',
  ...
  [ShowcaseStrings.Feat_Sealing_Title]:
    'Scellement de documents basé sur le BrightTrust',
  ...
  [ShowcaseStrings.Feat_BlockTemp_Title]:
    'Température des blocs et cycle de vie',
  ...
  [ShowcaseStrings.Feat_Contracts_HL5]:
    'Mécanismes de vote pondérés par la réputation',
  ...
  [ShowcaseStrings.Soup_AlertUploadCBLOnly]:
    'Veuillez télécharger un fichier .cbl',
  ...
  [ShowcaseStrings.Soup_AlertParseCBLFailed]:
    "Échec de l'analyse du CBL : {ERROR}",
  ...
  [ShowcaseStrings.Soup_AlertMessageSent]:
    'Message envoyé et stocké dans la soupe !',
  [ShowcaseStrings.Soup_AlertSendFailed]:
    "Échec de l'envoi du message : {ERROR}",
  ...
  [ShowcaseStrings.Soup_AlertCopied]:
    'URL Magnet copiée dans le presse-papiers !',
  ...
  [ShowcaseStrings.Enc_PaddingSameSize]:
    'Tous les blocs doivent avoir la même taille',
  ...
  [ShowcaseStrings.Enc_UniqueIdentifier]:
    'Utilisé comme identifiant unique de bloc',
  ...
  [ShowcaseStrings.PP_S4_P1]:
    'Nous utilisons les informations que nous collectons pour :',
  [ShowcaseStrings.PP_S4_Li1]: 'Fournir, maintenir et améliorer les Services',
  ...
  [ShowcaseStrings.PP_S4_Li4]: 'Respecter les obligations légales applicables',
  ...
  [ShowcaseStrings.PP_S7_Title]: "7. Forces de l'ordre et demandes légales",
