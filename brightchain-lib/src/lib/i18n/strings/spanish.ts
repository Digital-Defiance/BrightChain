...
export const SpanishStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    'No hay almacén de bloques registrado en el contenedor de servicios. Asegúrese de que la inicialización de la base de datos se haya completado antes de construir BlockStoreService.',
  ...
  // Splash - Banner de desarrollo temprano
  [BrightChainStrings.Splash_EarlyDev_Title]:
    '🚧 Desarrollo temprano — Trabajo en curso',
  [BrightChainStrings.Splash_EarlyDev_Body]:
    'BrightChain es un trabajo en curso. La mayoría de las funciones están en desarrollo activo y no son completamente funcionales. Todo es muy rudimentario mientras arrancamos la red.',
  [BrightChainStrings.Splash_EarlyDev_Team]: 'Equipo pequeño',
  [BrightChainStrings.Splash_EarlyDev_TeamDescription]:
    'El equipo de desarrollo actualmente está formado por una persona y un asistente de IA. Buscamos activamente co-desarrolladores y primeros nodos pares para la red.',
  ...
  [BrightChainStrings.Splash_EarlyDev_DataWarningDescription]:
    'No podemos garantizar la persistencia de los datos. La base de datos puede necesitar ser purgada por cambios incompatibles antes de alcanzar la estabilidad. Por favor, no almacene nada irremplazable.',
  ...
  [BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription]:
    'Existe un único nodo de producción sin redundancia, configurado manualmente sin automatización. Las interrupciones son posibles en cualquier momento.',
  [BrightChainStrings.Splash_EarlyDev_GetInvolved]: 'Participa',
  [BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription]:
    'Las donaciones y contribuciones de tiempo son muy bienvenidas y acelerarían significativamente el desarrollo. Si estás interesado en co-desarrollar o gestionar un nodo par, contáctenos.',
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'Correo falso (Dev)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: 'Destinatarios',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: 'Capturados',
  [BrightChainStrings.Admin_Menu_Dashboard]: 'Panel de administración',
  [BrightChainStrings.Admin_Menu_Users]: 'Gestión de usuarios',
  [BrightChainStrings.Admin_Menu_Blocks]: 'Admin de Bloques',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: 'Admin de Joule',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]:
    'Administración del libro mayor de Joule',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    'Crédito / débito / ajuste operativo en la cuenta de energía de un usuario. Hasta que los sistemas de contribución y proveedor estén en producción, todo movimiento de Joule se realiza manualmente aquí. Cada acción se registra en el log de auditoría administrativa persistente que aparece a continuación.',
  [BrightChainStrings.Admin_Joule_SelectUser]: 'Seleccionar usuario',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    'Buscar por nombre de usuario o correo (mín. 2 caracteres)',
  [BrightChainStrings.Admin_Joule_Searching]: 'Buscando…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    'Seleccionado: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'Limpiar',
  [BrightChainStrings.Admin_Joule_AccountSection]: 'Cuenta',
  [BrightChainStrings.Admin_Joule_FieldBalance]: 'Saldo',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: 'Disponible',
  [BrightChainStrings.Admin_Joule_FieldReserved]: 'Reservado',
  [BrightChainStrings.Admin_Joule_FieldEarned]: 'Ganado',
  [BrightChainStrings.Admin_Joule_FieldSpent]: 'Gastado',
  [BrightChainStrings.Admin_Joule_FieldReputation]: 'Reputación',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: 'Última actualización',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: 'Ajustar saldo',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'Acción',
  [BrightChainStrings.Admin_Joule_ActionCredit]: 'Acreditar (añadir Joule)',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'Debitar (retirar Joule)',
  [BrightChainStrings.Admin_Joule_ActionAdjust]:
    'Ajustar (establecer saldo objetivo absoluto)',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    'Importe de crédito (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]:
    'Importe de débito (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    'Saldo objetivo (microJoules, decimal)',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: 'Importe',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    'Cadena decimal de microJoules. 1 J = 1.000.000 µJ. El ajuste acepta un objetivo no negativo.',
  [BrightChainStrings.Admin_Joule_ReasonLabel]:
    'Motivo (obligatorio, máx. 256 caracteres)',
  [BrightChainStrings.Admin_Joule_MemoLabel]:
    'Nota (opcional, máx. 1024 caracteres)',
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'Acreditar',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'Debitar',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: 'Establecer saldo',
  ...
  [BrightChainStrings.Admin_Joule_NoActions]:
    'No hay acciones administrativas registradas para este usuario.',
  [BrightChainStrings.Admin_Joule_ColWhen]: 'Cuándo',
  [BrightChainStrings.Admin_Joule_ColAction]: 'Acción',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: 'Saldo posterior',
  [BrightChainStrings.Admin_Joule_ColReason]: 'Motivo',
  [BrightChainStrings.Admin_Joule_ColActor]: 'Actor',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'Cargar más',
  [BrightChainStrings.Admin_Joule_LoadingMore]: 'Cargando…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'Fin del registro.',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]:
    'Confirmar Joule {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmUserTemplate]:
    'Usuario: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]: 'Acción: {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    'Saldo objetivo: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    'Importe: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: 'Motivo: {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'Nota: {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'Este cambio se escribe directamente en el EnergyAccountStore operativo. La reconciliación del libro mayor de capa 3 ocurrirá una vez que se publique el subsistema del libro mayor.',
  [BrightChainStrings.Admin_Joule_Submitting]: 'Enviando…',
  [BrightChainStrings.Admin_Joule_Confirm]: 'Confirmar',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]:
    'Error al cargar la cuenta de Joule',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]: 'Error al cargar más eventos',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: 'Operación fallida',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]:
    '{ACTION} con éxito. Δ {DELTA}',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'Bloques',
  [BrightChainStrings.Explorer_Nav_Pools]: 'Pools',
  [BrightChainStrings.Explorer_Nav_Search]: 'Buscar',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'Buscar por prefijo de hash…',
  [BrightChainStrings.Explorer_SearchButton]: 'Buscar',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} resultado(s)',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'No se encontraron bloques.',
  [BrightChainStrings.Explorer_PoolsTitle]: 'Pools de almacenamiento',
  [BrightChainStrings.Explorer_PoolsNone]: 'No se encontraron pools.',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} bloques',
  [BrightChainStrings.Explorer_BlockDetail]: 'Detalle del bloque',
  [BrightChainStrings.Explorer_BackToBlocks]: '← Volver a bloques',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'Localizar en la red',
  [BrightChainStrings.Explorer_Locating]: 'Localizando…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'Localización en red',
  [BrightChainStrings.Explorer_NetworkFound]: 'Encontrado',
  [BrightChainStrings.Explorer_NetworkNotFound]: 'No encontrado',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    '{PEERS} pares consultados en {DURATION}ms',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'No se encontraron nodos con este bloque.',
  [BrightChainStrings.Explorer_ColHash]: 'Hash',
  [BrightChainStrings.Explorer_ColPool]: 'Pool',
  [BrightChainStrings.Explorer_ColSize]: 'Tamaño',
  [BrightChainStrings.Explorer_ColCreated]: 'Creado',
  [BrightChainStrings.Explorer_PageTemplate]:
    'Página {PAGE} · {TOTAL} en total',
  [BrightChainStrings.Explorer_Previous]: 'Anterior',
  [BrightChainStrings.Explorer_Next]: 'Siguiente',
  [BrightChainStrings.Explorer_BlockNotFound]: 'Bloque no encontrado',
  [BrightChainStrings.Explorer_LocateFailed]: 'Error en la localización de red',
  [BrightChainStrings.Explorer_FetchFailed]: 'Error al cargar bloques',
  [BrightChainStrings.Explorer_SearchFailed]: 'Error en la búsqueda',
  [BrightChainStrings.Explorer_Parity]: 'Paridad',
  ...
  [BrightChainStrings.Admin_ChatServers_Title]:
    'Administración de servidores BrightChat',
  [BrightChainStrings.Admin_ChatServers_TabServers]: 'Servidores',
  [BrightChainStrings.Admin_ChatServers_TabChannels]: 'Canales',
  [BrightChainStrings.Admin_ChatServers_TabMembers]: 'Miembros',
  [BrightChainStrings.Admin_ChatServers_ColName]: 'Nombre',
  [BrightChainStrings.Admin_ChatServers_ColOwner]: 'Propietario',
  [BrightChainStrings.Admin_ChatServers_ColMembers]: 'Miembros',
  [BrightChainStrings.Admin_ChatServers_ColChannels]: 'Canales',
  [BrightChainStrings.Admin_ChatServers_ColCreated]: 'Creado',
  [BrightChainStrings.Admin_ChatServers_ColActions]: 'Acciones',
  [BrightChainStrings.Admin_ChatServers_NoServersFound]:
    'No se encontraron servidores.',
  [BrightChainStrings.Admin_ChatServers_DeleteServer]: 'Eliminar servidor',
  [BrightChainStrings.Admin_ChatServers_DeleteServerTitle]: 'Eliminar servidor',
  [BrightChainStrings.Admin_ChatServers_DeleteServerConfirm]:
    '¿Está seguro de que desea eliminar este servidor? Todos los canales y datos se eliminarán permanentemente.',
  [BrightChainStrings.Admin_ChatServers_EditServer]: 'Editar servidor',
  [BrightChainStrings.Admin_ChatServers_EditServerTitle]: 'Editar servidor',
  [BrightChainStrings.Admin_ChatServers_ServerName]: 'Nombre del servidor',
  [BrightChainStrings.Admin_ChatServers_ServerIcon]: 'URL del icono',
  [BrightChainStrings.Admin_ChatServers_Save]: 'Guardar',
  [BrightChainStrings.Admin_ChatServers_ChannelName]: 'Nombre del canal',
  [BrightChainStrings.Admin_ChatServers_ChannelTopic]: 'Tema',
  [BrightChainStrings.Admin_ChatServers_ChannelVisibility]: 'Visibilidad',
  [BrightChainStrings.Admin_ChatServers_ChannelMembers]: 'Miembros',
  [BrightChainStrings.Admin_ChatServers_NoChannelsFound]:
    'No se encontraron canales.',
  [BrightChainStrings.Admin_ChatServers_DeleteChannel]: 'Eliminar canal',
  [BrightChainStrings.Admin_ChatServers_DeleteChannelTitle]: 'Eliminar canal',
  [BrightChainStrings.Admin_ChatServers_DeleteChannelConfirm]:
    '¿Está seguro de que desea eliminar este canal? Todos los mensajes se eliminarán permanentemente.',
  [BrightChainStrings.Admin_ChatServers_MemberName]: 'Miembro',
  [BrightChainStrings.Admin_ChatServers_MemberRole]: 'Rol',
  [BrightChainStrings.Admin_ChatServers_MemberJoined]: 'Se unió',
  [BrightChainStrings.Admin_ChatServers_NoMembersFound]:
    'No se encontraron miembros.',
  [BrightChainStrings.Admin_ChatServers_RemoveMember]: 'Eliminar miembro',
  [BrightChainStrings.Admin_ChatServers_RemoveMemberTitle]: 'Eliminar miembro',
  [BrightChainStrings.Admin_ChatServers_RemoveMemberConfirm]:
    '¿Está seguro de que desea eliminar a este miembro del servidor?',
  [BrightChainStrings.Admin_ChatServers_ChangeRole]: 'Cambiar rol',
  [BrightChainStrings.Admin_ChatServers_EncryptedNote]:
    'El contenido del mensaje está cifrado de extremo a extremo y no es visible para los administradores.',
  [BrightChainStrings.Admin_ChatServers_FilterByServer]: 'Filtrar por servidor',
  [BrightChainStrings.Admin_ChatServers_AllServers]: 'Todos los servidores',
  [BrightChainStrings.Admin_Menu_ChatServers]: 'Servidores de chat',
  ...
  [BrightChainStrings.Error_Friends_RequestNotFound]:
    'Solicitud de amistad no encontrada o no está pendiente',
  [BrightChainStrings.Error_Friends_NotFriends]:
    'No existe amistad entre estos miembros',
  [BrightChainStrings.Error_Friends_UserBlocked]:
    'No se puede realizar la operación de amistad debido a un bloqueo entre los miembros',
  [BrightChainStrings.Error_Friends_Unauthorized]:
    'No estás autorizado para realizar esta acción en esta solicitud de amistad',

  // Friends Controller Response Messages
  [BrightChainStrings.Friends_RequestSent]: 'Solicitud de amistad enviada',
  [BrightChainStrings.Friends_RequestAccepted]: 'Solicitud de amistad aceptada',
  ...
  [BrightChainStrings.Friends_Removed]: 'Amigo eliminado',
  [BrightChainStrings.Friends_ListRetrieved]: 'Lista de amigos recuperada',
  [BrightChainStrings.Friends_ReceivedRequestsRetrieved]:
    'Solicitudes de amistad recibidas recuperadas',
  [BrightChainStrings.Friends_SentRequestsRetrieved]:
    'Solicitudes de amistad enviadas recuperadas',
  [BrightChainStrings.Friends_StatusRetrieved]: 'Estado de amistad recuperado',
  [BrightChainStrings.Friends_MutualRetrieved]: 'Amigos en común recuperados',
  [BrightChainStrings.Friends_Unauthenticated]: 'Autenticación requerida',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_RateLimited]:
    'Límite de solicitudes excedido. Espere antes de reintentar.',
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    'Límite de solicitudes excedido. Complete la unidad de trabajo adjunta para continuar.',
  [BrightChainStrings.Error_PoUW_Middleware_WorkVerificationFailed]:
    'La verificación del resultado del trabajo falló.',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_MissingWorkResult]:
    'Falta el resultado del trabajo en el cuerpo de la solicitud.',
  ...
  [BrightChainStrings.DatePage_Format_LocalDate]: 'Fecha local',
  [BrightChainStrings.DatePage_Format_LocalTime]: 'Hora local',
  ...
  [BrightChainStrings.DatePage_HolidayType_Public]: 'Día festivo',
