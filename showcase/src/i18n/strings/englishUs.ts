...
export const ShowcaseAmericanEnglishStrings: ComponentStrings<ShowcaseStringKey> =
  {
    ...
    [ShowcaseStrings.FAQ_Ohm_Character]: 'Ohm Character',
    [ShowcaseStrings.FAQ_Volta_Character]: 'Volta Character',
    ...
    [ShowcaseStrings.FAQ_Toggle_Technical_Sublabel]: 'Ohm guards the details',
    [ShowcaseStrings.FAQ_Toggle_Ecosystem_Sublabel]: 'Volta reveals the vision',
    ...
    [ShowcaseStrings.FAQ_Tech_Q9_Quorum_Label]: 'The Quorum',
    [ShowcaseStrings.FAQ_Tech_Q9_Quorum]:
      'Identity is cryptographically tied to a Governance Quorum. This ensures that while a user\'s data and actions are private, the community maintains a "Social Layer" of accountability via Shamir\'s Secret Sharing and Homomorphic Voting.',
    ...
    [ShowcaseStrings.FAQ_Tech_Q10_QuorumBasedAccess]:
      'Access to specific databases or collections can be governed by a Quorum, requiring cryptographic approval from authorized signers.',
    ...
    [ShowcaseStrings.FAQ_Tech_Q11_BrightHub_Quorums]:
      'Moderation isn\'t handled by a corporate "Safety Team." Instead, communities are governed by Governance Quorums. Rules are cryptographically enforced, and community standards are voted on via Homomorphic Voting, ensuring that a group\'s digital space remains truly "Owner-Free" and self-determined.',
    ...
    [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Title]: 'Top Secret',
    [ShowcaseStrings.FAQ_Tech_Q11_TopSecret_Text]:
      'A Top Secret dApp is coming upon release that will change everything you know and upend the game completely.',
    ...
    [ShowcaseStrings.FAQ_Eco_Soot_Answer]:
      "Soot is the visible consequence of every operation — the \"carbon footprint\" of your digital actions. It's not a currency you spend; it's a cost you can't avoid. Every time energy is consumed, Soot is produced — a visual representation of computational work that accumulates over time. The more you do, the more Soot builds up. Light usage leaves a trace here and there; heavy usage creates visible accumulation. Soot represents karma in the BrightChain ecosystem: every action leaves a mark. In Ohm's words: \"Volta gives you the energy, operations turn it into heat, and the system tracks the consequences. I just make sure we don't waste more than we have to.\"",
    ...
    [ShowcaseStrings.FAQ_Eco_HowFitsTogether_Answer]:
      "The ecosystem runs on the dynamic tension between Volta (the Spender) and Ohm (the Saver), with Joules flowing between them as the energy currency. Volta is eager to power every operation at full blast, while Ohm ensures resources aren't wasted. Every action consumes Joules and produces Soot — the visible trace of computational work. When an operation fires, Volta reaches for Joules, Ohm evaluates the cost and reluctantly lets them through, and the system tracks the resulting Soot. This creates a self-balancing economy where contribution equals capacity, and every action leaves its mark on the network.",

    [ShowcaseStrings.FAQ_Eco_Beliefs_Title]:
      '🧘 What does BrightChain believe in?',
    [ShowcaseStrings.FAQ_Eco_Beliefs_Answer]:
      "Energy is conserved. Actions have consequences. Data has weight. Every element in the BrightChain ecosystem maps to a deeper principle: Volta is the Spark — pure, chaotic potential and the desire to act. Ohm is the Anchor — grounded wisdom and the discipline to act correctly. Joules are the Flow — the spirit moving between them. Soot is the Karma — the visible cost that cannot be avoided. Together they form a closed loop: Volta provides the energy, Ohm ensures it's spent wisely, and the system tracks every consequence. Nothing is free. Nothing is wasted. Everything leaves a mark.",
    ...
    [ShowcaseStrings.FAQ_Eco_MascotsInAction_Answer]:
      "The mascots are woven throughout the product experience. Volta and Ohm live in the platform-wide Joule-meter, with Volta crackling near the energy gauge and Ohm stepping in during expensive operations to perform his Resistive Meditation — turning the progress bar from neon-blue to a calm amber. Soot accumulates visibly throughout your session, reflecting the computational work being done. Coming soon: mascot appearances on error pages, loading screens, confirmation dialogs scaled to operation severity, and yes — merch.",
    ...
    [ShowcaseStrings.Comp_Solution_P2]:
      "Built on Ethereum's keyspace but engineered without proof-of-work constraints, BrightChain monetizes unused storage on personal devices, creating a sustainable P2P network. The quorum system provides democratic governance with mathematical security guarantees.",
    ...
    [ShowcaseStrings.Comp_VP_Anonymous_Desc]:
      'Privacy with moderation capabilities — brokered anonymity via quorum consensus',
    ...
    [ShowcaseStrings.Comp_VP_Quorum_Title]: '🔒 Quorum Governance',
    ...
    [ShowcaseStrings.About_Feature_Anonymous_Desc]:
      'Privacy with moderation capabilities. Brokered anonymity balances privacy with accountability via quorum consensus.',
