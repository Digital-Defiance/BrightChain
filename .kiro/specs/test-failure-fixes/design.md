...
### BrightChainMember Factory Method

**Problem**: Constructor is private, factory method signature changed

**Solution**:
- Always use `BrightChainMember.newMember()` factory method
...
```typescript
// Before (fails)
BrightChainMember.newMember(type, name, contactEmail)
...
| new BrightChainMember(...) | BrightChainMember.newMember(...) | Use factory method |
...
3. **Member Creation Tests**: Verify BrightChainMember factory method works
