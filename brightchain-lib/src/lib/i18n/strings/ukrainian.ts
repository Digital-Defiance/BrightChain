...
export const UkrainianStrings: ComponentStrings<BrightChainStringKey> = {
  ...
  [BrightChainStrings.Error_SealingError_InsufficientSharesForReconstruction]:
    'Недостатньо часток для реконструкції ключа',
  [BrightChainStrings.Error_SealingError_KeyReconstructionFailed]:
    'Реконструкція ключа не вдалася',
  ...
  [BrightChainStrings.Error_MessageMetadataSchema_InvalidEncryptionSchemeFormat]:
    'Недійсний формат схеми шифрування',
  ...
  [BrightChainStrings.BlockStoreService_NoStoreRegistered]:
    'У контейнері сервісів не зареєстровано сховище блоків. Переконайтеся, що ініціалізація бази даних завершена перед створенням BlockStoreService.',
  ...
  [BrightChainStrings.Splash_NotACryptocurrency]: 'Не криптовалюта',
  ...
  // Splash - Банер раннього розвитку
  [BrightChainStrings.Splash_EarlyDev_Title]:
    '🚧 Ранній розвиток — Робота в процесі',
  [BrightChainStrings.Splash_EarlyDev_Body]:
    'BrightChain — це проект у стадії розробки. Більшість функцій перебуває в активній розробці і ще не повністю функціонує. Все дуже рудиментарно, поки ми запускаємо мережу.',
  [BrightChainStrings.Splash_EarlyDev_Team]: 'Невелика команда',
  [BrightChainStrings.Splash_EarlyDev_TeamDescription]:
    'Команда розробників наразі складається з однієї людини та AI-асистента. Ми активно шукаємо спільних розробників та перші вузли для мережі.',
  [BrightChainStrings.Splash_EarlyDev_DataWarning]: 'Дані можуть бути видалені',
  [BrightChainStrings.Splash_EarlyDev_DataWarningDescription]:
    'Ми не можемо гарантувати збереження даних. База даних може потребувати очищення через зворотно несумісні зміни до досягнення стабільності. Будь ласка, не зберігайте нічого незамінного.',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarning]:
    'Без гарантії безперебійної роботи',
  [BrightChainStrings.Splash_EarlyDev_UptimeWarningDescription]:
    'Існує єдиний виробничий вузол без резервування, налаштований вручну без автоматизації. Збої можливі в будь-який час.',
  [BrightChainStrings.Splash_EarlyDev_GetInvolved]: 'Долучитися',
  [BrightChainStrings.Splash_EarlyDev_GetInvolvedDescription]:
    "Пожертвування та внески часом дуже вітаються і значно прискорять розвиток. Якщо ви зацікавлені у спільній розробці або управлінні вузлом, будь ласка, зв'яжіться з нами.",
  ...
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Title]: 'Фейкова пошта (Dev)',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_Recipients]: 'Отримувачі',
  [BrightChainStrings.Admin_Dashboard_FakeEmail_CapturedTotal]: 'Перехоплено',
  [BrightChainStrings.Admin_Menu_Dashboard]: 'Панель адміністратора',
  [BrightChainStrings.Admin_Menu_Users]: 'Керування користувачами',
  [BrightChainStrings.Admin_Menu_Blocks]: 'Адмін оглядача блоків',
  ...
  [BrightChainStrings.Admin_Menu_Joule]: 'Адмін Джоуля',
  ...
  // Admin Joule Panel
  [BrightChainStrings.Admin_Joule_PageTitle]: 'Адміністрування реєстру Joule',
  [BrightChainStrings.Admin_Joule_PageDescription]:
    'Операційне нарахування / списання / коригування на енергетичному рахунку користувача. До запуску системи внесків і провайдерів усі рухи Joule виконуються вручну тут. Кожна дія записується в постійний журнал аудиту адміністратора нижче.',
  [BrightChainStrings.Admin_Joule_SelectUser]: 'Вибрати користувача',
  [BrightChainStrings.Admin_Joule_SearchUsersLabel]:
    'Пошук за іменем користувача або електронною поштою (мін. 2 симв.)',
  [BrightChainStrings.Admin_Joule_Searching]: 'Пошук…',
  [BrightChainStrings.Admin_Joule_SelectedTemplate]:
    'Вибрано: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_Clear]: 'Очистити',
  [BrightChainStrings.Admin_Joule_AccountSection]: 'Рахунок',
  [BrightChainStrings.Admin_Joule_FieldBalance]: 'Баланс',
  [BrightChainStrings.Admin_Joule_FieldAvailable]: 'Доступно',
  [BrightChainStrings.Admin_Joule_FieldReserved]: 'Зарезервовано',
  [BrightChainStrings.Admin_Joule_FieldEarned]: 'Зароблено',
  [BrightChainStrings.Admin_Joule_FieldSpent]: 'Витрачено',
  [BrightChainStrings.Admin_Joule_FieldReputation]: 'Репутація',
  [BrightChainStrings.Admin_Joule_FieldLastUpdated]: 'Останнє оновлення',
  [BrightChainStrings.Admin_Joule_AdjustBalanceSection]: 'Скоригувати баланс',
  [BrightChainStrings.Admin_Joule_ActionLabel]: 'Дія',
  [BrightChainStrings.Admin_Joule_ActionCredit]: 'Нарахувати (додати Joule)',
  [BrightChainStrings.Admin_Joule_ActionDebit]: 'Списати (зняти Joule)',
  [BrightChainStrings.Admin_Joule_ActionAdjust]:
    'Скоригувати (встановити абсолютний цільовий баланс)',
  [BrightChainStrings.Admin_Joule_AmountCreditLabel]:
    'Сума нарахування (мікроJoule, десятковий)',
  [BrightChainStrings.Admin_Joule_AmountDebitLabel]:
    'Сума списання (мікроJoule, десятковий)',
  [BrightChainStrings.Admin_Joule_AmountAdjustLabel]:
    'Цільовий баланс (мікроJoule, десятковий)',
  [BrightChainStrings.Admin_Joule_AmountFallbackLabel]: 'Сума',
  [BrightChainStrings.Admin_Joule_AmountHelperText]:
    'Десятковий рядок мікроJoule. 1 J = 1 000 000 µJ. Коригування приймає невід’ємне значення.',
  [BrightChainStrings.Admin_Joule_ReasonLabel]:
    "Причина (обов'язково, макс. 256 симв.)",
  [BrightChainStrings.Admin_Joule_MemoLabel]:
    "Нотатка (необов'язково, макс. 1024 симв.)",
  [BrightChainStrings.Admin_Joule_ButtonCredit]: 'Нарахувати',
  [BrightChainStrings.Admin_Joule_ButtonDebit]: 'Списати',
  [BrightChainStrings.Admin_Joule_ButtonSetBalance]: 'Встановити баланс',
  [BrightChainStrings.Admin_Joule_RecentActionsSection]:
    'Останні адміністративні дії',
  [BrightChainStrings.Admin_Joule_NoActions]:
    'Для цього користувача не зафіксовано жодних адміністративних дій.',
  [BrightChainStrings.Admin_Joule_ColWhen]: 'Коли',
  [BrightChainStrings.Admin_Joule_ColAction]: 'Дія',
  [BrightChainStrings.Admin_Joule_ColDelta]: 'Δ',
  [BrightChainStrings.Admin_Joule_ColBalanceAfter]: 'Баланс після',
  [BrightChainStrings.Admin_Joule_ColReason]: 'Причина',
  [BrightChainStrings.Admin_Joule_ColActor]: 'Виконавець',
  [BrightChainStrings.Admin_Joule_LoadMore]: 'Завантажити ще',
  [BrightChainStrings.Admin_Joule_LoadingMore]: 'Завантаження…',
  [BrightChainStrings.Admin_Joule_EndOfLog]: 'Кінець журналу.',
  [BrightChainStrings.Admin_Joule_ConfirmTitleTemplate]:
    'Підтвердити Joule {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmUserTemplate]:
    'Користувач: {USERNAME} ({USER_ID})',
  [BrightChainStrings.Admin_Joule_ConfirmActionTemplate]: 'Дія: {ACTION}',
  [BrightChainStrings.Admin_Joule_ConfirmTargetTemplate]:
    'Цільовий баланс: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmAmountTemplate]:
    'Сума: {AMOUNT} µJ ({FORMATTED})',
  [BrightChainStrings.Admin_Joule_ConfirmReasonTemplate]: 'Причина: {REASON}',
  [BrightChainStrings.Admin_Joule_ConfirmMemoTemplate]: 'Нотатка: {MEMO}',
  [BrightChainStrings.Admin_Joule_ConfirmWarning]:
    'Ця зміна записується безпосередньо в операційний EnergyAccountStore. Узгодження реєстру третього рівня відбудеться після запуску підсистеми реєстру.',
  [BrightChainStrings.Admin_Joule_Submitting]: 'Надсилання…',
  [BrightChainStrings.Admin_Joule_Confirm]: 'Підтвердити',
  [BrightChainStrings.Admin_Joule_TimestampPlaceholder]: '—',
  [BrightChainStrings.Admin_Joule_ErrorLoadAccount]:
    'Не вдалося завантажити рахунок Joule',
  [BrightChainStrings.Admin_Joule_ErrorLoadMore]:
    'Не вдалося завантажити додаткові події',
  [BrightChainStrings.Admin_Joule_ErrorOperationFailed]: 'Операція не вдалася',
  [BrightChainStrings.Admin_Joule_SuccessTemplate]:
    '{ACTION} успішно. Δ {DELTA}',
  ...
  [BrightChainStrings.Admin_Users_ColRole]: 'Роль',
  [BrightChainStrings.Admin_Users_ChangeRole]: 'Змінити роль',
  [BrightChainStrings.Admin_Users_ChangeRoleTitle]: 'Змінити роль користувача',
  [BrightChainStrings.Admin_Users_ChangeRoleConfirmTemplate]:
    'Ви впевнені, що хочете змінити {USERNAME} з {OLD_ROLE} на {NEW_ROLE}?',
  [BrightChainStrings.Admin_Users_ChangeRoleWarning]:
    ' Зміна користувача на адміністратора надає повний адміністративний доступ.',
  [BrightChainStrings.Admin_Users_RoleAdmin]: 'Адмін',
  [BrightChainStrings.Admin_Users_RoleMember]: 'Учасник',
  [BrightChainStrings.Admin_Users_RoleSystem]: 'Система',
  ...
  [BrightChainStrings.Admin_Users_DeleteWarning]: ' Це деструктивна операція.',
  ...
  [BrightChainStrings.Explorer_Nav_Blocks]: 'Блоки',
  [BrightChainStrings.Explorer_Nav_Pools]: 'Пули',
  [BrightChainStrings.Explorer_Nav_Search]: 'Пошук',
  [BrightChainStrings.Explorer_SearchPlaceholder]:
    'Пошук за префіксом хешу блоку…',
  [BrightChainStrings.Explorer_SearchButton]: 'Шукати',
  [BrightChainStrings.Explorer_SearchResultsTemplate]: '{COUNT} результат(ів)',
  [BrightChainStrings.Explorer_NoBlocksFound]: 'Блоки не знайдено.',
  [BrightChainStrings.Explorer_PoolsTitle]: 'Пули зберігання',
  [BrightChainStrings.Explorer_PoolsNone]: 'Пули не знайдено.',
  [BrightChainStrings.Explorer_PoolBlocksTemplate]: '{COUNT} блоків',
  [BrightChainStrings.Explorer_BlockDetail]: 'Деталі блоку',
  [BrightChainStrings.Explorer_BackToBlocks]: '← Назад до блоків',
  [BrightChainStrings.Explorer_LocateOnNetwork]: 'Знайти в мережі',
  [BrightChainStrings.Explorer_Locating]: 'Пошук…',
  [BrightChainStrings.Explorer_NetworkLocate]: 'Мережевий пошук',
  [BrightChainStrings.Explorer_NetworkFound]: 'Знайдено',
  [BrightChainStrings.Explorer_NetworkNotFound]: 'Не знайдено',
  [BrightChainStrings.Explorer_NetworkQueriedTemplate]:
    'Опитано {PEERS} вузлів за {DURATION}мс',
  [BrightChainStrings.Explorer_NetworkNoNodes]:
    'Не знайдено вузлів, що зберігають цей блок.',
  [BrightChainStrings.Explorer_ColHash]: 'Хеш',
  [BrightChainStrings.Explorer_ColPool]: 'Пул',
  [BrightChainStrings.Explorer_ColSize]: 'Розмір',
  [BrightChainStrings.Explorer_ColCreated]: 'Створено',
  [BrightChainStrings.Explorer_PageTemplate]:
    'Сторінка {PAGE} · {TOTAL} всього',
  [BrightChainStrings.Explorer_Previous]: 'Попередня',
  [BrightChainStrings.Explorer_Next]: 'Наступна',
  [BrightChainStrings.Explorer_BlockNotFound]: 'Блок не знайдено',
  [BrightChainStrings.Explorer_LocateFailed]: 'Помилка мережевого пошуку',
  [BrightChainStrings.Explorer_FetchFailed]: 'Не вдалося завантажити блоки',
  [BrightChainStrings.Explorer_SearchFailed]: 'Помилка пошуку',
  [BrightChainStrings.Explorer_Parity]: 'Парність',
  ...
  [BrightChainStrings.Admin_ChatServers_Title]:
    'Адміністрування серверів BrightChat',
  ...
  [BrightChainStrings.Admin_ChatServers_FilterByServer]:
    'Фільтрувати за сервером',
  ...
  [BrightChainStrings.Error_Friends_SelfRequestNotAllowed]:
    'Ви не можете надіслати запит на дружбу самому собі',
  [BrightChainStrings.Error_Friends_AlreadyFriends]:
    'Ви вже є другом цього учасника',
  [BrightChainStrings.Error_Friends_RequestAlreadyExists]:
    'Запит на дружбу в очікуванні вже існує',
  [BrightChainStrings.Error_Friends_RequestNotFound]:
    'Запит на дружбу не знайдено або він не в очікуванні',
  [BrightChainStrings.Error_Friends_NotFriends]:
    'Між цими учасниками не існує дружби',
  [BrightChainStrings.Error_Friends_UserBlocked]:
    'Неможливо виконати операцію дружби через блокування між учасниками',
  [BrightChainStrings.Error_Friends_Unauthorized]:
    'Ви не маєте права виконувати цю дію щодо цього запиту на дружбу',

  // Friends Controller Response Messages
  [BrightChainStrings.Friends_RequestSent]: 'Запит на дружбу надіслано',
  [BrightChainStrings.Friends_RequestAccepted]: 'Запит на дружбу прийнято',
  [BrightChainStrings.Friends_RequestRejected]: 'Запит на дружбу відхилено',
  [BrightChainStrings.Friends_RequestCancelled]: 'Запит на дружбу скасовано',
  [BrightChainStrings.Friends_Removed]: 'Друга видалено',
  [BrightChainStrings.Friends_ListRetrieved]: 'Список друзів отримано',
  [BrightChainStrings.Friends_ReceivedRequestsRetrieved]:
    'Отримані запити на дружбу отримано',
  [BrightChainStrings.Friends_SentRequestsRetrieved]:
    'Надіслані запити на дружбу отримано',
  [BrightChainStrings.Friends_StatusRetrieved]: 'Статус дружби отримано',
  [BrightChainStrings.Friends_MutualRetrieved]: 'Спільних друзів отримано',
  ...
  [BrightChainStrings.Error_PoUW_Middleware_RateLimited]:
    'Перевищено ліміт запитів. Будь ласка, зачекайте перед повторною спробою.',
  [BrightChainStrings.Error_PoUW_Middleware_RateLimitedWithWork]:
    'Перевищено ліміт запитів. Виконайте додану одиницю роботи для продовження.',
  [BrightChainStrings.Error_PoUW_Middleware_WorkVerificationFailed]:
    'Перевірка результату роботи не вдалася.',
  [BrightChainStrings.Error_PoUW_Middleware_InvalidChallengeToken]:
    'Недійсний або прострочений токен виклику.',
  [BrightChainStrings.Error_PoUW_Middleware_MissingWorkResult]:
    'Відсутній результат роботи в тілі запиту.',
  ...
  [BrightChainStrings.DatePage_Format_LocalDate]: 'Місцева дата',
  [BrightChainStrings.DatePage_Format_LocalTime]: 'Місцевий час',
