...
describe('ConstituentBlockListBlock', () => {
  ...
  describe('parseHeader', () => {
    it('should parse valid header data', () => {
      const block = createTestBlock();
      const header = cblService.parseHeader(block.data, creator);
    ...
    it('should validate creator ID match', () => {
      ...
      try {
        cblService.parseHeader(block.data, differentCreator.member),
    ...
    it('should validate date fields', () => {
      ...
      expect(() => cblService.parseHeader(invalidData, creator)).toThrowType(
        BlockValidationError,
        (error: BlockValidationError) => {
