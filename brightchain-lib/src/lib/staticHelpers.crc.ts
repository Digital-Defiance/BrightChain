...
export abstract class StaticHelpersCRC {
  /**
  ...
  public static async crc8Async(input: Buffer | Readable): Promise<Buffer> {
    if (Buffer.isBuffer(input)) {
      return Promise.resolve(StaticHelpersCRC.crc8(input));
    }
  ...
  public static async verifyCrc8Async(
    ...
    const calculatedCrc8 = await StaticHelpersCRC.crc8Async(data);
  ...
  public static async crc16Async(input: Buffer | Readable): Promise<Buffer> {
    if (Buffer.isBuffer(input)) {
      return Promise.resolve(StaticHelpersCRC.crc16(input));
    }
  ...
  public static async verifyCrc16Async(
    ...
    const calculatedCrc16 = await StaticHelpersCRC.crc16Async(data);
  ...
  public static async crc32Async(input: Buffer | Readable): Promise<Buffer> {
    if (Buffer.isBuffer(input)) {
      return Promise.resolve(StaticHelpersCRC.crc32(input));
    }
    ...
    return new Promise((resolve, reject) => {
      ...
      input.on('end', () => {
        ...
        resolve(StaticHelpersCRC.crc32(fullBuffer));
      });
  ...
  public static async verifyCrc32Async(
    ...
    const calculatedCrc32 = await StaticHelpersCRC.crc32Async(data);
