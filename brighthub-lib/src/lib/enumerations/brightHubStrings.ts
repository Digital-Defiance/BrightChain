...
export const BrightHubStrings = createI18nStringKeys(BrightHubComponentId, {
  ...
  PostComposer_ImageLimitReached: 'PostComposer_ImageLimitReached',
  PostComposer_ImageUploadFailed: 'PostComposer_ImageUploadFailed',
  PostComposer_Uploading: 'PostComposer_Uploading',
  PostComposer_InsertImage: 'PostComposer_InsertImage',
  PostComposer_RemoveAttachment: 'PostComposer_RemoveAttachment',
  PostComposer_AttachmentLimitReached: 'PostComposer_AttachmentLimitReached',
  PostComposer_EditAltText: 'PostComposer_EditAltText',
  PostComposer_AltText: 'PostComposer_AltText',
  PostComposer_Save: 'PostComposer_Save',
  PostComposer_Cancel: 'PostComposer_Cancel',
  PostComposer_InsertIcon: 'PostComposer_InsertIcon',
  PostComposer_IconSearchPlaceholder: 'PostComposer_IconSearchPlaceholder',
  PostComposer_IconNoMatchTemplate: 'PostComposer_IconNoMatchTemplate',
  PostComposer_IconStyleOptions: 'PostComposer_IconStyleOptions',
  PostComposer_IconColor: 'PostComposer_IconColor',
  PostComposer_IconColorNone: 'PostComposer_IconColorNone',
  PostComposer_IconAnimation: 'PostComposer_IconAnimation',
  PostComposer_IconAnimationNone: 'PostComposer_IconAnimationNone',
  PostComposer_IconRotation: 'PostComposer_IconRotation',
  PostComposer_IconRotationNone: 'PostComposer_IconRotationNone',
  PostComposer_IconSize: 'PostComposer_IconSize',
  PostComposer_IconSizeDefault: 'PostComposer_IconSizeDefault',
  PostComposer_IconPreview: 'PostComposer_IconPreview',

  // ImageCropDialog
  ImageCropDialog_Title: 'ImageCropDialog_Title',
  ImageCropDialog_Crop: 'ImageCropDialog_Crop',
  ImageCropDialog_Skip: 'ImageCropDialog_Skip',
  ImageCropDialog_Cancel: 'ImageCropDialog_Cancel',
  ImageCropDialog_ZoomLabel: 'ImageCropDialog_ZoomLabel',
  ImageCropDialog_PreviewAlt: 'ImageCropDialog_PreviewAlt',
