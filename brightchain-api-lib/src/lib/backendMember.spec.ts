...
describe('brightchain', () => {
  ...
  beforeAll(() => {
    ...
    alice = BackendMember.newMember(
      eciesService,
      MemberType.User,
      'Alice Smith',
      new EmailString('alice@example.com'),
    );
    bob = BackendMember.newMember(
      eciesService,
      MemberType.User,
      'Bob Smith',
      new EmailString('bob@example.com'),
    );
    noKeyCharlie = BackendMember.newMember(
      eciesService,
      MemberType.User,
      'Charlie Smith',
  ...
  describe('basic member operations', () => {
    ...
    it('should unload a private key when called', () => {
      const dwight = BackendMember.newMember(
        eciesService,
        MemberType.User,
        'Dwight Smith',
  ...
  describe('BIP39 mnemonic and wallet functionality', () => {
    ...
    beforeAll(() => {
      ...
      wallet = w;
      member = BackendMember.newMember(
        eciesService,
        MemberType.User,
        'Test User',
    ...
    it('should handle wallet unload and reload with mnemonic', () => {
      ...
      const newMember = BackendMember.newMember(
        eciesService,
        MemberType.User,
        'Test User',
        new EmailString('test@example.com'),
      ...
      const reloadedMember = new BackendMember(
        eciesService,
        MemberType.User,
        'Test User',
        new EmailString('test@example.com'),
    ...
    it('should create unique keys for different members', () => {
      const member2 = BackendMember.newMember(
        eciesService,
        MemberType.User,
        'User 2',
  ...
  describe('json', () => {
    it('should serialize and deserialize correctly', () => {
      ...
      const reloadedMember = BackendMember.fromJson(memberJson, eciesService);
