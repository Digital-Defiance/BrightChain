/**
 * Typed error classes for the brightchain database engine.
 *
...
import type { ValidationFieldError } from '../interfaces/storage/documentTypes';

// Re-export so consumers of db/errors get the type without a separate import
