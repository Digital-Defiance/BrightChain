...
> = {
  ...
  [ShowcaseStrings.FAQ_Tech_Q11_BrightCal_Title]:
    'Gestión de calendario compartido y personal',
  ...
  [ShowcaseStrings.Feat_BrightDBPools_Tech1]:
  ...
  [ShowcaseStrings.Feat_OFFS_Desc]:
    'Construyendo sobre el concepto original del Sistema de Archivos sin Propietario, BrightChain lleva OFFS al siguiente nivel. Hemos añadido cifrado asimétrico ECIES, bloques de paridad de Corrección de Errores Reed-Solomon para redundancia y durabilidad, y un registro blockchain digital. Sobre esta base, Digital Burnbag aprovecha las propiedades únicas de OFFS para garantizar la destrucción de archivos sin que su contenido haya sido leído nunca. Consulte nuestro whitepaper Digital Burnbag Vault para los fundamentos matemáticos completos.',
  [ShowcaseStrings.Feat_OFFS_Cat]: 'Almacenamiento',
  [ShowcaseStrings.Feat_OFFS_Tech1]: 'Cifrado ECIES',
  [ShowcaseStrings.Feat_OFFS_Tech2]: 'FEC Reed-Solomon',
  [ShowcaseStrings.Feat_OFFS_Tech3]: 'Registro blockchain',
  [ShowcaseStrings.Feat_OFFS_HL1]:
    'Basado en el concepto OFFS original — archivos mezclados por XOR con datos aleatorios para que ningún bloque contenga contenido identificable',
  [ShowcaseStrings.Feat_OFFS_HL2]:
    'Mejorado con cifrado asimétrico ECIES para una capa de seguridad criptográfica más allá de la ofuscación XOR',
  [ShowcaseStrings.Feat_OFFS_HL3]:
    'Los bloques de paridad FEC Reed-Solomon proporcionan redundancia y durabilidad incluso si los nodos se desconectan',
  [ShowcaseStrings.Feat_OFFS_HL4]:
    'El registro blockchain digital mantiene registros resistentes a manipulaciones de todas las operaciones de bloques',
  [ShowcaseStrings.Feat_OFFS_HL5]:
    'Digital Burnbag garantiza la destrucción de archivos sin que el contenido haya sido accedido nunca — demostrable mediante el registro',
  [ShowcaseStrings.Feat_OFFS_HL6]:
    'Matemáticas novedosas detalladas en el whitepaper Digital Burnbag Vault — https://github.brightchain.org/docs/papers/digital-burnbag-vault/',
  ...
  [ShowcaseStrings.Feat_BrightCal_Desc]:
    'Calendario cifrado con control de acceso granular, eventos recurrentes, recordatorios e integración con sistemas de calendario tradicionales a través de CalDAV.',
  ...
  [ShowcaseStrings.Feat_BrightCal_HL1]:
    'Eventos almacenados como bloques cifrados en BrightChain',
  [ShowcaseStrings.Feat_BrightCal_HL2]:
    'Control de acceso granular mediante delegación BrightTrust',
  [ShowcaseStrings.Feat_BrightCal_HL3]:
    'Soporte completo para eventos recurrentes con reglas RRULE',
  [ShowcaseStrings.Feat_BrightCal_HL4]:
    'Recordatorios y notificaciones con entrega cifrada',
  [ShowcaseStrings.Feat_BrightCal_HL5]:
    'Integración CalDAV para clientes de calendario tradicionales',
  [ShowcaseStrings.Feat_BrightCal_HL6]:
    'Programación de invitaciones con protocolo iTIP/iMIP',
  [ShowcaseStrings.Feat_BrightCal_HL7]:
    'Historial de versiones inmutable para todos los cambios de eventos',
  [ShowcaseStrings.Feat_BrightCal_HL8]:
    'Calendarios compartidos con permisos por usuario',
  [ShowcaseStrings.Feat_BrightCal_HL9]:
    'Detección de conflictos y resolución automática',
  [ShowcaseStrings.Feat_BrightCal_HL10]:
    'Exportación e importación en formato iCalendar estándar',
  ...
  [ShowcaseStrings.Feat_Anonymity_Title]:
    'Anonimato intermediado y BrightTrust',
  ...
  [ShowcaseStrings.Feat_Anonymity_Tech2]:
  ...
  [ShowcaseStrings.Feat_Sealing_Title]:
    'Sellado de documentos basado en BrightTrust',
  ...
  [ShowcaseStrings.Feat_Reputation_Title]:
    'Reputación y seguimiento de energía',
  ...
  [ShowcaseStrings.Feat_BlockTemp_Title]:
    'Temperatura de bloques y ciclo de vida',
  ...
  [ShowcaseStrings.Feat_Contracts_HL5]:
    'Mecanismos de votación ponderados por reputación',
  ...
  [ShowcaseStrings.Soup_AlertMessageSent]:
    '¡Mensaje enviado y almacenado en la sopa!',
  ...
  [ShowcaseStrings.Edu_GlossaryTitle]:
    '📚 Glosario de conceptos de BrightChain',
  ...
  [ShowcaseStrings.Enc_PaddingSameSize]:
  ...
  [ShowcaseStrings.Enc_EnsuresIntegrity]:
    'Garantiza la integridad de los datos',
  [ShowcaseStrings.Enc_UniqueIdentifier]:
    'Se usa como identificador único de bloque',
  ...
  [ShowcaseStrings.PP_S4_Li1]: 'Proporcionar, mantener y mejorar los Servicios',
  [ShowcaseStrings.PP_S4_Li2]: 'Autenticar usuarios y gestionar cuentas',
  ...
  [ShowcaseStrings.PP_S7_Title]: '7. Fuerzas del orden y solicitudes legales',
  ...
  [ShowcaseStrings.PP_S15_Title]: '15. Ley aplicable y resolución de disputas',
